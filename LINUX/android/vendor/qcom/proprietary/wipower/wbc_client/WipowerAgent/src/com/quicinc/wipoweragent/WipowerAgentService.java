...
public class WipowerAgentService extends Service implements WbcManager.WbcEventListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (mWbcManager != null) {
            ...
            if (DBG) Log.v(TAG, "getChargeComplete:" + mWbcManager.getChargeComplete());
            if (DBG) Log.v(TAG, "getUSBChargingPresent:" + mWbcManager.getUSBChargingPresent());
            if (DBG) Log.v(TAG, "getBatteryOverheat:" + mWbcManager.getBatteryOverheat());
        }
