...
int qdp_test_03(void)
{
  ...
  QDP_TEST_LOG("qdp_test_03: 3gpp/3gpp2 profile look up with nai [%s] ENTRY",
                QDP_TEST_NAI);
...
int main(void)
{
  if (QDP_SUCCESS == qdp_test_03())
  {
    QDP_TEST_LOG("%s","QDP_TEST_03 PASS");
  }
  else
  {
    QDP_TEST_LOG("%s","QDP_TEST_03 FAIL");
  }
