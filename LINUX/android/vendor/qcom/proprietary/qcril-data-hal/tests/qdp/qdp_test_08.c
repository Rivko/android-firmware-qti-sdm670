...
int qdp_test_08(void)
{
  ...
  QDP_TEST_LOG("%s","qdp_test_08: prereq: use QMI to create IPv6 3GPP profile at beginning");
  QDP_TEST_LOG("qdp_test_08: 3gpp/3gpp2 profiles look up for APN [%s]ENTRY",
                QDP_TEST_APN_NAME);
  ...
  do
  {
    ...
    QDP_MALLOC(params[QDP_RIL_IP_FAMILY], (strlen(QDP_RIL_IP_6)+1)*sizeof(char));
