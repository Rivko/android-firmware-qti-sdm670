...
int qdp_test_02(void)
{
  ...
  QDP_TEST_LOG("qdp_test_02: 3gpp/3gpp2 profile look up for apn [%s]/nai [%s] ENTRY",
...
int main(void)
{
  if (QDP_SUCCESS == qdp_test_02())
  {
    QDP_TEST_LOG("%s","QDP_TEST_02 PASS");
  }
  else
  {
    QDP_TEST_LOG("%s","QDP_TEST_02 FAIL");
  }
