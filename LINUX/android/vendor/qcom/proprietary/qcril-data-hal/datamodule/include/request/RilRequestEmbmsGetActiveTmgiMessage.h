...
class RilRequestEmbmsGetActiveTmgiMessage : public SolicitedMessage<generic_callback_payload>,
    ...
    inline void deepCopy(qcril_request_params_type &p) {
        embms_get_active_tmgi_req_msg_v01 *payload = new embms_get_active_tmgi_req_msg_v01;
        memcpy(payload, (char *)&p.data, sizeof(embms_get_active_tmgi_req_msg_v01));
    ...
    RilRequestEmbmsGetActiveTmgiMessage(const qcril_request_params_type &p)
