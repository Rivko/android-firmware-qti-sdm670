...
#define EMBMS_V01_MAX_MESSAGE_ID 0x0023
/**
    @}
  */
...
typedef enum {
  ...
  RADIO_STATE_ON_V01 = 0x02,
  RADIO_STATE_OFF_V01 = 0x03,
...
/** @addtogroup embms_qmi_messages
    @{
  */
/** Indication Message; Indicates that modem request interested TMGI list from RIL */
typedef struct {

  /* Mandatory */
  int32_t dbg_trace_id;
}embms_unsol_get_interested_tmgi_list_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup embms_qmi_messages
    @{
  */
/** Request Message; Get EMBMS interested TMGI list */
typedef struct {
  ...
  uint32_t tmgi_info_len;  /**< Must be set to # of elements in tmgi_info */
  embms_tmgi_type_v01 tmgi_info[NUMBER_MAX_V01];
}embms_get_interested_tmgi_list_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup embms_qmi_messages
    @{
  */
/** Response Message; Get EMBMS interested TMGI list */
typedef struct {

  /* Mandatory */
  int32_t dbg_trace_id;
}embms_get_interested_tmgi_list_resp_ack_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_QMI_EMBMS_GET_INTERESTED_TMGI_LIST_V01
...
//#define REMOVE_QMI_EMBMS_UNSOL_GET_INTERESTED_TMGI_LIST_REQ_V01
...
#define QMI_EMBMS_UNSOL_GET_INTERESTED_TMGI_LIST_REQ_V01 0x0022
#define QMI_EMBMS_GET_INTERESTED_TMGI_LIST_RESP_V01 0x0023
#define QMI_EMBMS_GET_INTERESTED_TMGI_LIST_RESP_ACK_V01 0x0023
/**
    @}
  */
