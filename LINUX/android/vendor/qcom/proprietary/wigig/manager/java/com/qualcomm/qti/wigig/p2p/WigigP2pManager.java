...
/**
 * This class provides the API for managing WiGig peer-to-peer connectivity. This lets an
 * application discover available peers, setup connection to peers and query for the list of peers.
 * When a p2p connection is formed over wigig, the device continues to maintain the uplink
 ...
 * Applications can listen to {@link #WIGIG_P2P_DISCOVERY_CHANGED_ACTION} to know if a peer-to-peer
 * discovery is running or stopped. Additionally, {@link #WIGIG_P2P_PEERS_CHANGED_ACTION} indicates
 ...
 * WiGig devices that do not support p2p, an app can create a group using {@link #createGroup}
 ...
 * prior to setting up a WiGig p2p connection with the device.
 *
 ...
 * operations.
 *
 * Get an instance of this class by calling {@link #getInstance}
 *
 * {@see WifiP2pConfig}
 * {@see WifiP2pInfo}
 * {@see WifiP2pGroup}
 ...
 * {@see android.net.wigig.WpsInfo}
 */
public class WigigP2pManager {
    private static final String TAG = "WigigP2pManager";
    /**
     * The name of the Wigig P2P service
     */
     public static final String WIGIG_P2P_SERVICE = "wigigp2p";

    /**
     * Broadcast intent action to indicate whether WiGig p2p is enabled or disabled. An
     * extra {@link #EXTRA_WIGIG_STATE} provides the state information as int.
     *
     * @see #EXTRA_WIGIG_STATE
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WIGIG_P2P_STATE_CHANGED_ACTION =
        "android.net.wigig.p2p.STATE_CHANGED";

    /**
     * The lookup key for an int that indicates whether WiGig p2p is enabled or disabled.
     * Retrieve it with {@link android.content.Intent#getIntExtra(String,int)}.
     *
     * @see #WIGIG_P2P_STATE_DISABLED
     * @see #WIGIG_P2P_STATE_ENABLED
     */
    public static final String EXTRA_WIGIG_STATE = "wigig_p2p_state";

    /**
     * WiGig p2p is disabled.
     *
     * @see #WIGIG_P2P_STATE_CHANGED_ACTION
     */
    public static final int WIGIG_P2P_STATE_DISABLED = 1;

    /**
     * WiGig p2p is enabled.
     *
     * @see #WIGIG_P2P_STATE_CHANGED_ACTION
     */
    public static final int WIGIG_P2P_STATE_ENABLED = 2;

    /**
     * Broadcast intent action indicating that the state of WiGig p2p connectivity
     * has changed. One extra {@link #EXTRA_WIGIG_P2P_INFO} provides the p2p connection info in
     ...
     *
     * @see #EXTRA_WIGIG_P2P_INFO
     * @see #EXTRA_NETWORK_INFO
     * @see #EXTRA_WIGIG_P2P_GROUP
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WIGIG_P2P_CONNECTION_CHANGED_ACTION =
        "android.net.wigig.p2p.CONNECTION_STATE_CHANGE";

    /**
     * The lookup key for a {@link android.net.wigig.p2p.WifiP2pInfo} object
     * Retrieve with {@link android.content.Intent#getParcelableExtra(String)}.
     */
    public static final String EXTRA_WIGIG_P2P_INFO = "WifiP2pInfo";
    ...
    /**
     * The lookup key for a {@link android.net.wigig.p2p.WifiP2pGroup} object
     * associated with the p2p network. Retrieve with
     * {@link android.content.Intent#getParcelableExtra(String)}.
     */
    public static final String EXTRA_WIGIG_P2P_GROUP = "p2pGroupInfo";
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WIGIG_P2P_PEERS_CHANGED_ACTION =
        "android.net.wigig.p2p.PEERS_CHANGED";

     /**
      * The lookup key for a {@link android.net.wigig.p2p.WifiP2pDeviceList} object representing
      * the new peer list when {@link #WIGIG_P2P_PEERS_CHANGED_ACTION} broadcast is sent.
      *
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WIGIG_P2P_DISCOVERY_CHANGED_ACTION =
        "android.net.wigig.p2p.DISCOVERY_STATE_CHANGE";

    /**
     * The lookup key for an int that indicates whether p2p discovery has started or stopped.
     * Retrieve it with {@link android.content.Intent#getIntExtra(String,int)}.
     *
     * @see #WIGIG_P2P_DISCOVERY_STARTED
     * @see #WIGIG_P2P_DISCOVERY_STOPPED
     */
     ...
     *
     * @see #WIGIG_P2P_DISCOVERY_CHANGED_ACTION
     */
    public static final int WIGIG_P2P_DISCOVERY_STOPPED = 1;
     ...
     * @see #WIGIG_P2P_DISCOVERY_CHANGED_ACTION
     */
    public static final int WIGIG_P2P_DISCOVERY_STARTED = 2;

    /**
     * Broadcast intent action indicating that this device details have changed.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String WIGIG_P2P_THIS_DEVICE_CHANGED_ACTION =
        "android.net.wigig.p2p.THIS_DEVICE_CHANGED";

    /**
     * The lookup key for a {@link android.net.wigig.p2p.WifiP2pDevice} object
     * Retrieve with {@link android.content.Intent#getParcelableExtra(String)}.
     */
    public static final String EXTRA_WIGIG_P2P_DEVICE = "WifiP2pDevice";

    /**
     * Broadcast intent action indicating that remembered persistent groups have changed.
     * @hide
     */
    public static final String WIGIG_P2P_PERSISTENT_GROUPS_CHANGED_ACTION =
        "android.net.wigig.p2p.PERSISTENT_GROUPS_CHANGED";

    /**
     * The lookup key for a handover message returned by the WigigP2pService.
     * @hide
     */
    public static final String EXTRA_HANDOVER_MESSAGE =
            "android.net.wigig.p2p.EXTRA_HANDOVER_MESSAGE";

    IWigigP2pManager mService;

    private static final int BASE = WigigManager.BASE_WIGIG_P2P_MANAGER;
    ...
    /**
     * Create a new WigigP2pManager instance. Applications use
     * {@link #getInstance} to retrieve
     * the standard {@link WigigP2pManager#WIGIG_P2P_SERVICE WigigP2pManager.WIGIG_P2P_SERVICE}.
     * @param service the Binder interface
     * @hide - hide this because it takes in a parameter of type IWigigP2pManager, which
     * is a system private class.
     */
    public WigigP2pManager(IWigigP2pManager service) {
        mService = service;
    }

    /**
     * Get a new instance of the WigigP2pManager
     * Call {@link #initialize} on the instance before doing any p2p operation.
     */
    public static WigigP2pManager getInstance()
    {
        IBinder b = ServiceManager.getService(WIGIG_P2P_SERVICE);
        if (b == null) {
            Log.e(TAG, "Wigig P2P service not available");
            return null;
        }
        IWigigP2pManager s = IWigigP2pManager.Stub.asInterface(b);
        return new WigigP2pManager(s);
    }
    ...
    public interface ConnectionInfoListener {
         ...
         * @param info WiGig p2p connection info
         */
    ...
    public interface GroupInfoListener {
         ...
         * @param group WiGig p2p group info
         */
   ...
   public interface DnsSdTxtRecordListener {
    ...
    public interface PersistentGroupInfoListener {
         ...
         * @param groups WiGig p2p group info list
         */
    ...
    /**
     * A channel that connects the application to the Wigig p2p framework.
    ...
    /**
     * Registers the application with the WiGig framework. This function
    ...
    /**
     * Registers the application with the WiGig framework. Enables system-only functionality.
     * @hide
     */
    ...
    /**
     * Initiate peer discovery. A discovery process involves scanning for available WiGig peers
     ...
     * a p2p group is formed. Register for {@link #WIGIG_P2P_PEERS_CHANGED_ACTION} intent to
     * determine when the framework notifies of a change as peers are discovered.
     *
     * <p> Upon receiving a {@link #WIGIG_P2P_PEERS_CHANGED_ACTION} intent, an application
   ...
   /**
     ...
     * {@link ActionListener#onFailure}.
     *
     * <p> Register for {@link #WIGIG_P2P_CONNECTION_CHANGED_ACTION} intent to
    ...
    /** @hide */
    public void setWigigP2pChannels(Channel c, int lc, int oc, ActionListener listener) {
        checkChannel(c);
    ...
    /**
     * Start a WiGig Protected Setup (WPS) session.
     *
    ...
    /**
     * Get a reference to WigigP2pService handler. This is used to establish
     * an AsyncChannel communication with WigigService
     *
     * @return Messenger pointing to the WigigP2pService handler
     * @hide
     */
     ...
     * a priveleged AsyncChannel communication with WigigP2pService.
     *
     * @return Messenger pointing to the WigigP2pService handler
     * @hide
     */
