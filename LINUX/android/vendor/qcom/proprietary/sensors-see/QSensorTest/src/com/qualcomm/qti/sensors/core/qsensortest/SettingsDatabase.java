...
public class SettingsDatabase extends Object {
    ...
    for(int i = 0; i < 2; i++){
      ...
      if(resultCursor.moveToFirst()){
        sensorSetting = new SensorSetting(
            ...
            TriggerMode.values()[resultCursor.getInt(3)],
  ...
  public enum TriggerMode {
    ...
    public static TriggerMode getMode(Sensor sensor) {
      int TYPE_PICK_UP_GESTURE = Integer.MAX_VALUE;
      try { TYPE_PICK_UP_GESTURE = Sensor.class.getDeclaredField("TYPE_PICK_UP_GESTURE").getInt(null);
      } catch (Exception e) { }
