...
/*
Copyright (c) 2002-2019 Qualcomm Technologies, Inc.
All Rights Reserved.
...
#define MSG_SSID_GEN_FIRST  0
  ...
  #define MSG_SSID_QDR        119
  #define MSG_SSID_WDSP       120
  #define MSG_SSID_GNSS_HLOS  121
  ...
  #define MSG_SSID_SSGCCS         126
  #define MSG_SSID_PERF           127
  #define MSG_SSID_TSENS          128
  #define MSG_SSID_ECM            129
  #define MSG_SSID_TEMPERATURE_MONITOR   130

#define MSG_SSID_GEN_LAST   130
...
/* Default master category for WLAN. */
#define MSG_SSID_WLAN           4500
  ...
  #define MSG_SSID_WLAN_PLATFORM               4574
  #define MSG_SSID_WLAN_RSSI_MONITOR           4575
  #define MSG_SSID_WLAN_MODULE_WPM             4576
  #define MSG_SSID_WLAN_MODULE_CSS             4577
  #define MSG_SSID_WLAN_MODULE_PPS             4578
  #define MSG_SSID_WLAN_MODULE_SCAN_CH_PREDICT 4579
  #define MSG_SSID_WLAN_MODULE_MAWC            4580
  #define MSG_SSID_WLAN_MODULE_CMC_QMIC        4581
  #define MSG_SSID_WLAN_MODULE_HALPHY          4582
  #define MSG_SSID_WLAN_MODULE_ENQ             4583
  #define MSG_SSID_WLAN_MODULE_WLM             4584
#define MSG_SSID_WLAN_LAST      4584
...
#define MSG_SSID_ATS            4600
  ...
  #define MSG_SSID_MCS_TRM     4616
#define MSG_SSID_MCS_LAST     4616
...
#define MSG_SSID_DS                5000
  ...
  #define MSG_SSID_DS_TX             5033
  #define MSG_SSID_DS_WLAN           5034
  #define MSG_SSID_DS_IPSEC          5035
  #define MSG_SSID_DS_SSL            5036

#define MSG_SSID_DS_LAST           5036
...
#define MSG_SSID_SEC_QWES           5517
#define MSG_SSID_SEC_LAST           5517
...
#define MSG_SSID_CHGPD_CHARGING          8530
#define MSG_SSID_CHGPD_TYPCPD            8531

#define MSG_SSID_QDSP6_LAST              8531
...
#define MSG_SSID_F_RESERVED_0         9511
#define MSG_SSID_F_RESERVED_1         9512
#define MSG_SSID_F_RESERVED_2         9513
#define MSG_SSID_F_RESERVED_3         9514
#define MSG_SSID_F_RESERVED_4         9515
#define MSG_SSID_F_RESERVED_5         9516
#define MSG_SSID_F_RESERVED_6         9517
#define MSG_SSID_F_RESERVED_7         9518
#define MSG_SSID_F_RESERVED_8         9519
#define MSG_SSID_F_RESERVED_9         9520
#define MSG_SSID_F_RESERVED_10        9521
#define MSG_SSID_LTE_LAST           9521
...
#define MSG_SSID_DPM_DM                                         10416

#define MSG_SSID_DPM_LAST                                       10416

/* V2X related SSID's */
#define MSG_SSID_V2X    					10500
#define MSG_SSID_V2X_ML1					10501
#define MSG_SSID_V2X_MAC					10502
#define MSG_SSID_V2X_RLC 					10503
#define MSG_SSID_V2X_PDCP  				        10504
#define MSG_SSID_V2X_RRC					10505

#define MSG_SSID_V2X_LAST					10505
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_QRARB
  #define MSG_BUILD_MASK_MSG_SSID_QRARB    MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_QRARB)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_QRARB
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_LMTSMGR 
  #define MSG_BUILD_MASK_MSG_SSID_LMTSMGR     MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_LMTSMGR)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_LMTSMGR
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_DS_WLAN
  #define MSG_BUILD_MASK_MSG_SSID_DS_WLAN     MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_BUILD_MASK_MSG_SSID_DS_WLAN )

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_DS_WLAN
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_DS_IPSEC
  #define MSG_BUILD_MASK_MSG_SSID_DS_IPSEC    MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_DS_IPSEC)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_DS_IPSEC
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_DS_SSL
  #define MSG_BUILD_MASK_MSG_SSID_DS_SSL    MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_DS_SSL)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_DS_SSL
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_V2X
  #define MSG_BUILD_MASK_MSG_SSID_V2X   MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_V2X)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_V2X
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_V2X_ML1
  #define MSG_BUILD_MASK_MSG_SSID_V2X_ML1   MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_V2X_ML1)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_V2X_ML1
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_V2X_MAC
  #define MSG_BUILD_MASK_MSG_SSID_V2X_MAC   MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_V2X_MAC)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_V2X_MAC
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_V2X_RLC
  #define MSG_BUILD_MASK_MSG_SSID_V2X_RLC   MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_V2X_RLC)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_V2X_RLC
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_V2X_PDCP
  #define MSG_BUILD_MASK_MSG_SSID_V2X_PDCP   MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_V2X_PDCP)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_V2X_PDCP
...
/* In case it is not defined in msgtgt.h */
#ifndef MSG_BUILD_MASK_MSG_SSID_V2X_RRC
  #define MSG_BUILD_MASK_MSG_SSID_V2X_RRC   MSG_BUILD_MASK_DFLT
#endif

/* If the build environment has specified this file to translate legacy
   messages to the this SSID. */
#if defined (MSG_BT_SSID_DFLT) && (MSG_BT_SSID_DFLT==MSG_SSID_V2X_RRC)

  #undef MSG_SSID_DFLT
  #define MSG_SSID_DFLT MSG_BT_SSID_DFLT

  #undef MSG_BUILD_MASK_MSG_SSID_DFLT
  #define MSG_BUILD_MASK_MSG_SSID_DFLT MSG_BUILD_MASK_MSG_SSID_V2X_RRC
...
#define LISTENER_MSG_MASK_TBL_CNT MSG_MASK_TBL_CNT
/*!
