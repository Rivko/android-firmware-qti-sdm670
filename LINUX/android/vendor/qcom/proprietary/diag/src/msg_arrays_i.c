...
static const uint32 msg_bld_masks_lte[] =
{
  ...
  MSG_BUILD_MASK_MSG_SSID_NR5G,
  MSG_BUILD_MASK_MSG_SSID_NR5G_RRC,
  MSG_BUILD_MASK_MSG_SSID_NR5G_MACUL,
  MSG_BUILD_MASK_MSG_SSID_NR5G_MACDL,
  MSG_BUILD_MASK_MSG_SSID_NR5G_MACCTRL,
  MSG_BUILD_MASK_MSG_SSID_NR5G_RLCUL,
  MSG_BUILD_MASK_MSG_SSID_NR5G_RLCDL,
  MSG_BUILD_MASK_MSG_SSID_NR5G_PDCPUL,
  MSG_BUILD_MASK_MSG_SSID_NR5G_PDCPDL,
  MSG_BUILD_MASK_MSG_SSID_NR5G_ML1,
  MSG_BUILD_MASK_MSG_SSID_NR5G_DISCOVERY
};
