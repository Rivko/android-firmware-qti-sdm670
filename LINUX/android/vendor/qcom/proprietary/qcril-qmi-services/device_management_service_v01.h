...
#define DMS_V01_IDL_MINOR_VERS 0x38
 ...
 */
  ...
  */
  ...
  /**<   This TLV gives the list of maximum configurations and current configuration of the device.
  */
  ...
  /**<    explicit_config_index specifies if the current configuration is Modem selected or HOS specified.
        explicit_config_index Values:\n
...
typedef struct {
  ...
  */
  ...
  /**<   \n This notifies the TE whether current set of activity info
        is the newly calculated information or the values 
        that were computed previously following a
        QMI_DMS_GET_MODEM_ACTIVITY_INFO_REQ */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Set Device Configuration out of device capabilities */
typedef struct {
  ...
  uint8_t explicit_config_index_valid;  /**< Must be set to true if explicit_config_index is being passed */
  int16_t explicit_config_index;
  /**<   specifies the configuration index on which Modem should act on.
             explicit_config_index Values:\n
             - "-1" - modem controlled configuration \n 
             - "Any other valid value" - HLOS selected static configuration and points to an 
         index in list of device_cfg_list of "device_config_list” TLV related to most recently
         received QMI_DMS_GET_DEVICE_CAP_RESP or QMI_DMS_SET_EVENT_REPORT_IND message.
    */
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Set Device Configuration out of device capabilities */
typedef struct {
