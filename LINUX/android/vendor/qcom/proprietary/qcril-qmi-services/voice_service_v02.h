...
*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  Copyright (c) 2010-2016, 2017 Qualcomm Technologies, Inc. All rights reserved.
  Qualcomm Technologies Proprietary and Confidential.


  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/voice/api/voice_service_v02.h#19 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define VOICE_V02_IDL_MINOR_VERS 0x5F
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x0070
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<    True: If called party is being alerted and ringing .
  */
 ...
 */
  ...
  */
  ...
  /**<   Indicates current call is RTT call or not. Values:
...
typedef enum {
  ...
  VOICE_CC_RESULT_TYPE_VT_V02 = 0x03,
...
typedef struct {
  ...
  */
  ...
  /**<   Values: \n
      - VOICE_CC_RESULT_TYPE_VOICE (0x00) --
      - VOICE_CC_RESULT_TYPE_SUPS (0x01) --
      - VOICE_CC_RESULT_TYPE_USSD (0x02) --
      - VOICE_CC_RESULT_TYPE_VT (0x03) --
 */
 ...
 */
  ...
  */
  ...
  /**<   IP history information. This field contains history-info fields from
       ...
       it nor any subsequent field will be added.
  */
...
typedef struct {
  ...
  */
  ...
  Annex H of 3GPP TS 24.008 has details on these cause codes.
    */
...
typedef struct {
  ...
  /**<   Remote Party Conference Capabilities. Values: \n
             TRUE: Conference capability is enabled in remote party \n
             FALSE: Conference capability is disabled in remote party
         */
...
typedef struct {
  ...
  */
  ...
  rtt_mode_type_v02 rtt_mode;
  /**<   Call RTT attribute status. Values: \n
      - RTT_MODE_DISABLED (0) --  non-RTT call \n
      - RTT_MODE_FULL (1) --  RTT call with RTT being used from both sides \n
 */
...
typedef struct {
  ...
  */
  ...
  /**<   This TLV tells us the conference capabilities of the remote party
  */
 ...
 */
  ...
  */
  ...
  uint8_t sip_error_code_valid;  /**< Must be set to true if sip_error_code is being passed */
  uint16_t sip_error_code;
  /**<   Sip error code for sups failure
  */
...
typedef struct {
  ...
  */
  ...
  provision_status_enum_v02 provision_status;
  /**<   Provisioned status. Values: \n
      - PROVISION_STATUS_NOT_PROVISIONED (0x00) --
      - PROVISION_STATUS_PROVISIONED_PERMANENT (0x01) --
      - PROVISION_STATUS_PRESENTATION_RESTRICTED (0x02) --
      - PROVISION_STATUS_PRESENTATION_ALLOWED (0x03) --
 */
 ...
 */
  ...
  */
  ...
  /**<   Response type for call waiting. Contains data members: active_status
 ...
 */
  ...
  /* Optional */
  /*  Secure call flag for upgrading VoLTE calls to secure call. */
  uint8_t is_secure_call_valid;  /**< Must be set to true if is_secure_call is being passed */
  uint8_t is_secure_call;
  /**<   A value of TRUE requests that the call be upgraded to a secure call.
      A value of FALSE requests a non-secure call.
  */
 ...
 */
  ...
  /* Optional */
  /*  Flag to indicate if the call is secure call */
  uint8_t is_secure_call_valid;  /**< Must be set to true if is_secure_call is being passed */
  uint8_t is_secure_call;
  /**<   Indicates whether the call should be secure.
  */
 ...
 */
  ...
  /* Optional */
  /*  Flag to indicate if this is a secure call */
  uint8_t is_secure_call_valid;  /**< Must be set to true if is_secure_call is being passed */
  uint8_t is_secure_call;
  /**<   Indicates current call is a secure call.
  */
...
typedef enum {
  ...
  VOICE_NETWORK_MODE_WLAN_V02 = 0x06,
...
typedef struct {
  ...
  /**<   Network mode. Values: \n
      - VOICE_NETWORK_MODE_NONE (0x00) --
      - VOICE_NETWORK_MODE_GSM (0x01) --
      - VOICE_NETWORK_MODE_WCDMA (0x02) --
      - VOICE_NETWORK_MODE_CDMA (0x03) --
      - VOICE_NETWORK_MODE_LTE (0x04) --
      - VOICE_NETWORK_MODE_TDSCDMA (0x05) --
      - VOICE_NETWORK_MODE_WLAN (0x06) --
 */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Indicates the plmns to avoid.  */
typedef struct {
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Indicates the plmns to avoid.  */
typedef struct {
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Request Message; Allows APPS to query for speech_codec when they have not registered for speech codec indications. */
typedef struct {

  /* Mandatory */
  /*  Call ID */
  uint8_t call_id;
  /**<   Call ID of the call for which speech_codec is required.
  */
...
/** @addtogroup voice_qmi_messages
    @{
  */
/** Response Message; Allows APPS to query for speech_codec when they have not registered for speech codec indications. */
typedef struct {
...
typedef struct {
  ...
  /*  Call ID */
  uint8_t call_id;
  /**<   Unique identifier for the call.Applicable for all cancel_types
  */

  /* Mandatory */
  /*  Call cancel type */
  voip_cancel_type_enum_v02 cancel_type;
  /**<   Cancel service t?ype during the call \n
...
//#define REMOVE_QMI_VOICE_IMS_CALL_CANCEL_OPERATION_V02
