...
void* initGENERICOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_CMDID, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_cmdID)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_01, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_01)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_02, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_02)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_03, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_03)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_04, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_04)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_05, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_05)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_06, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_06)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_07, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_07)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_08, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_08)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_09, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_09)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_10, (A_UINT32)(((A_UINT8 *)&(pGENERICParms->generic_param_10)) - (A_UINT8 *)pGENERICParms), pParmsOffset);
...
void* initGENERICRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_CMDID, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_cmdID)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_01, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_01)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_02, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_02)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_03, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_03)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_04, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_04)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_05, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_05)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_06, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_06)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_07, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_07)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_08, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_08)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_09, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_09)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_GENERIC_PARAM_10, (A_UINT32)(((A_UINT8 *)&(pGENERICRSPParms->generic_param_10)) - (A_UINT8 *)pGENERICRSPParms), pParmsOffset);
