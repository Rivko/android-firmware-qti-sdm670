...
void* initLMQUERYOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_LM_CMDID, (A_UINT32)(((A_UINT8 *)&(pLMQUERYParms->lm_cmdId)) - (A_UINT8 *)pLMQUERYParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PAD3, (A_UINT32)(((A_UINT8 *)&(pLMQUERYParms->pad3)) - (A_UINT8 *)pLMQUERYParms), pParmsOffset);
...
void* initLMQUERYRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pLMQUERYRSPParms->status)) - (A_UINT8 *)pLMQUERYRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_CMDID, (A_UINT32)(((A_UINT8 *)&(pLMQUERYRSPParms->lm_cmdId)) - (A_UINT8 *)pLMQUERYRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PAD2, (A_UINT32)(((A_UINT8 *)&(pLMQUERYRSPParms->pad2)) - (A_UINT8 *)pLMQUERYRSPParms), pParmsOffset);
