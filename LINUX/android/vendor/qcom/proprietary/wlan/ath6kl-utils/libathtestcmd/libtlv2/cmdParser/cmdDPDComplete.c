...
void* initGETDPDCOMPLETEOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pGETDPDCOMPLETEParms->phyId)) - (A_UINT8 *)pGETDPDCOMPLETEParms), pParmsOffset);
...
void* initGETDPDCOMPLETERSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_DPDCOMPLETE, (A_UINT32)(((A_UINT8 *)&(pGETDPDCOMPLETERSPParms->dpdComplete)) - (A_UINT8 *)pGETDPDCOMPLETERSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pGETDPDCOMPLETERSPParms->phyId)) - (A_UINT8 *)pGETDPDCOMPLETERSPParms), pParmsOffset);
