...
void* initDPDAGC2PWROpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pDPDAGC2PWRParms->phyId)) - (A_UINT8 *)pDPDAGC2PWRParms), pParmsOffset);
...
void* initDPDAGC2PWRRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pDPDAGC2PWRRSPParms->phyId)) - (A_UINT8 *)pDPDAGC2PWRRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DPDAGC2PWR, (A_UINT32)(((A_UINT8 *)&(pDPDAGC2PWRRSPParms->DPDAgc2Pwr)) - (A_UINT8 *)pDPDAGC2PWRRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pDPDAGC2PWRRSPParms->status)) - (A_UINT8 *)pDPDAGC2PWRRSPParms), pParmsOffset);
