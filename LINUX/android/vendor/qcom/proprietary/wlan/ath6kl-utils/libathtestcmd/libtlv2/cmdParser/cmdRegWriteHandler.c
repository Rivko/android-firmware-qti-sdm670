...
void* initREGWRITEOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_REGADDRESS, (A_UINT32)(((A_UINT8 *)&(pREGWRITEParms->regaddress)) - (A_UINT8 *)pREGWRITEParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_REGVALUE, (A_UINT32)(((A_UINT8 *)&(pREGWRITEParms->regvalue)) - (A_UINT8 *)pREGWRITEParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RADIOID, (A_UINT32)(((A_UINT8 *)&(pREGWRITEParms->radioId)) - (A_UINT8 *)pREGWRITEParms), pParmsOffset);
...
void* initREGWRITERSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pREGWRITERSPParms->status)) - (A_UINT8 *)pREGWRITERSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RADIOID, (A_UINT32)(((A_UINT8 *)&(pREGWRITERSPParms->radioId)) - (A_UINT8 *)pREGWRITERSPParms), pParmsOffset);
