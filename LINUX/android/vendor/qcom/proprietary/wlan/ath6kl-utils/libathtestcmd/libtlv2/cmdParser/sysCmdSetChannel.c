...
void* initSETCHANNELOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)SYSPARM_PHY_MASK, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->phy_mask)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_RADIO_MASK, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->radio_mask)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_CROSSING, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->crossing)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_XCONNECTION, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->xconnection)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_CENTER_CHANNEL_R0, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->center_channel_R0)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_CENTER_CHANNEL_R1, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->center_channel_R1)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_BW_R0, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->BW_R0)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_BW_R1, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->BW_R1)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_MODE, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->mode)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_PRIMARY_LOCATION_R0, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->primary_location_R0)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_PRIMARY_LOCATION_R1, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->primary_location_R1)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_CAL_MASK, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->cal_mask)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_FORCE_CAL_MASK, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELParms->force_cal_mask)) - (A_UINT8 *)pSETCHANNELParms), pParmsOffset);
...
void* initSETCHANNELRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)SYSPARM_PHY_MASK, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->phy_mask)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_RADIO_MASK, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->radio_mask)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_CROSSING, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->crossing)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_XCONNECTION, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->xconnection)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_CENTER_CHANNEL_R0, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->center_channel_R0)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_CENTER_CHANNEL_R1, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->center_channel_R1)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_BW_R0, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->BW_R0)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_BW_R1, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->BW_R1)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_MODE, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->mode)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_PRIMARY_LOCATION_R0, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->primary_location_R0)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_PRIMARY_LOCATION_R1, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->primary_location_R1)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_CAL_MASK, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->cal_mask)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_FORCE_CAL_MASK, (A_UINT32)(((A_UINT8 *)&(pSETCHANNELRSPParms->force_cal_mask)) - (A_UINT8 *)pSETCHANNELRSPParms), pParmsOffset);
