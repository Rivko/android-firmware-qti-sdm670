...
void* initTESTDATAOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)SYSPARM_DATA1, (A_UINT32)(((A_UINT8 *)&(pTESTDATAParms->data1)) - (A_UINT8 *)pTESTDATAParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_DATA2, (A_UINT32)(((A_UINT8 *)&(pTESTDATAParms->data2)) - (A_UINT8 *)pTESTDATAParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_DATA3, (A_UINT32)(((A_UINT8 *)&(pTESTDATAParms->data3)) - (A_UINT8 *)pTESTDATAParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_DATA4, (A_UINT32)(((A_UINT8 *)&(pTESTDATAParms->data4)) - (A_UINT8 *)pTESTDATAParms), pParmsOffset);
...
void* initTESTDATARSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)SYSPARM_STATUS32, (A_UINT32)(((A_UINT8 *)&(pTESTDATARSPParms->status32)) - (A_UINT8 *)pTESTDATARSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_DATA1, (A_UINT32)(((A_UINT8 *)&(pTESTDATARSPParms->data1)) - (A_UINT8 *)pTESTDATARSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_DATA2, (A_UINT32)(((A_UINT8 *)&(pTESTDATARSPParms->data2)) - (A_UINT8 *)pTESTDATARSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_DATA3, (A_UINT32)(((A_UINT8 *)&(pTESTDATARSPParms->data3)) - (A_UINT8 *)pTESTDATARSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)SYSPARM_DATA4, (A_UINT32)(((A_UINT8 *)&(pTESTDATARSPParms->data4)) - (A_UINT8 *)pTESTDATARSPParms), pParmsOffset);
