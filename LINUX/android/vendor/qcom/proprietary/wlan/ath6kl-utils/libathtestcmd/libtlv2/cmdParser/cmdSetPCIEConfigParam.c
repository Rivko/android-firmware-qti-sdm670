...
void* initSETPCIECONFIGPARAMSOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PCIEADDR, (A_UINT32)(((A_UINT8 *)&(pSETPCIECONFIGPARAMSParms->pcieAddr)) - (A_UINT8 *)pSETPCIECONFIGPARAMSParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PCIEVALUE, (A_UINT32)(((A_UINT8 *)&(pSETPCIECONFIGPARAMSParms->pcieValue)) - (A_UINT8 *)pSETPCIECONFIGPARAMSParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_OPERATION, (A_UINT32)(((A_UINT8 *)&(pSETPCIECONFIGPARAMSParms->operation)) - (A_UINT8 *)pSETPCIECONFIGPARAMSParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_SIZE, (A_UINT32)(((A_UINT8 *)&(pSETPCIECONFIGPARAMSParms->size)) - (A_UINT8 *)pSETPCIECONFIGPARAMSParms), pParmsOffset);
