...
void* initLMCHANNELLISTOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_LM_FLAG, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_flag)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_ITEMNUM, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_itemNum)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PAD2, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->pad2)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_CBSTATE, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_cbState)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_CHAINMASK, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_chainMask)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_TXPOWER, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_txPower)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_PHYID, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_phyId)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_FREQ, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_freq)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_FREQ2, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_freq2)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LM_RATEINDEX, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTParms->lm_rateIndex)) - (A_UINT8 *)pLMCHANNELLISTParms), pParmsOffset);
...
void* initLMCHANNELLISTRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTRSPParms->status)) - (A_UINT8 *)pLMCHANNELLISTRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_TOTALHWCALNUM, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTRSPParms->totalHWCalNum)) - (A_UINT8 *)pLMCHANNELLISTRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_TOTALITEMNUM, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTRSPParms->totalItemNum)) - (A_UINT8 *)pLMCHANNELLISTRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_HWCALTIME, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTRSPParms->hwCalTime)) - (A_UINT8 *)pLMCHANNELLISTRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PAD2, (A_UINT32)(((A_UINT8 *)&(pLMCHANNELLISTRSPParms->pad2)) - (A_UINT8 *)pLMCHANNELLISTRSPParms), pParmsOffset);
