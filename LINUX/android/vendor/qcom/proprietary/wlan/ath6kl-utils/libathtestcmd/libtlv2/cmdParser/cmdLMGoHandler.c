...
void* initLMGOOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_LM_CMDID, (A_UINT32)(((A_UINT8 *)&(pLMGOParms->lm_cmdId)) - (A_UINT8 *)pLMGOParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PAD3, (A_UINT32)(((A_UINT8 *)&(pLMGOParms->pad3)) - (A_UINT8 *)pLMGOParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_TIMEON, (A_UINT32)(((A_UINT8 *)&(pLMGOParms->timeOn)) - (A_UINT8 *)pLMGOParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_TIMEOFF, (A_UINT32)(((A_UINT8 *)&(pLMGOParms->timeOff)) - (A_UINT8 *)pLMGOParms), pParmsOffset);
...
void* initLMGORSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_LM_CMDID, (A_UINT32)(((A_UINT8 *)&(pLMGORSPParms->lm_cmdId)) - (A_UINT8 *)pLMGORSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pLMGORSPParms->status)) - (A_UINT8 *)pLMGORSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PAD2, (A_UINT32)(((A_UINT8 *)&(pLMGORSPParms->pad2)) - (A_UINT8 *)pLMGORSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_TIMEON, (A_UINT32)(((A_UINT8 *)&(pLMGORSPParms->timeOn)) - (A_UINT8 *)pLMGORSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_TIMEOFF, (A_UINT32)(((A_UINT8 *)&(pLMGORSPParms->timeOff)) - (A_UINT8 *)pLMGORSPParms), pParmsOffset);
