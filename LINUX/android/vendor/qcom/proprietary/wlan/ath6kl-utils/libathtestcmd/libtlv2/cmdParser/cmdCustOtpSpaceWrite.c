...
void* initWRITECUSTOTPSPACEOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_OFFSETADDR, (A_UINT32)(((A_UINT8 *)&(pWRITECUSTOTPSPACEParms->offsetAddr)) - (A_UINT8 *)pWRITECUSTOTPSPACEParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CUSTDATA, (A_UINT32)(((A_UINT8 *)&(pWRITECUSTOTPSPACEParms->custData)) - (A_UINT8 *)pWRITECUSTOTPSPACEParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CUSTDATASIZE, (A_UINT32)(((A_UINT8 *)&(pWRITECUSTOTPSPACEParms->custDataSize)) - (A_UINT8 *)pWRITECUSTOTPSPACEParms), pParmsOffset);
...
void* initWRITECUSTOTPSPACERSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_WRITESTATUS, (A_UINT32)(((A_UINT8 *)&(pWRITECUSTOTPSPACERSPParms->writeStatus)) - (A_UINT8 *)pWRITECUSTOTPSPACERSPParms), pParmsOffset);
