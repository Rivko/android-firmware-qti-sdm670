...
void* initLMHWCALRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pLMHWCALRSPParms->phyId)) - (A_UINT8 *)pLMHWCALRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pLMHWCALRSPParms->status)) - (A_UINT8 *)pLMHWCALRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_HWCALTIME, (A_UINT32)(((A_UINT8 *)&(pLMHWCALRSPParms->hwCalTime)) - (A_UINT8 *)pLMHWCALRSPParms), pParmsOffset);
