...
void* initREGREADOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_REGADDRESS, (A_UINT32)(((A_UINT8 *)&(pREGREADParms->regaddress)) - (A_UINT8 *)pREGREADParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RADIOID, (A_UINT32)(((A_UINT8 *)&(pREGREADParms->radioId)) - (A_UINT8 *)pREGREADParms), pParmsOffset);
...
void* initREGREADRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_REGVALUE, (A_UINT32)(((A_UINT8 *)&(pREGREADRSPParms->regvalue)) - (A_UINT8 *)pREGREADRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RADIOID, (A_UINT32)(((A_UINT8 *)&(pREGREADRSPParms->radioId)) - (A_UINT8 *)pREGREADRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pREGREADRSPParms->status)) - (A_UINT8 *)pREGREADRSPParms), pParmsOffset);
