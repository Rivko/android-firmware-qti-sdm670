...
void* initDPDTRAININGQUALITYOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pDPDTRAININGQUALITYParms->phyId)) - (A_UINT8 *)pDPDTRAININGQUALITYParms), pParmsOffset);
...
void* initDPDTRAININGQUALITYRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_DPDTRAINQUAL, (A_UINT32)(((A_UINT8 *)&(pDPDTRAININGQUALITYRSPParms->DPDTrainQual)) - (A_UINT8 *)pDPDTRAININGQUALITYRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pDPDTRAININGQUALITYRSPParms->status)) - (A_UINT8 *)pDPDTRAININGQUALITYRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pDPDTRAININGQUALITYRSPParms->phyId)) - (A_UINT8 *)pDPDTRAININGQUALITYRSPParms), pParmsOffset);
