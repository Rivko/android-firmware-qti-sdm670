...
void* initGETTGTPWROpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pGETTGTPWRParms->phyId)) - (A_UINT8 *)pGETTGTPWRParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_USERMODE, (A_UINT32)(((A_UINT8 *)&(pGETTGTPWRParms->userMode)) - (A_UINT8 *)pGETTGTPWRParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_FREQ, (A_UINT32)(((A_UINT8 *)&(pGETTGTPWRParms->freq)) - (A_UINT8 *)pGETTGTPWRParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RATEBIT, (A_UINT32)(((A_UINT8 *)&(pGETTGTPWRParms->rateBit)) - (A_UINT8 *)pGETTGTPWRParms), pParmsOffset);
...
void* initGETTGTPWRRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pGETTGTPWRRSPParms->phyId)) - (A_UINT8 *)pGETTGTPWRRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_TGTPWR, (A_UINT32)(((A_UINT8 *)&(pGETTGTPWRRSPParms->tgtPwr)) - (A_UINT8 *)pGETTGTPWRRSPParms), pParmsOffset);
