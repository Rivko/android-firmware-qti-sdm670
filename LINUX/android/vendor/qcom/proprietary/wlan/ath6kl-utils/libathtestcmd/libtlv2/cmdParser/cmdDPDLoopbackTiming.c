...
void* initDPDLOOPBACKTIMINGOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKTIMINGParms->phyId)) - (A_UINT8 *)pDPDLOOPBACKTIMINGParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DPDTIMINGIDX, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKTIMINGParms->DPDTimingIdx)) - (A_UINT8 *)pDPDLOOPBACKTIMINGParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DPDLOOPBACKATTN, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKTIMINGParms->DPDLoopbackAttn)) - (A_UINT8 *)pDPDLOOPBACKTIMINGParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_GLUTIDX, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKTIMINGParms->glutIdx)) - (A_UINT8 *)pDPDLOOPBACKTIMINGParms), pParmsOffset);
...
void* initDPDLOOPBACKTIMINGRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKTIMINGRSPParms->phyId)) - (A_UINT8 *)pDPDLOOPBACKTIMINGRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKTIMINGRSPParms->status)) - (A_UINT8 *)pDPDLOOPBACKTIMINGRSPParms), pParmsOffset);
