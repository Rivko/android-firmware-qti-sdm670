...
void* initRXDCOGROUPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_CMDIDRXDCOGROUP, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->cmdIdRxDcoGroup)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->phyId)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BBDCOCRANGE, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->bbDcocRange)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFDCOCRANGE, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->rfDcocRange)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CHAINMASK, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->chainMask)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LPBKMODE, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->lpbkMode)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFFIRST, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->rfFirst)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_INITLUT, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->initLUT)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFOVRD, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->rfOvrd)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BBOVRD, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->bbOvrd)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_NUMGAIN, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->numGain)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BAND, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->band)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CHAIN, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->chain)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFBB, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->rfBB)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DEPTH, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->depth)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_USECOSIMSETTING, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->useCosimSetting)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_GAINLUT, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->gainLut)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFDOCLUT, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->rfDocLut)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BBDOCLUT, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->bbDocLut)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_INPUTTABLE2SWPROCESSING, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->inputTable2SwProcessing)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_SLEEPTIME, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->sleepTime)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_THRESHOLD, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPParms->threshold)) - (A_UINT8 *)pRXDCOGROUPParms), pParmsOffset);
...
void* initRXDCOGROUPRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_CMDIDRXDCOGROUP, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->cmdIdRxDcoGroup)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->phyId)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BBDCOCRANGE, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->bbDcocRange)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFDCOCRANGE, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->rfDcocRange)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CHAINMASK, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->chainMask)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_LPBKMODE, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->lpbkMode)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFFIRST, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->rfFirst)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_INITLUT, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->initLUT)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFOVRD, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->rfOvrd)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BBOVRD, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->bbOvrd)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_NUMGAIN, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->numGain)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BAND, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->band)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CHAIN, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->chain)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFBB, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->rfBB)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DEPTH, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->depth)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PADDING, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->padding)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_EXECUTIONTIME, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->executionTime)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_GAINLUT, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->gainLut)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DCOI, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->dcoI)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DCOQ, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->dcoQ)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_RFDOCLUT, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->rfDocLut)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_BBDOCLUT, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->bbDocLut)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_HWPROCESSEDTABLE, (A_UINT32)(((A_UINT8 *)&(pRXDCOGROUPRSPParms->hwProcessedTable)) - (A_UINT8 *)pRXDCOGROUPRSPParms), pParmsOffset);
