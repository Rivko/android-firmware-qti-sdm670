...
void* initCALCALTIMEOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pCALCALTIMEParms->phyId)) - (A_UINT8 *)pCALCALTIMEParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CALOP, (A_UINT32)(((A_UINT8 *)&(pCALCALTIMEParms->calOp)) - (A_UINT8 *)pCALCALTIMEParms), pParmsOffset);
...
void* initCALCALTIMERSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_ELAPSEDTIME, (A_UINT32)(((A_UINT8 *)&(pCALCALTIMERSPParms->elapsedTime)) - (A_UINT8 *)pCALCALTIMERSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pCALCALTIMERSPParms->status)) - (A_UINT8 *)pCALCALTIMERSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pCALCALTIMERSPParms->phyId)) - (A_UINT8 *)pCALCALTIMERSPParms), pParmsOffset);
