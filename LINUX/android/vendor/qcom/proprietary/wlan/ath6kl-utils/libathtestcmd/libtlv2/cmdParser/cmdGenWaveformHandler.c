...
void* initGENWAVEFORMOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_WAVEFORMINDEX, (A_UINT32)(((A_UINT8 *)&(pGENWAVEFORMParms->waveformIndex)) - (A_UINT8 *)pGENWAVEFORMParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pGENWAVEFORMParms->phyId)) - (A_UINT8 *)pGENWAVEFORMParms), pParmsOffset);
...
void* initGENWAVEFORMRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_DATAI, (A_UINT32)(((A_UINT8 *)&(pGENWAVEFORMRSPParms->dataI)) - (A_UINT8 *)pGENWAVEFORMRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DATAQ, (A_UINT32)(((A_UINT8 *)&(pGENWAVEFORMRSPParms->dataQ)) - (A_UINT8 *)pGENWAVEFORMRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pGENWAVEFORMRSPParms->status)) - (A_UINT8 *)pGENWAVEFORMRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pGENWAVEFORMRSPParms->phyId)) - (A_UINT8 *)pGENWAVEFORMRSPParms), pParmsOffset);
