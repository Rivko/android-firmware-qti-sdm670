...
void* initMORESEGMENTOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_CMDID, (A_UINT32)(((A_UINT8 *)&(pMORESEGMENTParms->cmdId)) - (A_UINT8 *)pMORESEGMENTParms), pParmsOffset);
...
void* initMORESEGMENTRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_CMDID, (A_UINT32)(((A_UINT8 *)&(pMORESEGMENTRSPParms->cmdId)) - (A_UINT8 *)pMORESEGMENTRSPParms), pParmsOffset);
