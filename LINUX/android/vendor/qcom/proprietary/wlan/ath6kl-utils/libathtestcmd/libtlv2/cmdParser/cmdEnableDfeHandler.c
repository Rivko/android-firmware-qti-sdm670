...
void* initENABLEDFEOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pENABLEDFEParms->phyId)) - (A_UINT8 *)pENABLEDFEParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_ENABLE, (A_UINT32)(((A_UINT8 *)&(pENABLEDFEParms->enable)) - (A_UINT8 *)pENABLEDFEParms), pParmsOffset);
...
void* initENABLEDFERSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pENABLEDFERSPParms->phyId)) - (A_UINT8 *)pENABLEDFERSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pENABLEDFERSPParms->status)) - (A_UINT8 *)pENABLEDFERSPParms), pParmsOffset);
