...
extern MANLIB_API ATHEROS_REG_FILE stickyRegTbl[STICKY_REG_TBL_SIZE_MAX];
extern MANLIB_API MODE_INFO stickyModRegTbl[STICKY_REG_TBL_SIZE_MAX];
extern MANLIB_API A_UINT32  STICKY_REG_TBL_SIZE;
extern MANLIB_API A_UINT32  STICKY_MOD_REG_TBL_SIZE;
