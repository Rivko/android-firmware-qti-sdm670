...
void* initDPDLOOPBACKATTNOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKATTNParms->phyId)) - (A_UINT8 *)pDPDLOOPBACKATTNParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_DPDLOOPBACKATTN, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKATTNParms->DPDLoopbackAttn)) - (A_UINT8 *)pDPDLOOPBACKATTNParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_GLUTIDX, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKATTNParms->glutIdx)) - (A_UINT8 *)pDPDLOOPBACKATTNParms), pParmsOffset);
...
void* initDPDLOOPBACKATTNRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKATTNRSPParms->phyId)) - (A_UINT8 *)pDPDLOOPBACKATTNRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pDPDLOOPBACKATTNRSPParms->status)) - (A_UINT8 *)pDPDLOOPBACKATTNRSPParms), pParmsOffset);
