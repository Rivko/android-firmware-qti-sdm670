...
void* initXTALCALPROCOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    fillParmOffsetTbl((A_UINT32)PARM_CAPIN, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCParms->capIn)) - (A_UINT8 *)pXTALCALPROCParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CAPOUT, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCParms->capOut)) - (A_UINT8 *)pXTALCALPROCParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CTRLFLAG, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCParms->ctrlFlag)) - (A_UINT8 *)pXTALCALPROCParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCParms->phyId)) - (A_UINT8 *)pXTALCALPROCParms), pParmsOffset);
...
void* initXTALCALPROCRSPOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    // Make up ParmOffsetTbl
    resetParmOffsetFields();
    fillParmOffsetTbl((A_UINT32)PARM_STATUS, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCRSPParms->status)) - (A_UINT8 *)pXTALCALPROCRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CAPVALMIN, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCRSPParms->capValMin)) - (A_UINT8 *)pXTALCALPROCRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CAPVALMAX, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCRSPParms->capValMax)) - (A_UINT8 *)pXTALCALPROCRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CAPIN, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCRSPParms->capIn)) - (A_UINT8 *)pXTALCALPROCRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_CAPOUT, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCRSPParms->capOut)) - (A_UINT8 *)pXTALCALPROCRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PLLLOCKED, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCRSPParms->pllLocked)) - (A_UINT8 *)pXTALCALPROCRSPParms), pParmsOffset);
    fillParmOffsetTbl((A_UINT32)PARM_PHYID, (A_UINT32)(((A_UINT8 *)&(pXTALCALPROCRSPParms->phyId)) - (A_UINT8 *)pXTALCALPROCRSPParms), pParmsOffset);
