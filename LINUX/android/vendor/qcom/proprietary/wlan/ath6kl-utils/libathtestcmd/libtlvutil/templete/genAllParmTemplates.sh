...
./Linux/genParmTemplate.out ${WORKAREA}/include/systemtools/common/cmdNartGenericCmdParms.h
./Linux/genParmTemplate.out ${WORKAREA}/include/systemtools/common/cmdNartGenericRspParms.h
./Linux/genParmTemplate.out ${WORKAREA}/include/systemtools/common/cmdTxStatus.h
./Linux/genParmTemplate.out ${WORKAREA}/include/systemtools/common/cmdRxStatus.h
