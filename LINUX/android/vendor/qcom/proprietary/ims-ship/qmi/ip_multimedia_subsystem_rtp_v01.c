...
static const uint8_t imsrtp_session_video_capability_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(imsrtp_session_video_capability_req_msg_v01, app_id) - QMI_IDL_OFFSET8(imsrtp_session_video_capability_req_msg_v01, app_id_valid)),
  0x14,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry imsrtp_service_command_messages_v01[] = {
  ...
  {QMI_IMSRTP_SESSION_VIDEO_CAPABILITY_REQ_V01, QMI_IDL_TYPE16(0, 74), 50},
...
static const qmi_idl_service_message_table_entry imsrtp_service_indication_messages_v01[] = {
  ...
  {QMI_IMS_RTP_VIDEO_ERROR_IND_V01, QMI_IDL_TYPE16(0, 67), 7},
