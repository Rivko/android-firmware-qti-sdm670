...
#define CAMERA_WAIT_FOR_BUFFERS 3
...
/* Callback to receive camera frames with native handle */
typedef void (*ims_recording_frame_handle_callback_timestamp)(nsecs_t timestamp,
...
// Registering the call backs to receive camera frames data and control
