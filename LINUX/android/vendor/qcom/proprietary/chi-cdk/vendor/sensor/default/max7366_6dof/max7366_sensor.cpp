...
static const UINT   o6dofRegisterGainDecimator = 16;                                   ///< Maximum digital register gain
...
static FLOAT RegisterToRealGain(
    UINT registerGain)
{
    return static_cast<FLOAT>(registerGain / o6dofRegisterGainDecimator);
}
...
static UINT RealToRegisterGain(
    FLOAT realGain)
{
    return static_cast<UINT>(realGain * o6dofRegisterGainDecimator);
}
