...
LOCAL_PATH := $(CAMX_CHICDK_PATH)/vendor/node/staticaecalgo
endif
...
LOCAL_C_INCLUDES +=                         \
    $(CAMX_CDK_PATH)                        \
    $(CAMX_CDK_PATH)/stats                  \
    $(CAMX_VENDOR_PATH)/node/staticaecalgo       \
    $(CAMX_VENDOR_PATH)/node/staticaecalgo/inc
...
# Binary name
LOCAL_MODULE := com.qtistatic.stats.aec
