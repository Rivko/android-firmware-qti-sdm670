...
LOCAL_PATH := $(CAMX_CHICDK_PATH)/vendor/node/staticawbalgo
endif
...
LOCAL_C_INCLUDES += $(CAMX_CDK_PATH)        \
    $(CAMX_CDK_PATH)/stats                  \
    $(CAMX_VENDOR_PATH)/node/staticawbalgo       \
    $(CAMX_VENDOR_PATH)/node/staticawbalgo/inc
...
# Binary name
LOCAL_MODULE := com.qtistatic.stats.awb
