...
class complex_general_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, selected_signer=None, selected_encryptor=None, selected_cert_config=None, max_cert_size=None, key_size=None, num_certs_in_certchain=None, num_root_certs=None, testsig_serialnum=None, mrc_index=None, msm_part=None, oem_id=None, model_id=None, sw_id=None, app_id=None, crash_dump=None, rot_en=None, soc_hw_version=None, soc_vers=None, mask_soc_hw_version=None, in_use_soc_hw_version=None, use_serial_number_in_signing=None, serial_number=None, debug=None, debug_serials=None, exponent=None, object_id=None, pmbl_properties=None, cass_capability=None, hash_pageseg_as_segment=None, hash_algorithm=None, segment_hash_algorithm=None, cass_attest_cert=None, rsa_padding=None, hmac=None, secboot_version=None, qc_sign=False, oem_sign=True, UIE_key=None, UIE_capability=None, UIE_root_key_type=None, oem_id_independent=None, revocation_enablement=None, activation_enablement=None, dsa_type=None, ecdsa_curve=None):
        ...
        self.debug = debug
        self.debug_serials = debug_serials
    ...
    def get_debug_serials(self): return self.debug_serials
    def set_debug_serials(self, debug_serials): self.debug_serials = debug_serials
    ...
    def get_qc_sign(self): return self.qc_sign
    def set_qc_sign(self, qc_sign): self.qc_sign = qc_sign
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='complex_general_properties', fromsubclass_=False):
        ...
        if self.debug_serials is not None:
            self.debug_serials.export(outfile, level, namespace_, name_='debug_serials')
        ...
        if self.qc_sign is not None:
            showIndent(outfile, level)
            outfile.write('<%sqc_sign>%s</%sqc_sign>\n' % (namespace_, self.gds_format_boolean(self.gds_str_lower(str(self.qc_sign)), input_name='qc_sign'), namespace_))
    ...
    def hasContent_(self):
        if (
            ...
            self.debug_serials is not None or
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.debug_serials is not None:
            showIndent(outfile, level)
            outfile.write('debug_serials=model_.complex_debug_serials(\n')
            self.debug_serials.exportLiteral(outfile, level, name_='debug_serials')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.exponent is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'selected_signer':
            ...
            self.debug = debug_
        elif nodeName_ == 'debug_serials':
            obj_ = complex_debug_serials.factory()
            obj_.build(child_)
            self.set_debug_serials(obj_)
            ...
            if sval_ in ('true', '1'):
                ...
                raise_parse_error(child_, 'requires boolean')
            ival_ = self.gds_validate_boolean(ival_, node, 'qc_sign')
            self.qc_sign = ival_
...
class complex_debug_serials(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, serial=None):
        if serial is None:
            ...
            self.serial = serial
    def factory(*args_, **kwargs_):
        if complex_debug_serials.subclass:
            return complex_debug_serials.subclass(*args_, **kwargs_)
        else:
            return complex_debug_serials(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='tns:', name_='complex_debug_serials', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='complex_debug_serials')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='complex_debug_serials'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='complex_debug_serials', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='complex_debug_serials'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
...
# end class complex_debug_serials
...
class complex_general_properties_overrides(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, max_cert_size=None, key_size=None, num_certs_in_certchain=None, num_root_certs=None, testsig_serialnum=None, mrc_index=None, msm_part=None, oem_id=None, model_id=None, sw_id=None, app_id=None, crash_dump=None, rot_en=None, soc_hw_version=None, soc_vers=None, mask_soc_hw_version=None, in_use_soc_hw_version=None, use_serial_number_in_signing=None, serial_number=None, debug=None, debug_serials=None, exponent=None, object_id=None, cass_capability=None, hash_pageseg_as_segment=None, hash_algorithm=None, segment_hash_algorithm=None, cass_attest_cert=None, rsa_padding=None, hmac=None, secboot_version=None, qc_sign=None, oem_sign=None, UIE_key=None, UIE_capability=None, UIE_root_key_type=None, oem_id_independent=None, revocation_enablement=None, activation_enablement=None, dsa_type=None, ecdsa_curve=None):
        self.max_cert_size = max_cert_size
        self.key_size = key_size
        self.num_certs_in_certchain = num_certs_in_certchain
        self.num_root_certs = num_root_certs
