...
class EncryptionParameters(BaseEncryptionParameters):
    ...
    def _generate_new_encryption_params_blob(self):
        ...
        self.l1_nonce = os.urandom(EncryptionParameters.L1_IV_LEN_BYTES)
        ...
        self.l2_nonce = os.urandom(EncryptionParameters.L2_IV_LEN_BYTES)
        ...
        self.l3_image_iv = os.urandom(EncryptionParameters.L3_IV_LEN_BYTES)
