...
from sectools.features.isc.encryption_service.utility_functions import compute_segment_iv_uie_1_0
import binascii
...
class Decryptor(BaseDecryptor):
    ...
    def decrypt_segment(self, encrypted_binary_segment, segment_num):
        '''
        '''
        computed_segment_iv = compute_segment_iv_uie_1_0(segment_num, self.encryption_parameters.get_image_encryption_iv())
