...
const qcril_qmi_ims_msg_meta_type qcril_qmi_ims_msg_meta_data[] =
{
    ...
    {ims_MsgId_REQUEST_CONFERENCE,                           ims_MsgType_RESPONSE, ims_SipErrorInfo_fields,                    sizeof(ims_SipErrorInfo),                    QCRIL_EVT_NONE,                                                "IMS_CONFERENCE RESP"},
    ...
    {ims_MsgId_REQUEST_EXPLICIT_CALL_TRANSFER, ims_MsgType_REQUEST, ims_ExplicitCallTransfer_fields, sizeof(ims_ExplicitCallTransfer), QCRIL_EVT_IMS_SOCKET_REQ_EXPLICIT_CALL_TRANSFER, "IMS_EXPLICIT_CALL_TRANSFER REQ"},
    {ims_MsgId_REQUEST_EXPLICIT_CALL_TRANSFER, ims_MsgType_RESPONSE, NULL,            0,                QCRIL_EVT_NONE,                     "IMS_EXPLICIT_CALL_TRANSFER RESP"},
    ...
    {ims_MsgId_REQUEST_ADD_PARTICIPANT,           ims_MsgType_RESPONSE, ims_SipErrorInfo_fields,  sizeof(ims_SipErrorInfo),  QCRIL_EVT_NONE,                                     "IMS_ADD_PARTICIPANT RESP"},
    ...
    {ims_MsgId_REQUEST_SET_COLR, ims_MsgType_RESPONSE, ims_SuppSvcResponse_fields, sizeof(ims_SuppSvcResponse), QCRIL_EVT_NONE, "IMS_SET_COLR RESP"},
    ...
    {ims_MsgId_REQUEST_HOLD,   ims_MsgType_RESPONSE, ims_SipErrorInfo_fields,  sizeof(ims_SipErrorInfo),                QCRIL_EVT_NONE,                  "IMS_HOLD RESP"},
    ...
    {ims_MsgId_REQUEST_RESUME, ims_MsgType_RESPONSE, ims_SipErrorInfo_fields,  sizeof(ims_SipErrorInfo),                  QCRIL_EVT_NONE,                  "IMS_RESUME RESP"},
    ...
    {ims_MsgId_REQUEST_GET_RTP_STATISTICS,       ims_MsgType_REQUEST,  NULL,                         0,                             QCRIL_EVT_IMS_SOCKET_REQ_GET_RTP_STATISTICS,       "IMS_GET_RTP_STATISTICS REQ"},
    {ims_MsgId_REQUEST_GET_RTP_STATISTICS,       ims_MsgType_RESPONSE, ims_RtpStatisticsData_fields, sizeof(ims_RtpStatisticsData), QCRIL_EVT_NONE,                                    "IMS_GET_RTP_STATISTICS RESP"},
    {ims_MsgId_REQUEST_GET_RTP_ERROR_STATISTICS, ims_MsgType_REQUEST,  NULL,                         0,                             QCRIL_EVT_IMS_SOCKET_REQ_GET_RTP_ERROR_STATISTICS, "IMS_GET_RTP_ERROR_STATISTICS REQ"},
    {ims_MsgId_REQUEST_GET_RTP_ERROR_STATISTICS, ims_MsgType_RESPONSE, ims_RtpStatisticsData_fields, sizeof(ims_RtpStatisticsData), QCRIL_EVT_NONE,                                    "IMS_GET_RTP_ERROR_STATISTICS RESP"},

    {ims_MsgId_REQUEST_GET_WIFI_CALLING_STATUS, ims_MsgType_REQUEST,  NULL,                       0,                           QCRIL_EVT_IMS_SOCKET_REQ_GET_WIFI_CALLING_STATUS, "IMS_GET_WIFI_CALLING_STATUS REQ"},
    {ims_MsgId_REQUEST_GET_WIFI_CALLING_STATUS, ims_MsgType_RESPONSE, ims_WifiCallingInfo_fields, sizeof(ims_WifiCallingInfo), QCRIL_EVT_NONE,                                   "IMS_GET_WIFI_CALLING_STATUS RESP"},
    {ims_MsgId_REQUEST_SET_WIFI_CALLING_STATUS, ims_MsgType_REQUEST,  ims_WifiCallingInfo_fields, sizeof(ims_WifiCallingInfo), QCRIL_EVT_IMS_SOCKET_REQ_SET_WIFI_CALLING_STATUS, "IMS_SET_WIFI_CALLING_STATUS REQ"},
    {ims_MsgId_REQUEST_SET_WIFI_CALLING_STATUS, ims_MsgType_RESPONSE, NULL,                       0,                           QCRIL_EVT_NONE,                                   "IMS_SET_WIFI_CALLING_STATUS RESP"},

    {ims_MsgId_REQUEST_SET_IMS_CONFIG, ims_MsgType_REQUEST,  ims_ConfigMsg_fields, sizeof(ims_ConfigMsg), QCRIL_EVT_IMS_SOCKET_REQ_SET_IMS_CONFIG, "IMS_SET_IMS_CONFIG REQ"},
    {ims_MsgId_REQUEST_SET_IMS_CONFIG, ims_MsgType_RESPONSE, ims_ConfigMsg_fields, sizeof(ims_ConfigMsg), QCRIL_EVT_NONE,                          "IMS_SET_IMS_CONFIG RESP"},

    {ims_MsgId_REQUEST_GET_IMS_CONFIG, ims_MsgType_REQUEST,  ims_ConfigMsg_fields, sizeof(ims_ConfigMsg), QCRIL_EVT_IMS_SOCKET_REQ_GET_IMS_CONFIG, "IMS_GET_IMS_CONFIG REQ"},
    {ims_MsgId_REQUEST_GET_IMS_CONFIG, ims_MsgType_RESPONSE, ims_ConfigMsg_fields, sizeof(ims_ConfigMsg), QCRIL_EVT_NONE,                          "IMS_GET_IMS_CONFIG RESP"},
    {ims_MsgId_REQUEST_SEND_GEOLOCATION_INFO, ims_MsgType_REQUEST, ims_GeoLocationInfo_fields, sizeof(ims_GeoLocationInfo), QCRIL_EVT_IMS_SOCKET_REQ_SET_GEO_LOC,                          "IMS_SEND_GEOLOCATION_INFO REQ"},
    {ims_MsgId_REQUEST_SEND_GEOLOCATION_INFO, ims_MsgType_RESPONSE, NULL,                      0,                           QCRIL_EVT_NONE,                                                "IMS_SEND_GEOLOCATION_INFO RSP"},
    {ims_MsgId_REQUEST_GET_VOPS_INFO,    ims_MsgType_REQUEST,  NULL,                   0,                    QCRIL_EVT_IMS_SOCKET_REQ_GET_VOPS_INFO,   "IMS_GET_IMS_VOPS_INFO_REQ"},
    {ims_MsgId_REQUEST_GET_VOPS_INFO,    ims_MsgType_RESPONSE, ims_VopsInfo_fields,    sizeof(ims_VopsInfo), QCRIL_EVT_NONE,                           "IMS_GET_IMS_VOPS_INFO_RESP"},
    {ims_MsgId_REQUEST_GET_SSAC_INFO,    ims_MsgType_REQUEST,  NULL,                   0,                    QCRIL_EVT_IMS_SOCKET_REQ_GET_SSAC_INFO,   "IMS_GET_IMS_SSAC_INFO_REQ"},
    {ims_MsgId_REQUEST_GET_SSAC_INFO,    ims_MsgType_RESPONSE, ims_SsacInfo_fields,    sizeof(ims_SsacInfo), QCRIL_EVT_NONE,                           "IMS_GET_IMS_SSAC_INFO_RESP"},
    {ims_MsgId_UNSOL_REQUEST_GEOLOCATION, ims_MsgType_UNSOL_RESPONSE, ims_GeoLocationInfo_fields, sizeof(ims_GeoLocationInfo), QCRIL_EVT_NONE,                          "IMS_UNSOL_GEOLOCATION_INFO UNSOL"},
    {ims_MsgId_REQUEST_GET_VOWIFI_CALL_QUALITY, ims_MsgType_REQUEST, NULL, 0, QCRIL_EVT_IMS_SOCKET_REQ_GET_VOWIFI_CALL_QUALITY, "IMS_GET_VOWIFI_CALL_QUALITY REQ"},
    {ims_MsgId_REQUEST_GET_VOWIFI_CALL_QUALITY, ims_MsgType_RESPONSE, ims_VoWiFiCallQuality_fields, sizeof(ims_VoWiFiCallQuality), QCRIL_EVT_NONE, "IMS_GET_VOWIFI_CALL_QUALITY RSP"},
    {ims_MsgId_REQUEST_SET_VOLTE_PREF, ims_MsgType_REQUEST, ims_VolteUserPref_fields, sizeof(ims_VolteUserPref), QCRIL_EVT_IMS_SOCKET_REQ_SET_VOLTE_PREF, "IMS_SET_VOLTE_PREF REQ"},
    {ims_MsgId_REQUEST_SET_VOLTE_PREF, ims_MsgType_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_SET_VOLTE_PREF RSP"},
    {ims_MsgId_REQUEST_GET_VOLTE_PREF, ims_MsgType_REQUEST, NULL, 0, QCRIL_EVT_IMS_SOCKET_REQ_GET_VOLTE_PREF, "IMS_GET_VOLTE_PREF REQ"},
    {ims_MsgId_REQUEST_GET_VOLTE_PREF, ims_MsgType_RESPONSE, ims_VolteUserPref_fields, sizeof(ims_VolteUserPref), QCRIL_EVT_NONE, "IMS_GET_VOLTE_PREF RSP"},
    {ims_MsgId_REQUEST_GET_HANDOVER_CONFIG, ims_MsgType_REQUEST, NULL, 0, QCRIL_EVT_IMS_SOCKET_REQ_GET_HANDOVER_CONFIG, "IMS_GET_HANDOVER_CONFIG REQ"},
    {ims_MsgId_REQUEST_GET_HANDOVER_CONFIG, ims_MsgType_RESPONSE, ims_HandoverConfigMsg_fields, sizeof(ims_HandoverConfigMsg), QCRIL_EVT_NONE, "IMS_GET_HANDOVER_CONFIG RSP"},
    {ims_MsgId_REQUEST_SET_HANDOVER_CONFIG, ims_MsgType_REQUEST, ims_HandoverConfigMsg_fields, sizeof(ims_HandoverConfigMsg), QCRIL_EVT_IMS_SOCKET_REQ_SET_HANDOVER_CONFIG, "IMS_SET_HANDOVER_CONFIG REQ"},
    {ims_MsgId_REQUEST_SET_HANDOVER_CONFIG, ims_MsgType_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_SET_HANDOVER_CONFIG RSP"},
    {ims_MsgId_REQUEST_GET_IMS_SUB_CONFIG, ims_MsgType_REQUEST, NULL, 0, QCRIL_EVT_IMS_SOCKET_REQ_GET_IMS_SUB_CONFIG, "IMS_GET_IMS_SUB_CONFIG REQ"},
    {ims_MsgId_REQUEST_GET_IMS_SUB_CONFIG, ims_MsgType_RESPONSE, ims_ImsSubConfig_fields, sizeof(ims_ImsSubConfig), QCRIL_EVT_NONE, "IMS_GET_IMS_SUB_CONFIG RSP"},

    {ims_MsgId_REQUEST_SEND_RTT_MSG, ims_MsgType_REQUEST , ims_RttMessage_fields, sizeof(ims_RttMessage), QCRIL_EVT_IMS_SOCKET_REQ_SEND_RTT_MSG, "IMS_SEND_RTT_MSG REQ"},
    {ims_MsgId_REQUEST_SEND_RTT_MSG, ims_MsgType_RESPONSE, NULL                    , 0                         , QCRIL_EVT_NONE                       , "IMS_SEND_RTT_MSG RSP"},
    {ims_MsgId_REQUEST_CANCEL_MODIFY_CALL, ims_MsgType_REQUEST, ims_CancelModifyCall_fields, sizeof(ims_CancelModifyCall), QCRIL_EVT_IMS_SOCKET_REQ_CANCEL_MODIFY_CALL, "IMS_CANCEL_MODIFY_CALL REQ"},
    {ims_MsgId_REQUEST_CANCEL_MODIFY_CALL, ims_MsgType_RESPONSE, NULL, 0, QCRIL_EVT_NONE, "IMS_CANCEL_MODIFY_CALL RSP"},
    // Unsol Indications
    ...
    {ims_MsgId_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED, ims_MsgType_UNSOL_RESPONSE, ims_Registration_fields, sizeof(ims_Registration), QCRIL_EVT_NONE, "IMS_UNSOL_NETWORK_STATE_CHANGED"},
    {ims_MsgId_UNSOL_RESPONSE_REGISTRATION_BLOCK_STATUS, ims_MsgType_UNSOL_RESPONSE, ims_RegistrationBlockStatus_fields, sizeof(ims_RegistrationBlockStatus_fields), QCRIL_EVT_NONE, "IMS_UNSOL_REGISTRATION_BLOCK_STATUS"},
    ...
    {ims_MsgId_UNSOL_REFRESH_VICE_INFO,   ims_MsgType_UNSOL_RESPONSE, ims_ViceInfo_fields,          sizeof(ims_ViceInfo),          QCRIL_EVT_NONE, "IMS_UNSOL_REFRESH_VICE_INFO"},
    {ims_MsgId_UNSOL_VOWIFI_CALL_QUALITY, ims_MsgType_UNSOL_RESPONSE, ims_VoWiFiCallQuality_fields, sizeof(ims_VoWiFiCallQuality), QCRIL_EVT_NONE, "IMS_UNSOL_VOWIFI_CALL_QUALITY"},
    {ims_MsgId_UNSOL_VOPS_CHANGED,        ims_MsgType_UNSOL_RESPONSE, ims_VopsInfo_fields,          sizeof(ims_VopsInfo),          QCRIL_EVT_NONE, "IMS_UNSOL_VOPS_CHANGED"},
    {ims_MsgId_UNSOL_SSAC_CHANGED,        ims_MsgType_UNSOL_RESPONSE, ims_SsacInfo_fields,          sizeof(ims_SsacInfo),          QCRIL_EVT_NONE, "IMS_UNSOL_SSAC_CHANGED"},
    {ims_MsgId_UNSOL_PARTICIPANT_STATUS_INFO, ims_MsgType_UNSOL_RESPONSE, ims_ParticipantStatusInfo_fields, sizeof(ims_ParticipantStatusInfo), QCRIL_EVT_NONE, "IMS_UNSOL_PARTICIPANT_STATUS_INFO"},

    {ims_MsgId_UNSOL_IMS_SUB_CONFIG_CHANGED, ims_MsgType_UNSOL_RESPONSE, ims_ImsSubConfig_fields, sizeof(ims_ImsSubConfig), QCRIL_EVT_NONE, "IMS_UNSOL_IMS_SUB_CONFIG_CHANGED"},
    {ims_MsgId_UNSOL_RESPONSE_RTT_MSG_RECEIVED,     ims_MsgType_UNSOL_RESPONSE, ims_RttMessage_fields, sizeof(ims_RttMessage),    QCRIL_EVT_NONE, "IMS_UNSOL_RTT_MSG_RECEIVED"}
};
