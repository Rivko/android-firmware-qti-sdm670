...
typedef struct
{
  ...
  union
  {
    ...
    /* slot id */
    uint8                               slot_id;
    /* LPA profile id used in case of delete LPA profile
       to clean-up LPA cache */
    uint8                               profile_id;
    /* LPA profile enable disable */
    boolean                             en_dis_profile;
...
/* -----------------------------------------------------------------------------
   STRUCT:      QCRIL_UIM_ICCID_INFO_TYPE

   DESCRIPTION:
     Structure that holds ICCID data along with length for the
     corresponding card
-------------------------------------------------------------------------------*/
typedef struct
{
...
typedef struct
{
  ...
  qcril_uim_iccid_info_type             card_iccid_info;
