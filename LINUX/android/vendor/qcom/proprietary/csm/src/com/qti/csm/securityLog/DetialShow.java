...
public class DetialShow extends PreferenceActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this instanceof PreferenceActivity) {
            addPreferencesFromResource(R.layout.list_info);
            ...
            ArrayList<String> requests = deReq.getReqPh(context, mUid);
