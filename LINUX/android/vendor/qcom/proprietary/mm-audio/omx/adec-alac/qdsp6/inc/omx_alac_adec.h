/*=========================================================================
@file omx_alac_adec.h
This module contains the class definition for openMAX ALAC decoder component.
...
#ifndef _OMX_ALAC_DEC_H_
#define _OMX_ALAC_DEC_H_
...
#define OMX_CORE_INPUT_BUFFER_SIZE      65536
#define OMX_ALAC_OUTPUT_BUFFER_SIZE     8192
...
// OMX alac audio decoder class
//class omx_alac_adec: public qc_omx_component
class COmxAlacDec: public qc_omx_component
{
public:
    ...
    static void *pause_timeout_handler(void *);

    bool acquire_wakelock();
    bool release_wakelock();
#endif
...
private:
    ...
    OMX_U32 reserved[7];
    OMX_U32 num_of_frames;
    }__attribute__ ((packed))META_OUT;

    typedef struct dec_meta_out
    {
        OMX_U32 offset_to_frame;
        OMX_U32 frame_size;
        OMX_U32 encoded_pcm_samples;
        OMX_U32 msw_ts;
        OMX_U32 lsw_ts;
        OMX_U32 nflags;
    ...
    pthread_mutex_t              m_audio_drive_lock;
#ifdef NT_PAUSE_TIMEOUT_ENABLED
    pthread_mutex_t              m_wakelock_lock;
#endif
    ...
    OMX_BOOL                     m_drv_bPaused;
#ifdef NT_PAUSE_TIMEOUT_ENABLED
    bool                         m_wakelock_voted;
#endif
    ...
    struct alac_ipc_info         *m_ipc_to_in_th;
    struct alac_ipc_info         *m_ipc_to_out_th;
    struct alac_ipc_info         *m_ipc_to_cmd_th;
    struct alac_ipc_info         *m_ipc_to_event_th;
    ...
    QOMX_AUDIO_PARAM_ALACTYPE    m_adec_param;
    ...
    void process_events(COmxAlacDec *client_data);
    ...
    void destroy_pause_timer();
#endif

    OMX_BOOL is_drv_paused() { return m_drv_bPaused; }
    void set_drv_paused(OMX_BOOL val) { m_drv_bPaused = val; }
    void suspend_audio_driver(bool);

};
#endif // _OMX_ALAC_DEC_H_
