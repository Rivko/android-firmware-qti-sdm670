...
Copyright (c) 2010, 2014, 2017 Qualcomm Technologies, Inc.
...
#define MONO                            1
#define STEREO                          2
#define CHMASK_MONO                     0x4
#define CHMASK_STEREO                   0x3
#define CHMASK_2POINT1                  0x7
#define CHMASK_QUAD                     0x33
#define CHMASK_PENTA                    0x37
#define CHMASK_5POINT1                  0x3F
#define CHMASK_6POINT1                  0x13F
#define CHMASK_7POINT1                  0x63F
#define TUNNEL                          0
#define NON_TUNNEL                      1
#define BITS_PER_BYTE                   8
#define OMX_ADEC_MIN                    0
#define OMX_ADEC_MAX                    100
#define FORMATTAG_WMA                   353
#define FORMATTAG_WMAPRO                354
...
#define OMX_WMA_OUTPUT_BUFFER_SIZE      8192
...
class COmxWmaDec: public qc_omx_component
{
public:
...
private:
    ...
    struct wma_ipc_info          *m_ipc_to_in_th;
    struct wma_ipc_info          *m_ipc_to_out_th;
    struct wma_ipc_info          *m_ipc_to_cmd_th;
    struct wma_ipc_info          *m_ipc_to_event_th;
    ...
    OMX_AUDIO_PARAM_WMATYPE        m_adec_param;
    ...
    void process_events(COmxWmaDec *client_data);
    ...
    void flush_ack();
    void deinit_decoder();
    uint32_t channel_out_mask_from_count(OMX_U16);
