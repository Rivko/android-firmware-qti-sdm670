/*=========================================================================
  ...
  @file omx_ape_adec.h
  This module contains the class definition for openMAX APE decoder component.
...
#ifndef _OMX_APE_DEC_H_
#define _OMX_APE_DEC_H_
...
#define OMX_APE_OUTPUT_BUFFER_SIZE      8192
...
// OMX ape audio decoder class
//class omx_ape_adec: public qc_omx_component
class COmxApeDec: public qc_omx_component
{
public:
...
private:
    ...
    struct ape_ipc_info         *m_ipc_to_in_th;
    struct ape_ipc_info         *m_ipc_to_out_th;
    struct ape_ipc_info         *m_ipc_to_cmd_th;
    struct ape_ipc_info         *m_ipc_to_event_th;
    ...
    QOMX_AUDIO_PARAM_APETYPE    m_adec_param;
    ...
    void process_events(COmxApeDec *client_data);
