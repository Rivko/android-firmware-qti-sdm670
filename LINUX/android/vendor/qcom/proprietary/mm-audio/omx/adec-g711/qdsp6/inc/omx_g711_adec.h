/*=========================================================================
@file omx_g711_adec.h
This module contains the class definition for openMAX G711 decoder component.
...
#ifndef _OMX_G711_DEC_H_
#define _OMX_G711_DEC_H_
...
// OMX g711 audio decoder class
//class omx_g711_adec: public qc_omx_component
class COmxG711Dec: public qc_omx_component
{
public:
...
private:
    ...
    struct g711_ipc_info          *m_ipc_to_in_th;
    struct g711_ipc_info          *m_ipc_to_out_th;
    struct g711_ipc_info          *m_ipc_to_cmd_th;
    struct g711_ipc_info          *m_ipc_to_event_th;
    ...
    OMX_AUDIO_PARAM_G711TYPE     m_adec_param;
    ...
    void process_events(COmxG711Dec *client_data);
