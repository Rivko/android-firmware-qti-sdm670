/*=========================================================================
@file omx_amr_adec.h
This module contains the class definition for openMAX Amr decoder component.
...
class COmxAmrDec: public qc_omx_component
{
public:
...
private:
    ...
    struct amr_ipc_info          *m_ipc_to_in_th;
    struct amr_ipc_info          *m_ipc_to_out_th;
    struct amr_ipc_info          *m_ipc_to_cmd_th;
    struct amr_ipc_info          *m_ipc_to_event_th;
    ...
    OMX_AUDIO_PARAM_AMRTYPE     m_adec_param;
    ...
    void process_events(COmxAmrDec *client_data);
