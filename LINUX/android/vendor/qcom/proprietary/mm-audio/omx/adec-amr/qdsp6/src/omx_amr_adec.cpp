...
{
    return (new COmxAmrDec);
}

// omx_cmd_queue destructor
COmxAmrDec::omx_cmd_queue::~omx_cmd_queue()
{
    // Nothing to do
}

// omx cmd queue constructor
COmxAmrDec::omx_cmd_queue::omx_cmd_queue(): m_read(0),m_write(0),m_size(0)
{
    memset(m_q, 0, sizeof(omx_event)*OMX_CORE_CONTROL_CMDQ_SIZE);
}

// omx cmd queue insert
bool COmxAmrDec::omx_cmd_queue::insert_entry(unsigned long p1,
...
bool COmxAmrDec::omx_cmd_queue::pop_entry(unsigned long *p1,
        unsigned long *p2, unsigned char *id)
{
    bool ret = true;
    if (m_size > 0)
...
bool COmxAmrDec::omx_cmd_queue::get_msg_id(unsigned char *id)
{
    if(m_size > 0)
    {
        *id = m_q[m_read].id;
...
void COmxAmrDec::wait_for_event()
{
    int rc;
    struct timespec ts;
...
void COmxAmrDec::event_complete()
{
    pthread_mutex_lock(&m_event_lock);
...
void COmxAmrDec::wait_for_flush_event()
{
...
void COmxAmrDec::event_flush_complete()
{
    pthread_mutex_lock(&m_flush_cmpl_lock);
...
void COmxAmrDec::process_event_cb(void *client_data, __unused unsigned char id)
{
    DEBUG_PRINT("PE:Waiting for event's...");
    COmxAmrDec  *pThis = (COmxAmrDec *) client_data;
    pThis->process_events(pThis);
}

void COmxAmrDec::process_events(__unused COmxAmrDec *client_data)
{
    int rc = 0;
...
/* ======================================================================
   ...
   None.
   ========================================================================== */
COmxAmrDec::COmxAmrDec(): m_volume(25),
    m_app_data(NULL),
    m_eos_bm(0),
    m_flush_cnt(0),
    m_first_amr_header(0),
    m_is_alloc_buf(0),
    drv_inp_buf_cnt(0),
    drv_out_buf_cnt(0),
    nNumInputBuf(0),
...
bool COmxAmrDec::aio_write(msm_audio_aio_buf *audio_aio_buf)
{
    bool rc = true;
...
bool COmxAmrDec::aio_read(msm_audio_aio_buf *audio_aio_buf)
{
    bool rc = true;
...
bool COmxAmrDec::prepare_for_ebd(OMX_BUFFERHEADERTYPE *bufHdr)
{
    bool rc = true;
    ...
    if (bufHdr->nFlags & OMX_BUFFERFLAG_EOS )
    {
        if (bufHdr->nFilledLen)
        {
            ...
            /* Asynchronous write call to the AMR driver */
...
bool COmxAmrDec::audio_register_ion(struct mmap_info *ion_buf)
{
    bool rc = true;
    struct msm_audio_ion_info audio_ion_buf;
    /* Register the mapped ION buffer with the AMR driver */
...
bool COmxAmrDec::audio_deregister_ion(struct mmap_info *ion_buf)
{
    bool rc = true;
    struct msm_audio_ion_info audio_ion_buf;
    if (!ion_buf)
...
/**
  ...
  @return none
 */
void COmxAmrDec::buffer_done_cb(OMX_BUFFERHEADERTYPE *bufHdr, bool flg)
{
...
void COmxAmrDec::frame_done_cb(OMX_BUFFERHEADERTYPE *bufHdr, bool flg)
{
    META_OUT *pmeta_out = NULL;
    DEC_META_OUT *dec_meta_out = NULL;
    OMX_BUFFERHEADERTYPE *buffer = bufHdr;
...
void COmxAmrDec::process_out_port_msg(void *client_data, unsigned char id)
{
    unsigned long p1;
    unsigned long p2;
    unsigned char ident;
...
void COmxAmrDec::process_command_msg(void *client_data, unsigned char id)
{
    unsigned long p1;
    unsigned long p2;
    unsigned char ident;
...
void COmxAmrDec::process_in_port_msg(void *client_data, unsigned char id)
{
...
/**
  ...
  @return Error status
 */
OMX_ERRORTYPE COmxAmrDec::component_init(OMX_STRING role)
{
    ...
    /* Open the AMR device in asynchronous mode */
    ...
    else if(!strcmp(role,"OMX.qcom.audio.decoder.amrnb"))
    {
        amrnb_enable = 1;
        pcm_feedback = 1;
        DEBUG_PRINT("\ncomponent_init: Component %s LOADED \n", role);
    ...
    if(!amrnb_enable)
    {
        if(0 == pcm_feedback)
        {
            DEBUG_PRINT("opening in tunnel mode:\n");
            m_drv_fd = open("/dev/msm_amrwb",O_WRONLY | O_NONBLOCK);
        }
        else
        {
            DEBUG_PRINT("opening in non tunnel mode:\n");
            m_drv_fd = open("/dev/msm_amrwb",O_RDWR | O_NONBLOCK);
        }
    }
    else
    {
        ...
        {
            DEBUG_PRINT("opening in tunnel mode:\n");
            m_drv_fd = open("/dev/msm_amrnb",O_WRONLY | O_NONBLOCK);
        }
        else
        {
            DEBUG_PRINT("opening in non tunnel mode:\n");
            m_drv_fd = open("/dev/msm_amrnb",O_RDWR | O_NONBLOCK);
        }
    }
    ...
    if(!m_ipc_to_in_th)
    {
        m_ipc_to_in_th = omx_amr_thread_create(process_in_port_msg, this,
                (char *) "INPUT_THREAD");
        if(!m_ipc_to_in_th)
        {
    ...
    if(!m_ipc_to_cmd_th)
    {
        m_ipc_to_cmd_th = omx_amr_thread_create(process_command_msg, this,
                (char *) "COMMAND_THREAD");
        if(!m_ipc_to_cmd_th)
        {
    ...
    if(pcm_feedback)
    {
        if(!m_ipc_to_out_th)
        {
            m_ipc_to_out_th = omx_amr_thread_create(process_out_port_msg, this,
                    (char *) "OUTPUT_THREAD");
            if(!m_ipc_to_out_th)
            {
...
/**
  ...
  @return Error status
 */
OMX_ERRORTYPE  COmxAmrDec::get_component_version(__unused OMX_IN OMX_HANDLETYPE hComp,
...
/**
  ...
  @return Error status
 */
OMX_ERRORTYPE  COmxAmrDec::send_command(__unused OMX_IN OMX_HANDLETYPE hComp,
...
/**
  ...
  @return error status
 */
OMX_ERRORTYPE  COmxAmrDec::send_command_proxy(__unused OMX_IN OMX_HANDLETYPE hComp,
        OMX_IN OMX_COMMANDTYPE  cmd,
        OMX_IN OMX_U32       param1,
        __unused OMX_IN OMX_PTR      cmdData)
{
 ...
 */
bool COmxAmrDec::execute_omx_flush(OMX_IN OMX_U32 param1, bool cmd_cmpl)
{
    bool bRet = true;
...
/**
  ...
  @return bool value indicating whether flushing is carried out successfully
 */
bool COmxAmrDec::execute_input_omx_flush()
{
...
/**
  ...
  @return bool value indicating whether flushing is carried out successfully
 */
bool COmxAmrDec::execute_output_omx_flush()
{
    OMX_BUFFERHEADERTYPE *omx_buf;
    unsigned long      p1=0; // Parameter - 1
    unsigned long      p2=0; // Parameter - 2
 ...
 */
bool COmxAmrDec::post_input(unsigned long p1,
        unsigned long p2,
        unsigned char id)
{
    bool bRet = false;
...
bool COmxAmrDec::post_command(unsigned int p1,
        unsigned int p2,
        unsigned char id)
{
    bool bRet = false;
...
bool COmxAmrDec::post_output(unsigned long p1,
        unsigned long p2,
        unsigned char id)
{
    bool bRet = false;
...
/**
  ...
  @return error status
 */
OMX_ERRORTYPE  COmxAmrDec::get_parameter(__unused OMX_IN OMX_HANDLETYPE hComp,
...
/**
  ...
  @return error status
 */
OMX_ERRORTYPE  COmxAmrDec::set_parameter(__unused OMX_IN OMX_HANDLETYPE hComp,
        OMX_IN OMX_INDEXTYPE paramIndex,
        OMX_IN OMX_PTR        paramData)
{
    ...
    switch((int)paramIndex)
    {
        case OMX_IndexParamAudioAmr:
            {
                m_adec_param = *((OMX_AUDIO_PARAM_AMRTYPE *) paramData);
                DEBUG_PRINT("in %s:m_adec_param.mode=%d m_adec_param=%d\n",__func__, m_adec_param.eAMRBandMode,m_adec_param.eAMRDTXMode);
                break;
            }
        case OMX_IndexParamPortDefinition:
            {
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::get_config(OMX_IN OMX_HANDLETYPE      hComp,
...
/* ======================================================================
   ...
   OMX Error None if successful.
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::set_config(OMX_IN OMX_HANDLETYPE      hComp,
        OMX_IN OMX_INDEXTYPE configIndex,
...
None
=============================================================================*/
OMX_ERRORTYPE  COmxAmrDec::get_extension_index(
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::get_state(OMX_IN OMX_HANDLETYPE  hComp,
...
/* ======================================================================
   FUNCTION
   COmxAmrDec::ComponentTunnelRequest
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::component_tunnel_request(__unused OMX_IN OMX_HANDLETYPE hComp,
...
void COmxAmrDec::free_ion_buffer(void** ion_buffer)
{
...
/* ======================================================================
   FUNCTION
   COmxAmrDec::AllocateInputBuffer
        ...
        OMX_IN OMX_U32                   bytes)
{
    ...
    DEBUG_PRINT("%s %p\n",__FUNCTION__,this);
    DEBUG_PRINT("Inside COmxAmrDec::allocate_input_buffer");
        ...
        OMX_IN OMX_U32                       bytes)
{
    ...
    DEBUG_PRINT("%s %p\n",__FUNCTION__,this);
    DEBUG_PRINT("Inside COmxAmrDec::allocate_output_buffer");
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::allocate_buffer(OMX_IN OMX_HANDLETYPE hComp,
        OMX_INOUT OMX_BUFFERHEADERTYPE** bufferHdr,
        OMX_IN OMX_U32                        port,
        OMX_IN OMX_PTR                     appData,
        OMX_IN OMX_U32                       bytes)
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::use_buffer(
        OMX_IN OMX_HANDLETYPE            hComp,
        OMX_INOUT OMX_BUFFERHEADERTYPE** bufferHdr,
        OMX_IN OMX_U32                   port,
        OMX_IN OMX_PTR                   appData,
        ...
        OMX_IN OMX_U8*                   buffer)
{
    ...
    DEBUG_PRINT("%s %p\n",__FUNCTION__,this);
    DEBUG_PRINT("Inside COmxAmrDec::use_input_buffer");
    if(bytes < input_buffer_size)
    {
        /* return if i\p buffer size provided by client is less
           than min i\p buffer size supported by omx component */
        ...
        OMX_IN OMX_U8*                   buffer)
{
    ...
    DEBUG_PRINT("%s %p\n",__FUNCTION__,this);
    DEBUG_PRINT("Inside COmxAmrDec::use_output_buffer");
    if(bytes < output_buffer_size)
    {
        /* return if o\p buffer size provided by client is less
           than min o\p buffer size supported by omx component */
    ...
    if(m_out_current_buf_count < m_out_act_buf_count)
    {
        ...
        if (bufHdr != NULL && loc_bufHdr != NULL)
        {
            ...
            /* Register the mapped PMEM buffer with the AMR driver */
            if (!audio_register_ion(mmap_data))
            {
                free(bufHdr);
                free(loc_bufHdr);
 ...
 */
bool COmxAmrDec::search_input_bufhdr(OMX_BUFFERHEADERTYPE *buffer)
{
    bool eRet = false;
...
/**
  ...
  @return bool value indicating whether buffer is found
 */
bool COmxAmrDec::search_output_bufhdr(OMX_BUFFERHEADERTYPE *buffer)
{
    bool eRet = false;
    OMX_BUFFERHEADERTYPE *temp = NULL;
...
/**
  ...
  @return Error status
 */
OMX_ERRORTYPE  COmxAmrDec::free_buffer(__unused OMX_IN OMX_HANDLETYPE hComp,
        OMX_IN OMX_U32                 port,
...
/**
  ...
  @return error status
 */
OMX_ERRORTYPE  COmxAmrDec::empty_this_buffer(OMX_IN OMX_HANDLETYPE hComp,
        OMX_IN OMX_BUFFERHEADERTYPE* buffer)
{
    OMX_STATETYPE state;
    OMX_ERRORTYPE eRet = OMX_ErrorNone;
    ...
    if ((buffer != NULL) && (buffer->nInputPortIndex == 0) &&
...
/**
  ...
  @return error status
 */
OMX_ERRORTYPE  COmxAmrDec::empty_this_buffer_proxy(OMX_IN OMX_HANDLETYPE hComp,
        OMX_BUFFERHEADERTYPE* buffer)
{
    ...
    if(m_first_amr_header == 0)
    {
        m_first_amr_header = 1;
        if (pcm_feedback)
        {
...
OMX_ERRORTYPE  COmxAmrDec::fill_this_buffer_proxy (
        __unused OMX_IN OMX_HANDLETYPE         hComp,
        OMX_BUFFERHEADERTYPE* buffer)
{
    int ret = 0;
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::fill_this_buffer(OMX_IN OMX_HANDLETYPE hComp,
        OMX_IN OMX_BUFFERHEADERTYPE* buffer)
{
    OMX_STATETYPE state;
    OMX_ERRORTYPE eRet = OMX_ErrorNone;
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::set_callbacks(__unused OMX_IN OMX_HANDLETYPE hComp,
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::component_deinit(__unused OMX_IN OMX_HANDLETYPE hComp)
{
#if DUMPS_ENABLE
    if (bfd != -1)
        close(bfd);
...
/* ======================================================================
   ...
   ========================================================================== */
void  COmxAmrDec::deinit_decoder()
{
    ...
    DEBUG_PRINT("Component-deinit calling omx_amr_thread_stop\
            (m_ipc_to_in_th)\n");
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::use_EGL_image(__unused OMX_IN OMX_HANDLETYPE hComp,
...
/* ======================================================================
   ...
   ========================================================================== */
OMX_ERRORTYPE  COmxAmrDec::component_role_enum(__unused OMX_IN OMX_HANDLETYPE hComp,
        OMX_OUT OMX_U8*        role,
        OMX_IN OMX_U32        index)
{
    OMX_ERRORTYPE eRet = OMX_ErrorNone;
    const char *cmp_role = "audio_decoder.amr";
...
/* ======================================================================
   ...
   ========================================================================== */
bool COmxAmrDec::allocate_done(void)
{
...
/* ======================================================================
   ...
   ========================================================================== */
bool COmxAmrDec::release_done(OMX_U32 param1)
{
    OMX_BOOL bRet = OMX_FALSE;
    DEBUG_PRINT("%s %p\n",__FUNCTION__,this);
    if(param1 == OMX_ALL)
...
void COmxAmrDec::suspend_audio_driver(bool suspend) {
    if (m_drv_fd < 0) {
