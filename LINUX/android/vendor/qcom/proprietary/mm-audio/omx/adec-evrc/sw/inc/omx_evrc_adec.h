#ifndef  _OMX_EVRC_DEC_H_
#define  _OMX_EVRC_DEC_H_
/*============================================================================
                            O p e n M A X   Component
                                Audio EVRC Decoder

  @file comx_evrc_adec.h
  This module contains the class definition for openMAX EVRC decoder component.

Copyright (c) 2006-2008, 2015, 2017 Qualcomm Technologies, Inc.
All Rights Reserved.
...
#define OMX_CORE_INPUT_BUFFER_SIZE        720
#define OMX_EVRC_OUTPUT_BUFFER_SIZE       9600
...
private:
    ...
    short int pcm_output_buffer[60 * 160];
    int count_frame;
    OMX_U16 total_count;
    ...
    //Mutexes for input and ouput buffer count
    ...
    struct evrc_ipc_info           *m_ipc_data_th;// for input thread
    struct evrc_ipc_info           *m_ipc_cmd_th;// for command thread
    OMX_AUDIO_PARAM_EVRCTYPE       m_adec_param; // Cache EVRC decoder parameter
