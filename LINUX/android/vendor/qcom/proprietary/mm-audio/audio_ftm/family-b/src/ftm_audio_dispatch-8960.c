...
====================================================================================================
Copyright (c) 2011-2013, 2015-2017 Qualcomm Technologies, Inc.  All Rights Reserved.
                        ...
                        if (strstr(ctlname, "Volume")) {
                            ...
                            if(PATH_EXT_LB == commands->type_of_test)
                            {
                                if(strstr(ctlname, "RX"))
                                    val = (val * commands->rx_volume)/100;
                                else if(strstr(ctlname, "DEC"))
                                    val = (val * commands->tx_volume)/100;
                            }
                            else
                                val = (val * commands->volume)/100;
                        }
                        printf("\n Set %s %d", ctlname, val);
