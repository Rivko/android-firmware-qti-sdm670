...
#ifndef QVOP_NULLCALLBACK_H
#define QVOP_NULLCALLBACK_H
...
namespace qvop {
    ...
    class QvopNullCallback : public IQvopCallback {
    public:
        QvopNullCallback() {
        }
        ...
        virtual void onError(int32_t error) {
            logfile_print_v("%s: QvopNullCallback entry", QVOP_FN);
        }
        ...
        virtual void onMatchFound(int32_t error,
            ...
            logfile_print_v("%s: QvopNullCallback entr", QVOP_FN);
        }
