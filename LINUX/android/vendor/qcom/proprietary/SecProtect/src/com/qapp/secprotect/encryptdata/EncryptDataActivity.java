...
public class EncryptDataActivity extends FragmentActivity implements
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog,
                                    ...
                                    if (!password.equals(UtilsPassword
                                        ...
                                        dismissDialog = true;
                                        if (changePwd == true) {
                                            //If it's from "Change Password" menu
                                            Intent intent = new Intent(EncryptDataActivity.this,
                                                                       PasswordActivity.class);
                                            intent.putExtra("mode", Configs.INTENT_CHANGE_PASSWORD);
                                            changePwd = false;
                                            startActivity(intent);
                                        } else {
                                            setTitle(R.string.decrypt);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        //Display the menu only if the password is set
        logd("");
