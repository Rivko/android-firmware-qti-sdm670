...
#include "modules/data/RilRequestGoDormantMessage.h"
...
#if 0
    QCRIL_LOG_INFO("Handling %s (%d) Token ID (%" PRId32 ") - Mute value %d",
...
)
{
  ...
  {
#if 0
  QCRIL_LOG_INFO( "Handling %s (%d) Token ID (%" PRId32 ")",
