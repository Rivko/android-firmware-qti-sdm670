...
{
    qcril_qmi_oem_proto_msg_meta_data.push_back({QtiTelephonyService_RILOEMMessageId_RIL_OEM_GBA_INIT, QtiTelephonyService_RILOEMMessageType_RIL_OEM_MSG_REQUEST,  QtiTelephonyService_RilOemGbaInitRequestPayload_fields, sizeof(QtiTelephonyService_RilOemGbaInitRequestPayload), QCRIL_EVT_OEM_MSG_GBA_INIT, "QCRIL_EVT_OEM_MSG_GBA_INIT_REQ"});
    qcril_qmi_oem_proto_msg_meta_data.push_back({QtiTelephonyService_RILOEMMessageId_RIL_OEM_GBA_INIT, QtiTelephonyService_RILOEMMessageType_RIL_OEM_MSG_RESPONSE,  QtiTelephonyService_RilOemGbaInitResponsePayload_fields, sizeof(QtiTelephonyService_RilOemGbaInitResponsePayload), QCRIL_EVT_NONE, "QCRIL_EVT_OEM_MSG_GBA_INIT_RSP"});
    qcril_qmi_oem_proto_msg_meta_data.push_back({QtiTelephonyService_RILOEMMessageId_RIL_OEM_IMPI, QtiTelephonyService_RILOEMMessageType_RIL_OEM_MSG_REQUEST, QtiTelephonyService_RilOemImpiRequestPayload_fields, sizeof(QtiTelephonyService_RilOemImpiRequestPayload), QCRIL_EVT_OEM_MSG_GET_IMPI, "QCRIL_EVT_OEM_MSG_GET_IMPI_REQ"});
    qcril_qmi_oem_proto_msg_meta_data.push_back({QtiTelephonyService_RILOEMMessageId_RIL_OEM_IMPI, QtiTelephonyService_RILOEMMessageType_RIL_OEM_MSG_RESPONSE, QtiTelephonyService_RilOemImpiResponsePayload_fields, sizeof(QtiTelephonyService_RilOemImpiResponsePayload), QCRIL_EVT_NONE, "QCRIL_EVT_OEM_MSG_GET_IMPI_RSP"});
}
