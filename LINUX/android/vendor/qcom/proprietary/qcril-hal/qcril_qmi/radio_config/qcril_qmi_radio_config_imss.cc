    ...
    switch(config_ptr->config_item)
    {
      ...
      case QCRIL_QMI_RADIO_CONFIG_CLIENT_PROVISIONING_WIFI_CALL_PREFERENCE:
        ...
        if(enum_int_val != IMS_SETTINGS_WFC_CALL_PREF_NONE_V01)
        {
          ...
          // IMSS REFACTOR: TODO: integrate with the radio config
...
)
{
  ...
  do
  {
    ...
    qmi_resp = (ims_settings_get_voip_config_rsp_msg_v01 *)params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_sip_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_reg_mgr_extended_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_client_provisioning_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_user_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_sms_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_presence_config_rsp_msg_v01 *) params_ptr->data;
    /* If the qmi response is success, then process the data */
    if(qmi_resp->resp.result == QMI_RESULT_SUCCESS_V01)
    {
      radio_config_error = QCRIL_QMI_RADIO_CONFIG_ERROR_SUCCESS;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_qipcall_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_reg_mgr_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
   /* Validate config ptr */
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_handover_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
   /* Validate config ptr */
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_get_qipcall_vice_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_voip_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_sip_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_reg_mgr_extended_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_client_provisioning_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_user_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_sms_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_presence_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_qipcall_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_reg_mgr_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_handover_config_rsp_msg_v01 *) params_ptr->data;
...
)
{
  ...
  do
  {
    ...
    /* Get the qmi response structure from req_params_type */
    qmi_resp = (ims_settings_set_qipcall_vice_config_rsp_msg_v01 *) params_ptr->data;
