...
*/
/*=========================================================================*/
static inline int mcfg_get_qc_version(char* file_name, char** qc_version, uint32_t* len)
{
...
*/
/*=========================================================================*/
static inline int mcfg_get_oem_version(char* file_name, char** oem_version, uint32_t* len)
{
...
)
{
  ...
  {
    qcril_qmi_print_hex((unsigned char *)qc_version, qc_version_len);
...
)
{
  ...
  if ( result == RIL_E_SUCCESS )
  {
    qcril_qmi_print_hex((unsigned char *)oem_version, oem_version_len);
