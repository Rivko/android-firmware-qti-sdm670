...
static const uint8_t embms_unsol_get_interested_tmgi_list_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(embms_unsol_get_interested_tmgi_list_req_msg_v01, dbg_trace_id)
};

static const uint8_t embms_get_interested_tmgi_list_resp_msg_data_v01[] = {
  0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(embms_get_interested_tmgi_list_resp_msg_v01, dbg_trace_id),

  0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(embms_get_interested_tmgi_list_resp_msg_v01, call_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(embms_get_interested_tmgi_list_resp_msg_v01, tmgi_info),
  NUMBER_MAX_V01,
  QMI_IDL_OFFSET8(embms_get_interested_tmgi_list_resp_msg_v01, tmgi_info) - QMI_IDL_OFFSET8(embms_get_interested_tmgi_list_resp_msg_v01, tmgi_info_len),
  QMI_IDL_TYPE88(0, 0)
};

static const uint8_t embms_get_interested_tmgi_list_resp_ack_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(embms_get_interested_tmgi_list_resp_ack_msg_v01, dbg_trace_id)
};
...
static const qmi_idl_message_table_entry embms_message_table_v01[] = {
  ...
  {sizeof(embms_unsol_get_interested_tmgi_list_req_msg_v01), embms_unsol_get_interested_tmgi_list_req_msg_data_v01},
  {sizeof(embms_get_interested_tmgi_list_resp_msg_v01), embms_get_interested_tmgi_list_resp_msg_data_v01},
  {sizeof(embms_get_interested_tmgi_list_resp_ack_msg_v01), embms_get_interested_tmgi_list_resp_ack_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry embms_service_command_messages_v01[] = {
  ...
  {QMI_EMBMS_GET_INTERESTED_TMGI_LIST_RESP_V01, QMI_IDL_TYPE16(0, 56), 463}
};
...
static const qmi_idl_service_message_table_entry embms_service_response_messages_v01[] = {
  ...
  {QMI_EMBMS_GET_INTERESTED_TMGI_LIST_RESP_ACK_V01, QMI_IDL_TYPE16(0, 57), 7}
};
...
static const qmi_idl_service_message_table_entry embms_service_indication_messages_v01[] = {
  ...
  {QMI_EMBMS_UNSOL_GET_INTERESTED_TMGI_LIST_REQ_V01, QMI_IDL_TYPE16(0, 55), 7}
};
