/******************************************************************************
#  Copyright (c) 2000-2005, 2010, 2017 Qualcomm Technologies, Inc.
#  All Rights Reserved.
...
typedef enum
{
  ...
  /* Other */
  E_NO_RESOURCES   = 300, /* When there are no resources to perform the operation */
  E_RADIO_NOT_AVAILABLE = 301, /* When modem is not available to perform the operation */
