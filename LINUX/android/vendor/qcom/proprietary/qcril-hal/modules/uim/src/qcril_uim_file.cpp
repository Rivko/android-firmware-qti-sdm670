...
struct
{
  ...
  qmi_uim_slot_type             slot;
       ...
       {0, {QCRIL_UIM_ARA_M_APP_OPEN_WAIT_TIME, 0}, QCRIL_DEFAULT_INSTANCE_ID, {0}, 0, NULL, 0, QMI_UIM_SLOT_1};
...
*/
/*=========================================================================*/
static qcril_uim_original_request_type* qcril_uim_clone_read_transparent_request
(
  qcril_instance_id_e_type                     instance_id,
...
)
{
  ...
  ret_ptr->cmd          = UIM_INTERNAL_REQUEST_SIM_IO_READ_BINARY;

  /* Allocate original request */
  orig_ptr = qcril_uim_allocate_orig_request(instance_id,
                                             modem_id,
                                             token,
  ...
  if (orig_ptr == NULL)
  {
    QCRIL_UIM_FREE_IF_NOT_NULL(ret_ptr);
    return NULL;
  }

  orig_ptr->data.orig_pin2_ptr = ret_ptr;
...
*/
/*=========================================================================*/
static qcril_uim_original_request_type* qcril_uim_clone_read_record_request
(
  qcril_instance_id_e_type                instance_id,
  qcril_modem_id_e_type                   modem_id,
  RIL_Token                               token,
...
)
{
  ...
  /* Generic fields */
  ret_ptr->size         = tot_size;
  ret_ptr->cmd          = UIM_INTERNAL_REQUEST_SIM_IO_READ_RECORD;
...
*/
/*=========================================================================*/
static qcril_uim_original_request_type* qcril_uim_clone_write_transparent_request
(
  qcril_instance_id_e_type                      instance_id,
  qcril_modem_id_e_type                         modem_id,
  RIL_Token                                     token,
...
)
{
  ...
  /* Generic fields */
  ret_ptr->size         = tot_size;
  ret_ptr->cmd          = UIM_INTERNAL_REQUEST_SIM_IO_UPDATE_BINARY;
...
*/
/*=========================================================================*/
static qcril_uim_original_request_type* qcril_uim_clone_write_record_request
(
  qcril_instance_id_e_type                 instance_id,
  qcril_modem_id_e_type                    modem_id,
  RIL_Token                                token,
...
)
{
  ...
  /* Generic fields */
  ret_ptr->size         = tot_size;
  ret_ptr->cmd          = UIM_INTERNAL_REQUEST_SIM_IO_UPDATE_RECORD;
...
*/
/*=========================================================================*/
static qcril_uim_original_request_type* qcril_uim_clone_set_fdn_status_request
(
  qcril_instance_id_e_type                       instance_id,
  qcril_modem_id_e_type                          modem_id,
  RIL_Token                                      token,
...
)
{
  ...
  /* Generic fields */
  ret_ptr->size         = tot_size;
  ret_ptr->cmd          = UIM_INTERNAL_REQUEST_SET_SERVICE_STATUS_FDN;
  orig_ptr = qcril_uim_allocate_orig_request(instance_id,
                                             modem_id,
                                             token,
                                             UIM_INTERNAL_REQUEST_VERIFY_PIN2,
...
)
{
  ...
  if (err != RIL_E_SUCCESS)
  {
    qcril_uim_response(instance_id, token, err, NULL, 0, TRUE,
                       (char *)"error in qcril_uim_extract_file_id");
    return;
  }
  ...
  {
    qcril_uim_response(instance_id, token, err, NULL, 0, TRUE,
                       (char *)"error in qcril_uim_extract_session_type");
    return;
  }
...
send_read_binary_error:
  ...
  qcril_uim_response(instance_id, token, err,
                     NULL, 0, TRUE, (char *)"error in qcril_qmi_uim_read_transparent");
...
send_read_record_error:
  ...
  qcril_uim_remove_non_provisioning_session(token);
  qcril_uim_response(instance_id, token, err,
                     NULL, 0, TRUE, (char *)"error in qcril_qmi_uim_read_record");
  /* Clean up any original request if allocated */
  if (callback_request_ptr)
  {
    qcril_free(callback_request_ptr);
...
send_update_binary_error:
  ...
  qcril_uim_remove_non_provisioning_session(token);
  qcril_uim_response(instance_id, token, err, NULL, 0, TRUE,
                     (char *)"error in qcril_qmi_uim_write_transparent");
  /* Clean up any original request if allocated */
  if (callback_request_ptr)
  {
    qcril_free(callback_request_ptr);
...
send_update_record_error:
  ...
  qcril_uim_remove_non_provisioning_session(token);
  qcril_uim_response(instance_id, token, err,
                     NULL, 0, TRUE, (char *)"error in qcril_qmi_uim_write_record");
  /* Clean up any original request if allocated */
  if (callback_request_ptr)
  {
    qcril_free(callback_request_ptr);
...
)
{
  ...
  {
    qcril_uim_response(instance_id, token,
                       err, NULL, 0, TRUE, (char *)"error in qcril_uim_extract_file_id");
    return;
  }
...
send_get_response_error:
  ...
  qcril_uim_remove_non_provisioning_session(token);
  qcril_uim_response(instance_id, token, err,
                     NULL, 0, TRUE, (char *)"error in qcril_qmi_uim_get_file_attributes");
  /* Clean up any original request if allocated */
  if (callback_request_ptr)
  {
    qcril_free(callback_request_ptr);
...
)
{
  ...
  if(in_ptr == NULL || in_ptr[0] == NULL)
  {
    qcril_uim_response(params_ptr->instance_id, params_ptr->t,
                       ...
                       TRUE, (char *)"NULL pointer in facilty string" );
    QCRIL_ASSERT(0);
    return;
  }
  ...
  if (memcmp(in_ptr[0], "FD", 2) != 0)
  {
    qcril_uim_response(params_ptr->instance_id, params_ptr->t,
                       ...
                       TRUE, (char *)"unsupported facilty string" );
    return;
  }
      ...
      (service_status_params.session_info.session_type == QMI_UIM_SESSION_TYPE_CARD_SLOT_3))
  {
        ...
        (service_status_params.session_info.session_type == QMI_UIM_SESSION_TYPE_CARD_SLOT_3))
    {
      qcril_uim_response(params_ptr->instance_id, params_ptr->t,
                         RIL_E_REQUEST_NOT_SUPPORTED, NULL, 0,
                         TRUE, (char *)"error extracting session info");
      return;
    }
  }
...
send_get_fdn_error:
  qcril_uim_response(params_ptr->instance_id, params_ptr->t, err,
                     NULL, 0, TRUE, (char *)"error in qcril_qmi_uim_get_service_status");
  /* Clean up any original request if allocated */
  if (callback_request_ptr)
  {
    qcril_free(callback_request_ptr);
...
)
{
  ...
  else
  {
    qcril_uim_response(params_ptr->instance_id, params_ptr->t,
                       ...
                       TRUE, (char *)"invalid input paramter data[1]");
    return;
  }
...
send_set_fdn_error:
  qcril_uim_response(params_ptr->instance_id, params_ptr->t, err,
                     NULL, 0, TRUE, (char *)"error in qcril_qmi_uim_set_service_status");
  /* Clean up any original request if allocated */
  if (callback_request_ptr)
  {
    qcril_free(callback_request_ptr);
...
send_status_error:
  ...
  qcril_uim_remove_non_provisioning_session(token);
  qcril_uim_response(instance_id, token, err,
                     NULL, 0, TRUE, (char *)"error in qcril_uim_get_status");
  /* Clean up any original request if allocated */
  if (callback_request_ptr)
  {
    qcril_free(callback_request_ptr);
...
)
{
  ...
  if (original_request_ptr->request_id == RIL_REQUEST_SIM_OPEN_CHANNEL)
  {
    ...
    else
    {
      ...
      if(params_ptr->qmi_rsp_data.rsp_data.logical_channel_rsp.sw1 == 0x00 &&
         params_ptr->qmi_rsp_data.rsp_data.logical_channel_rsp.sw2 == 0x00)
      {
...
)
{
  ...
  if (params_ptr->qmi_rsp_data.qmi_err_code == QMI_UIM_SERVICE_ERR_INVALID_QMI_CMD)
  {
    ...
    if (qcril_uim_send_qmi_async_msg(QCRIL_UIM_REQUEST_SEND_APDU,
                                     (void *)&original_request_ptr->data.send_apdu,
                                     original_request_ptr) >= 0)
    {
...
)
{
  ...
  /* No need to call qcril_uim_remove_non_provisioning_session since we do not try
     to open one in the request, continue to generate response */
  if(original_request_ptr->request_id == UIM_OEM_HOOK_SLOT_SEND_APDU_REQ)
  {
...
)
{
  ...
  if (qcril_uim.long_apdu_info.total_apdu_len == qcril_uim.long_apdu_info.rx_len)
  {
    if (qcril_uim.long_apdu_info.original_request_ptr != NULL)
    {
      ...
      if(qcril_uim.long_apdu_info.original_request_ptr->request_id == UIM_OEM_HOOK_SLOT_SEND_APDU_REQ)
      {
        RIL_SlotSendApduResp  slot_apdu_rsp;
        uint32                resp_len;
...
)
{
  ...
  qcril_uim_card_app_type              *app_type_ptr;
  ...
  app_type_ptr = (qcril_uim_card_app_type *)params_ptr->data;
  ...
  original_request_ptr->data.mcc_mnc_req.app_type = app_type_ptr->app_type;
  ...
  QCRIL_LOG_ERROR("Error queueing READ_TRANSPARENT for EF AD or IMSI-M");
...
)
{
  ...
  if(in_ptr == NULL)
  {
    qcril_uim_response(params_ptr->instance_id,
                       params_ptr->t,
                       QCRIL_UIM_RIL_E_INVALID_ARGUMENTS,
                       NULL,
                       0,
                       TRUE,
                       (char *)"NULL pointer");
...
isim_auth_error:
  qcril_uim_response(params_ptr->instance_id, params_ptr->t, ret_err,
                       NULL, 0, TRUE, (char *)"error in qcril_qmi_uim_authentication");
...
)
{
  ...
  memset(original_request_ptr->data.channel_info.aid_buffer,
         0x00,
         sizeof(original_request_ptr->data.channel_info.aid_buffer));
  ...
  if(qcril_uim_ara_m_delay_timer.timer_id != 0)
  {
                                          ...
                                          qcril_uim_ara_m_delay_timer.slot) != RIL_E_SUCCESS)
    {
      qcril_uim_response(qcril_uim_ara_m_delay_timer.instance_id, qcril_uim_ara_m_delay_timer.token,
                         ...
                         (char *)"error in qcril_qmi_uim_logical_channel due to card error");
    }
...
)
{
  ...
  else
  {
    ...
    qcril_uim_response(params_ptr->instance_id, params_ptr->t, QCRIL_UIM_RIL_E_INTERNAL_ERR,
                       NULL, 0, TRUE, (char *)"error in qcril_qmi_uim_logical_channel");
    return;
  }

  /* Parse input info based on the request type */
  if (params_ptr->event_id_android == RIL_REQUEST_SIM_OPEN_CHANNEL)
  {
  ...
  else if (params_ptr->event_id_android == RIL_REQUEST_SIM_CLOSE_CHANNEL)
  {
...
)
{
  ...
  if(params_ptr->event_id_android == UIM_OEM_HOOK_SLOT_SEND_APDU_REQ)
  {
  ...
  if (params_ptr->event_id_android == RIL_REQUEST_SIM_TRANSMIT_APDU_BASIC)
  {
    check_apdu_params = TRUE;
  }
#endif /* RIL_REQUEST_SIM_TRANSMIT_APDU_BASIC */
#if defined(RIL_REQUEST_SIM_TRANSMIT_APDU_CHANNEL)
  if (params_ptr->event_id_android == RIL_REQUEST_SIM_TRANSMIT_APDU_CHANNEL)
  {
    check_apdu_params = TRUE;
  }
  ...
  /* For UIM_OEM_HOOK_SLOT_SEND_APDU_REQ slot id comes in the request */
  if(params_ptr->event_id_android != UIM_OEM_HOOK_SLOT_SEND_APDU_REQ)
  {
    /* Find slot info */
    if (ril_to_uim_is_tsts_enabled() && (params_ptr->instance_id == QCRIL_THIRD_INSTANCE_ID))
...
)
{
  ...
  if(params_ptr->event_id_android != UIM_OEM_HOOK_SLOT_SET_APDU_BEHAVIOR_REQ)
  {
...
)
{
  ...
  orig_ptr = (qcril_uim_original_request_type *)params_ptr->orig_req_data;

  original_request_ptr = orig_ptr->data.orig_pin2_ptr;
  if(original_request_ptr == NULL)
  {
    QCRIL_LOG_ERROR("%s", "NULL original_request_ptr");
    QCRIL_ASSERT(0);
  ...
  if (params_ptr->qmi_rsp_data.qmi_err_code != 0)
  {
    int32 num_retries = (int32)params_ptr->qmi_rsp_data.rsp_data.verify_pin_rsp.num_retries;
    ...
    if (original_request_ptr->cmd == UIM_INTERNAL_REQUEST_SET_SERVICE_STATUS_FDN)
    {
      qcril_uim_response(orig_ptr->instance_id,
                         ...
                         sizeof(num_retries),
                         TRUE,
                         (char *)"error in pin verification");
    }
    else
    {
      qcril_uim_response(orig_ptr->instance_id,
  ...
  {
    case UIM_INTERNAL_REQUEST_SIM_IO_READ_BINARY:
      QCRIL_LOG_QMI( modem_id, "qmi_uim_service", "read transparent" );
      callback_request_ptr->session_type = original_request_ptr->data.read_transparent.session_info.session_type;
      res = qcril_uim_send_qmi_async_msg(QCRIL_UIM_REQUEST_READ_TRANSPARENT,
                                         (void *)&original_request_ptr->data.read_transparent,
                                         callback_request_ptr);
      break;

    case UIM_INTERNAL_REQUEST_SIM_IO_READ_RECORD:
      QCRIL_LOG_QMI( modem_id, "qmi_uim_service", "read record" );
      callback_request_ptr->session_type = original_request_ptr->data.read_record.session_info.session_type;
      res = qcril_uim_send_qmi_async_msg(QCRIL_UIM_REQUEST_READ_RECORD,
                                         (void *)&original_request_ptr->data.read_record,
                                         callback_request_ptr);
      break;

    case UIM_INTERNAL_REQUEST_SIM_IO_UPDATE_BINARY:
      QCRIL_LOG_QMI( modem_id, "qmi_uim_service", "write transparent" );
      callback_request_ptr->session_type = original_request_ptr->data.write_transparent.session_info.session_type;
      res = qcril_uim_send_qmi_async_msg(QCRIL_UIM_REQUEST_WRITE_TRANSPARENT,
                                         (void *)&original_request_ptr->data.write_transparent,
                                         callback_request_ptr);
      break;

    case UIM_INTERNAL_REQUEST_SIM_IO_UPDATE_RECORD:
      QCRIL_LOG_QMI( modem_id, "qmi_uim_service", "write record" );
      callback_request_ptr->session_type = original_request_ptr->data.write_record.session_info.session_type;
      res = qcril_uim_send_qmi_async_msg(QCRIL_UIM_REQUEST_WRITE_RECORD,
                                         (void *)&original_request_ptr->data.write_record,
                                         callback_request_ptr);
      break;

    case UIM_INTERNAL_REQUEST_SET_SERVICE_STATUS_FDN:
      ...
      res = qcril_uim_send_qmi_async_msg(QCRIL_UIM_REQUEST_SET_FDN,
                                         (void *)&original_request_ptr->data.set_service_status,
                                         callback_request_ptr);
      break;
  ...
  if (res < 0)
  {
    qcril_uim_response(orig_ptr->instance_id, orig_ptr->token,
...
)
{
  ...
  if(qcril_uim_ara_m_delay_timer.timer_id != 0)
  {
    ...
    qcril_uim_response(qcril_uim_ara_m_delay_timer.instance_id, qcril_uim_ara_m_delay_timer.token,
                       QCRIL_UIM_RIL_E_INTERNAL_ERR, NULL, 0, TRUE,
                 (char *)"error in ARA-M qcril_qmi_uim_logical_channel due to card error or refresh reset");
  }
...
set_terminal_capability_req_error:
  qcril_uim_response(params_ptr->instance_id, params_ptr->t, ril_err,
        NULL, 0, TRUE, (char *)"error in qcril_uim_request_set_terminal_capability");
...
get_terminal_capability_req_error:
  qcril_uim_response(params_ptr->instance_id, params_ptr->t, ril_err,
         NULL, 0, TRUE, (char *)"error in qcril_uim_request_get_terminal_capability");
