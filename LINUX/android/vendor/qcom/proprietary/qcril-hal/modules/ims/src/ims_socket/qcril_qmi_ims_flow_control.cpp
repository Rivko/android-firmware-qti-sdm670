...
static qcril_evt_e_type ims_flow_control_family_ring_dtmf_req[IMS_FLOW_CONTROL_MSG_COUNT];
...
void qcril_ims_init_flow_control_msgs_table()
{
  ims_flow_control_family_ring_dtmf_req[0] = QCRIL_EVT_IMS_SOCKET_REQ_DTMF;
  ims_flow_control_family_ring_dtmf_req[1] = QCRIL_EVT_IMS_SOCKET_REQ_DTMF_START;
  ims_flow_control_family_ring_dtmf_req[2] = QCRIL_EVT_IMS_SOCKET_REQ_DTMF_STOP;
}
...
void qcril_ims_flow_control_pre_init()
{
  ...
  /* Initialize flow control msg array */
  qcril_ims_init_flow_control_msgs_table();
  ...
  qcril_ims_flow_control_family_ring =
              (qcril_qmi_ims_family_ring_list_type*)qcril_malloc(sizeof(qcril_qmi_ims_family_ring_list_type));
  ...
  if(qcril_ims_flow_control_family_ring != NULL)
  {
    ...
    qcril_ims_flow_control_family_ring->ims_flow_control_family_ring =
                      ims_flow_control_family_ring_dtmf_req;
