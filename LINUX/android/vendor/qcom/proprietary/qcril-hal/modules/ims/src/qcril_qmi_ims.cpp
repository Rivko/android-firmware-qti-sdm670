...
*/
/*=========================================================================*/
static const char *qcril_qmi_ims_vt_lookup_command_name
(
  unsigned long msg
)
{
...
*/
/*=========================================================================*/
static const char *qcril_qmi_ims_presence_lookup_command_name
(
  unsigned long msg
)
{
...
)
{
  ...
  if( ind_data_ptr != NULL )
  {
    ...
    qcril_hook_unsol_response( instance_id,  QCRIL_EVT_HOOK_VT_UNSOL_CALL_STATUS_IND, (char*)ind_data_ptr, ind_data_len );
  }
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)dial_call_resp->resp.error, &resp );
    }
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)ans_call_resp->resp.error, &resp );
    }
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)end_call_resp->resp.error, &resp );
    }
...
)
{
  ...
  modem_id = (qcril_modem_id_e_type)QCRIL_EXTRACT_MODEM_ID_FROM_USER_DATA( user_data );
...
)
{
  ...
  {
     decoded_payload = (void*)qcril_malloc(decoded_payload_len);
  }
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      dial_call_resp = (ims_vt_dial_call_resp_v01*)qcril_malloc( sizeof( ims_vt_dial_call_resp_v01 ) );
  ...
  if ( err != QMI_NO_ERR )
  {
    ...
    qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)err, &resp );
    qcril_send_request_response( &resp );
  }
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
     ...
     if( err == QMI_NO_ERR )
     {
        answer_call_resp = (ims_vt_answer_call_resp_v01*)qcril_malloc( sizeof(ims_vt_answer_call_resp_v01) );

        if( answer_call_resp == NULL )
        {
          qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)QMI_SERVICE_ERR_NO_MEMORY, &resp );
          qcril_send_request_response( &resp );
          return;
        }
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
     ...
     end_call_resp = (ims_vt_end_call_resp_v01*)qcril_malloc( sizeof(voice_end_call_resp_msg_v02) );
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)publish_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)unpublish_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)subscribe_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)subscribe_xml_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)unsubscribe_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)set_notify_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
    else
    {
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)get_notify_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
    else
    {
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)set_event_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
    else
    {
...
)
{
  ...
  if( params_ptr->data != NULL )
  {
    ...
    if ( result != QMI_NO_ERR )
    {
      qcril_default_request_resp_params( instance_id, params_ptr->t, params_ptr->event_id, (RIL_Errno)get_event_resp->resp.error, &resp );
      qcril_send_request_response( &resp );
    }
    else
    {
...
)
{
  ...
  if( ind_data_ptr != NULL )
  {
    ...
    qcril_hook_unsol_response( instance_id,  QCRIL_EVT_HOOK_IMS_PUBLISH_TRIGGER_IND_V01, (char*)ind_data_ptr, ind_data_len );
  }
...
)
{
  ...
  if( ind_data_ptr != NULL )
  {
    ...
    qcril_hook_unsol_response( instance_id,  QCRIL_EVT_HOOK_IMS_NOTIFY_XML_IND_V01, (char*)ind_data_ptr, ind_data_len );
  }
...
)
{
  ...
  if( ind_data_ptr != NULL )
  {
    ...
    qcril_hook_unsol_response( instance_id,  QCRIL_EVT_HOOK_IMS_NOTIFY_IND_V01, (char*)ind_data_ptr, ind_data_len );
  }
...
)
{
  ...
  if( ind_data_ptr != NULL )
  {
    ...
    qcril_hook_unsol_response( instance_id,  QCRIL_EVT_HOOK_IMS_ENABLER_STATUS_IND, (char*)ind_data_ptr, ind_data_len );
  }
  ...
  if( ind_data_ptr != NULL )
  {
     ...
     if( ( publish_ind->imsp_publish_callid == req_info.sub_id ) && (req_info.valid_sub_id ) )
     {
        ...
        else
        {
           ...
           {
                publish_resp.resp.error = (qmi_error_type_v01)publish_ind->imsp_sip_resp_code;
           ...
           qcril_default_request_resp_params( instance_id, req_info.t, req_info.request, (RIL_Errno)err_code, &resp );
        }
  ...
  if( ind_data_ptr != NULL )
  {
     ...
     if( ( publish_xml_ind->imsp_publish_callid == req_info.sub_id ) && (req_info.valid_sub_id ) )
     {
         ...
         else
         {
            ...
            {
                publish_xml_resp.resp.error = (qmi_error_type_v01)publish_xml_ind->imsp_sip_resp_code;
  ...
  if( ind_data_ptr != NULL )
  {
     ...
     if( ( unpublish_ind->imsp_unpublish_callid == req_info.sub_id ) && (req_info.valid_sub_id ) )
     {
        ...
        else
        {
           ...
           {
              unpublish_resp.resp.error = (qmi_error_type_v01)unpublish_ind->imsp_sip_resp_code;
  ...
  if( ind_data_ptr != NULL )
  {
     ...
     if( ( subscribe_ind->imsp_subscribe_callid == req_info.sub_id ) && (req_info.valid_sub_id ) )
     {
         ...
         else
         {
            ...
            {
                subscribe_resp.resp.error = (qmi_error_type_v01)subscribe_ind->imsp_sip_resp_code;
  ...
  if( ind_data_ptr != NULL )
  {
     ...
     if( ( subscribe_xml_ind->imsp_subscribe_callid == req_info.sub_id ) && (req_info.valid_sub_id ) )
     {
         ...
         else
         {
            ...
            {
                subscribe_xml_resp.resp.error = (qmi_error_type_v01)subscribe_xml_ind->imsp_sip_resp_code;
  ...
  if( ind_data_ptr != NULL )
  {
     ...
     if( ( unsubscribe_ind->imsp_unsubscribe_callid == req_info.sub_id ) && (req_info.valid_sub_id ) )
     {
        ...
        else
        {
           ...
           {
              unsubscribe_resp.resp.error = (qmi_error_type_v01)unsubscribe_ind->imsp_sip_resp_code;
...
)
{
  ...
  if( err == QMI_NO_ERR )
  {
     enabler_state_resp = (imsp_get_enabler_state_resp_v01*)qcril_malloc( sizeof(*enabler_state_resp) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      send_publish_resp = (imsp_send_publish_resp_v01*)qcril_malloc( sizeof( *send_publish_resp ) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      send_publish_resp = (imsp_send_publish_xml_resp_v01*)qcril_malloc( sizeof( *send_publish_resp ) );
...
)
{
  ...
  if( err == QMI_NO_ERR )
  {
     unpublish_resp = (imsp_send_unpublish_resp_v01*)qcril_malloc( sizeof( *unpublish_resp ) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      send_subscribe_resp = (imsp_send_subscribe_resp_v01*)qcril_malloc( sizeof( *send_subscribe_resp ) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      send_subscribe_resp = (imsp_send_subscribe_xml_resp_v01*)qcril_malloc( sizeof( *send_subscribe_resp ) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      unsubscribe_resp = (imsp_send_unsubscribe_resp_v01*)qcril_malloc( sizeof( *unsubscribe_resp ) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      notify_fmt_resp = (imsp_set_notify_fmt_resp_v01*)qcril_malloc( sizeof( *notify_fmt_resp ) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      notify_fmt_resp = (imsp_get_notify_fmt_resp_v01*)qcril_malloc( sizeof( *notify_fmt_resp ) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      event_report_resp = (imsp_set_event_report_resp_v01*)qcril_malloc( sizeof( *event_report_resp ) );
...
)
{
  ...
  if ( err == QMI_NO_ERR )
  {
      ...
      event_report_resp = (imsp_get_event_report_resp_v01*)qcril_malloc( sizeof( *event_report_resp ) );
