...
CallFailCause convertProtoToHidlCallFailCause(const ims_CallFailCause& failCause) {
    switch (failCause) {
        ...
        case ims_CallFailCause_CALL_FAIL_DIAL_MODIFIED_TO_USSD:
            return CallFailCause::CALL_FAIL_DIAL_MODIFIED_TO_USSD;
        case ims_CallFailCause_CALL_FAIL_DIAL_MODIFIED_TO_SS:
            return CallFailCause::CALL_FAIL_DIAL_MODIFIED_TO_SS;
        case ims_CallFailCause_CALL_FAIL_DIAL_MODIFIED_TO_DIAL:
            return CallFailCause::CALL_FAIL_DIAL_MODIFIED_TO_DIAL;
        ...
        case ims_CallFailCause_CALL_FAIL_DIAL_MODIFIED_TO_DIAL_VIDEO:
            return CallFailCause::CALL_FAIL_DIAL_MODIFIED_TO_DIAL_VIDEO;
        case ims_CallFailCause_CALL_FAIL_DIAL_VIDEO_MODIFIED_TO_DIAL:
            return CallFailCause::CALL_FAIL_DIAL_VIDEO_MODIFIED_TO_DIAL;
        case ims_CallFailCause_CALL_FAIL_DIAL_VIDEO_MODIFIED_TO_DIAL_VIDEO:
            return CallFailCause::CALL_FAIL_DIAL_VIDEO_MODIFIED_TO_DIAL_VIDEO;
        case ims_CallFailCause_CALL_FAIL_DIAL_VIDEO_MODIFIED_TO_SS:
            return CallFailCause::CALL_FAIL_DIAL_VIDEO_MODIFIED_TO_SS;
        case ims_CallFailCause_CALL_FAIL_DIAL_VIDEO_MODIFIED_TO_USSD:
            return CallFailCause::CALL_FAIL_DIAL_VIDEO_MODIFIED_TO_USSD;
