...
static std::map<qcril_evt_e_type, ims_MsgId> qcril_qmi_ims_event_msgid_map
{
    ...
    { QCRIL_EVT_IMS_SOCKET_REQ_SET_TTY_MODE,
                                            ims_MsgId_REQUEST_SEND_UI_TTY_MODE },

    { QCRIL_EVT_IMS_SOCKET_REQ_GET_RTP_STATISTICS,
                                            ims_MsgId_REQUEST_GET_RTP_STATISTICS },

    { QCRIL_EVT_IMS_SOCKET_REQ_GET_RTP_ERROR_STATISTICS,
                                            ims_MsgId_REQUEST_GET_RTP_ERROR_STATISTICS },
...
//===========================================================================
ims_MsgId qcril_qmi_ims_map_event_to_request(qcril_evt_e_type event)
{
  std::map<qcril_evt_e_type, ims_MsgId>::iterator it;

  it = qcril_qmi_ims_event_msgid_map.find(event);

  if (it != qcril_qmi_ims_event_msgid_map.end())
      return it->second;
  else
      return ims_MsgId_UNKNOWN_REQ;
}

boolean qcril_qmi_ims_is_valid_event(qcril_evt_e_type event)
{
    QCRIL_LOG_FUNC_ENTRY("Event: %s", event ? event->name : "<NULL>");
    auto count = qcril_qmi_ims_event_msgid_map.count(event);
    bool ret = (count == 1);
...
ims_Error qcril_qmi_ims_map_ril_error_to_ims_error(int ril_error)
{
  ...
  switch ( ril_error )
  {
    ...
    case RIL_E_DIAL_MODIFIED_TO_DIAL:
      ret = ims_Error_E_DIAL_MODIFIED_TO_DIAL;
      break;

    case RIL_E_DIAL_MODIFIED_TO_DIAL_VIDEO:
      ret = ims_Error_E_DIAL_MODIFIED_TO_DIAL_VIDEO;
      break;

    case RIL_E_DIAL_MODIFIED_TO_SS:
      ret = ims_Error_E_DIAL_MODIFIED_TO_SS;
      break;

    case RIL_E_DIAL_MODIFIED_TO_USSD:
      ret = ims_Error_E_DIAL_MODIFIED_TO_USSD;
      break;

    case RIL_E_DIAL_VIDEO_MODIFIED_TO_DIAL:
      ret = ims_Error_E_DIAL_VIDEO_MODIFIED_TO_DIAL;
      break;

    case RIL_E_DIAL_VIDEO_MODIFIED_TO_DIAL_VIDEO:
      ret = ims_Error_E_DIAL_VIDEO_MODIFIED_TO_DIAL_VIDEO;
      break;

    case RIL_E_DIAL_VIDEO_MODIFIED_TO_SS:
      ret = ims_Error_E_DIAL_VIDEO_MODIFIED_TO_SS;
      break;

    case RIL_E_DIAL_VIDEO_MODIFIED_TO_USSD:
      ret = ims_Error_E_DIAL_VIDEO_MODIFIED_TO_USSD;
      break;

    case RIL_E_SS_MODIFIED_TO_DIAL:
      ret = ims_Error_E_SS_MODIFIED_TO_DIAL;
      break;

    case RIL_E_SS_MODIFIED_TO_DIAL_VIDEO:
      ret = ims_Error_E_SS_MODIFIED_TO_DIAL_VIDEO;
      break;

    case RIL_E_SS_MODIFIED_TO_SS:
      ret = ims_Error_E_SS_MODIFIED_TO_SS;
      break;

    case RIL_E_SS_MODIFIED_TO_USSD:
      ret = ims_Error_E_SS_MODIFIED_TO_USSD;
      break;
...
void qcril_qmi_ims_translate_ims_calldetails_to_ril_calldetails(const ims_CallDetails *ims_data, RIL_Call_Details* ril_data)
{
  if (NULL == ril_data || NULL == ims_data)
  {
    ...
    if (NULL != ril_data)
    {
       ...
       ril_data->callType = qcril_qmi_ims_map_ims_call_type_to_ril_call_type(FALSE, ims_CallType_CALL_TYPE_VOICE);
       ril_data->callDomain = qcril_qmi_ims_map_ims_call_domain_to_ril_call_domain(FALSE, ims_CallDomain_CALL_DOMAIN_UNKNOWN);
    }
  }
  else
  {
...
)
{
  ...
  else
  {
    do
    {
      ...
      if (num > 0)
      {
        ims_data->info.arg = (ims_CallForwardInfoList_CallForwardInfo *)
                        qcril_malloc(sizeof(ims_CallForwardInfoList_CallForwardInfo*) *
                (num+1));
        ...
        for (i = 0; i < num; i++)
        {
          ims_CallForwardInfoList_CallForwardInfo* cfi = (ims_CallForwardInfoList_CallForwardInfo *)qcril_malloc(
...
void qcril_qmi_ims_translate_ril_service_status_class_to_ims_callwaitinginfo(int service_status, int service_class, ims_CallWaitingInfo* ims_data)
{
  ...
  else
  {
    ...
    ims_data->service_status = (ims_ServiceClassStatus)service_status;
...
void qcril_qmi_ims_translate_ril_suppsvcnotification_to_ims_suppsvcnotification(const RIL_SuppSvcNotification* ril_data, ims_SuppSvcNotification* ims_data)
{
  ...
  else
  {
    ...
    ims_data->notificationType = (ims_NotificationType)ril_data->notificationType;
...
)
{
  ...
  if (ims_info)
  {
    ...
    {
      ims_info->accTechStatus.arg = (ims_StatusForAccessTech *)qcril_malloc((1+1) * sizeof(ims_StatusForAccessTech *));

      if (ims_info->accTechStatus.arg)
      {
        ims_StatusForAccessTech *acc_tech_status = (ims_StatusForAccessTech *)qcril_malloc(sizeof(ims_StatusForAccessTech));
        if (acc_tech_status)
        {
...
)
{
  ...
  else
  {
    ...
    ims_data->SrvStatusInfo.arg = (ims_Info *)qcril_malloc( (n_srvstatusinfo+1) * sizeof(ims_Info*) );
...
)
{
    ...
    do
    {
        ims_info_ptr = (ims_Info *)qcril_malloc(sizeof(*ims_info_ptr));
        ...
        ims_info_ptr->accTechStatus.arg =
            (ims_StatusForAccessTech *)qcril_malloc( sizeof(ims_StatusForAccessTech*) * (num_of_acc_tech_status+1));
...
ims_SrvStatusList* qcril_qmi_ims_create_ims_srvstatusinfo(const qcril_qmi_imsa_srv_status_type* qmi_data)
{
    ...
    else
    {
        ...
        do
        {
            ims_srv_status_list_ptr = (ims_SrvStatusList *)qcril_malloc(sizeof(*ims_srv_status_list_ptr));
            ...
            if (num_of_info > 0)
            {
                ims_srv_status_list_ptr->SrvStatusInfo.arg = (ims_Info*)qcril_malloc( sizeof(ims_Info*) *
                        (num_of_info+1));
            }
...
ims_Handover* qcril_qmi_ims_create_ims_handover_from_imsa_rat_info(const imsa_rat_handover_status_info_v01* qmi_data)
{
    ...
    else
    {
        ...
        do
        {
            ims_handover_ptr = (ims_Handover *)qcril_malloc(sizeof(*ims_handover_ptr));
            ...
            if (strlen(qmi_data->cause_code))
            {
                           ...
                           strlen(WLAN_HANDOVER_NO_LTE_FAILURE_CODE_STRING)) == 0) )
                {
                    ...
                    ims_handover_ptr->errorCode.arg = (void *)qcril_malloc(
                            strlen(WLAN_HANDOVER_NO_LTE_FAILURE_CODE_STRING) + 1);
                    if(ims_handover_ptr->errorCode.arg != NULL)
                    {
                        strlcpy((char * __restrict)ims_handover_ptr->errorCode.arg, WLAN_HANDOVER_NO_LTE_FAILURE_CODE_STRING,
                                strlen(WLAN_HANDOVER_NO_LTE_FAILURE_CODE_STRING) + 1);
                    ...
                    {
                        ims_handover_ptr->errorMessage.arg = (void *)qcril_malloc(
                                (strlen(qmi_data->cause_code) + 1) - errormessage_start);
                        if(ims_handover_ptr->errorMessage.arg)
                        {
                            strlcpy((char* __restrict)ims_handover_ptr->errorMessage.arg,
                ...
                else
                {
                    ...
                    qcril_binary_data_type *bin_data = (qcril_binary_data_type *)qcril_malloc(sizeof(*bin_data));
                    if (NULL == bin_data)
                    {
                        failure = TRUE;
                        break;
                    }
                    bin_data->data = (uint8_t *)qcril_malloc(strlen(qmi_data->cause_code));
...
*/
/*=========================================================================*/
boolean qcril_qmi_voice_map_qmi_reason_to_ims_facility
(
  voice_cc_sups_result_reason_enum_v02 reason,
  ims_SuppSvcFacilityType *ims_reason
)
{
  boolean result = TRUE;
  ...
  if (ims_reason)
  {
    switch (reason)
    {
      ...
      case VOICE_CC_SUPS_RESULT_REASON_BARR_ALLOUTGOING_V02:
        *ims_reason = ims_SuppSvcFacilityType_FACILITY_BAOC;
        break;

        /* Bar All Outgoing International Calls */
      case VOICE_CC_SUPS_RESULT_REASON_BARR_OUTGOINGINT_V02:
        *ims_reason = ims_SuppSvcFacilityType_FACILITY_BAOIC;
        break;
      ...
      case VOICE_CC_SUPS_RESULT_REASON_BARR_OUTGOINGINTEXTOHOME_V02:
        *ims_reason = ims_SuppSvcFacilityType_FACILITY_BAOICxH;
        break;

        /* Bar All Incoming Calls */
      case VOICE_CC_SUPS_RESULT_REASON_BARR_ALLINCOMING_V02:
        *ims_reason = ims_SuppSvcFacilityType_FACILITY_BAIC;
        break;
...
)
{
  ...
  {
    ims_call_substate = static_cast<ims_CallSubstate>(ims_CallSubstate_CALL_SUBSTATE_AUDIO_CONNECTED_SUSPENDED |
