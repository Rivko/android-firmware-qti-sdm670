...
RilRequestQueryCallForwardMessage::~RilRequestQueryCallForwardMessage() {
  if (params != nullptr) {
...
void RilRequestQueryCallForwardMessage::deepCopy(const ril_request_type &request) {
...
string RilRequestQueryCallForwardMessage::dump() {
  return mName;
}
