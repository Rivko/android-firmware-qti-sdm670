...
#define __QCOM_FM_RADIO_CTRL_H__
...
class FmRadioController_qcom
{
    private:
        ...
        char rds_enabled;
        long int prev_freq;
        //Final_RDS_data rds_data;
        //RTPlus_data CurrentRTPlusData;
        int fd_driver;
    ...
    public:
       ...
       int GetAFValid_th(void);
       void SetAFValid_th(int );
       int GetAF_th(void);
       void SetAF_th(int);
       ...
       void SetSeekRSSI(long);
       void SetSeekSNR(long);
       void SetRSSI_th(unsigned short);
       void SetSNR_th(unsigned char);
       void SetCnt_th(unsigned char);
       int GetRSSI_th(void);
       int GetSNR_th(void);
       int GetCnt_th(void);
       // emphasis
       int SetDeConstant(long );
       long SearchDown(void);
       long SearchUp(void);
       long SearchAll(void);
