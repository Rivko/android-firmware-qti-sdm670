...
/*===========================================================================
    ...
    module is coupled with Qualcomm Technologies Audio Calibration Tool (QACT) v2.x.x.
    Qualcomm Technologies recommends to always use the latest version of QACT for
...
========================================================================== */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acdb/src/acdb_private.h#11 $ */
...
enum AcdbTableIds{
	...
	VOCPROC_STATIC_TBL,
	VOC_STREAM2_TBL,
	WDSP_MODULE_CAL_TBL_ID = 0x00000021,
	WDSP_MODULE_CONN_TBL_ID = 0x00000022,
	WDSP_SUBGRAPH_CONN_TBL_ID = 0x00000023,
	WDSP_DYN_MOD_INFO_TBL_ID = 0x00000024,
	WDSP_MOD_INFO_DATA_TBL_ID = 0x00000025,
};
...
typedef struct _AcdbQueryTblEntriesCmdType AcdbQueryTblEntriesCmdType;
#include "acdb_begin_pack.h"
struct _AcdbQueryTblEntriesCmdType {
   uint32_t nTblId;
