...
public class SWCalibrationActivity extends SemiAutomaticActivity {
    ...
    protected static final String SW_CALIB_PROXY_PATH = "/data/usf/sw_calib/usf_sw_calib_proxy.cfg";
    ...
    protected static final int CALIB_CIRCLE_DIAMETER_DP = 60; /* Diameter if the calibration circles */

    private static final int NUM_TOTAL_CALIB_CIRCLES = 4;

    protected static final float MAX_X = 1000f; /* Maximum value of X coordinate of the calibration
                                                   circle received from socket */

    protected static final float MAX_Y = 1000f; /* Maximum value of Y coordinate of the calibration
                                                   circle received from socket */
    ...
    protected View mCurrentCircle = null; /* The currently active calibration circle view.*/
    ...
    protected void onStart() {
        ...
        mSwCalibSocketListener = new SocketListener(mSwCalibHandler, SW_CALIB_SOCKET_PATH,
                mSwCalibDaemon, 4 * (Integer.SIZE / Byte.SIZE));
    ...
    protected void changeCfgLink() {
        try {
            ...
            Runtime.getRuntime().exec(
                "ln -s " + SW_CALIB_CFG_PATH + " " + SW_CALIB_PROXY_PATH);
        } catch (IOException e) {
            Log.e(this.toString(), e.toString());
