...
public class PairedPensActivity extends ListActivity {
    ...
    private static final String PEN_DATA_FILE = "/data/usf/epos/persistent_calib.dat";
    ...
    private static void removePersistCalibFile() {
      try {
          Runtime.getRuntime().exec("rm " + PEN_DATA_FILE);
      } catch (IOException e) {
          Log.e(PairedPensActivity.class.getName(), "Failed removing " + PEN_DATA_FILE);
      }
    }
}
