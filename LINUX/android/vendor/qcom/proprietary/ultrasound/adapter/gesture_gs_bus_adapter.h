/*===========================================================================
                           gesture_gs_bus_adapter.h

DESCRIPTION: Header file for gesture bus adapter for gesture daemon
...
#ifndef __GESTURE_GS_BUS_ADAPTER_H__
#define __GESTURE_GS_BUS_ADAPTER_H__
...
public:
  /*============================================================================
    CONSTRUCTOR:
  ============================================================================*/
  GestureGsBusAdapter(char *gesture_fw_lib_path);
