/*===========================================================================
                           proximity_gs_bus_adapter.h

DESCRIPTION: Header file for gesture bus adapter for proximity daemon
...
#ifndef __PROXIMITY_GS_BUS_ADAPTER_H__
#define __PROXIMITY_GS_BUS_ADAPTER_H__
...
-----------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
  Class ProximityGsBusAdapter
-----------------------------------------------------------------------------*/
class ProximityGsBusAdapter : public GsBusAdapter
{
public:
  /*============================================================================
    CONSTRUCTOR:
  ============================================================================*/
  ProximityGsBusAdapter(char *gesture_fw_lib_path);
