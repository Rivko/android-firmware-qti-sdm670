...
{
  // We should have divided the x and y components by the vector legth.
  // The vector is normalized, hence its length is 1.
  return Vector(asin(vector[X]) * RAD_TO_DEG,
                asin(vector[Y]) * RAD_TO_DEG,
                0);
}
