...
LOCAL_MODULE:= product_calib_mtp_ref2.dat
LOCAL_MODULE_CLASS := DATA
LOCAL_SRC_FILES := $(LOCAL_MODULE)
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE:= unit_calib_mtp_ref2.dat
LOCAL_MODULE_CLASS := DATA
LOCAL_SRC_FILES := $(LOCAL_MODULE)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/persist/usf/epos/ref2
...
LOCAL_MODULE:= sw_calib_mtp.dat
LOCAL_MODULE_CLASS := DATA
LOCAL_SRC_FILES := $(LOCAL_MODULE)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/persist/usf/sw_calib
LOCAL_MODULE_OWNER := qti
include $(BUILD_PREBUILT)
