...
public class EventInterface {
    ...
    public static Intent makeOffScreenDimensionIntent(float[] origin, float[] endX, float[] endY) {
        Intent intent = new Intent(EventInterface.INTENT_OFF_SCREEN_DIMENSIONS);
        intent.putExtra(INTENT_DIMENSION_KEY_ORIGIN, origin);
        intent.putExtra(INTENT_DIMENSION_KEY_END_X, endX);
        intent.putExtra(INTENT_DIMENSION_KEY_END_Y, endY);
        return intent;
    }
