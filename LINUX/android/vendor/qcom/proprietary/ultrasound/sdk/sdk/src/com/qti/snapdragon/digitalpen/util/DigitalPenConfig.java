...
public class DigitalPenConfig implements Parcelable {
    ...
    // usf_types.h defines USF_TSC_EVENT as 1
    public static final byte DP_INPUT_TYPE_STYLUS = 1;

    // usf_types.h defines USF_MOUSE_EVENT as 4
    public static final byte DP_INPUT_TYPE_MOUSE = 4;
    ...
    public static final byte DP_MOUSE_SENSITIVITY_SLOW = 1;

    public static final byte DP_MOUSE_SENSITIVITY_MEDIUM = 2;

    public static final byte DP_MOUSE_SENSITIVITY_FAST = 4;
    ...
    private byte mInputType;

    private byte mMouseSensitivity;
    ...
    public DigitalPenConfig() {
        // Default configuration (The service will typically load from config
        // file; these settings should only be seen in unit tests)
        mTouchRange = 35;
        ...
        mInputType = DP_INPUT_TYPE_STYLUS;
        mMouseSensitivity = DP_MOUSE_SENSITIVITY_MEDIUM;
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeByte(mInputType);
        out.writeByte(mMouseSensitivity);
    }
    ...
    private DigitalPenConfig(Parcel in) {
        ...
        mInputType = in.readByte();
        mMouseSensitivity = in.readByte();
    }
    ...
    public byte getMouseSensitivity() {
        return mMouseSensitivity;
    }

    public void setMouseSensitivity(byte mouseSensitivity) {
