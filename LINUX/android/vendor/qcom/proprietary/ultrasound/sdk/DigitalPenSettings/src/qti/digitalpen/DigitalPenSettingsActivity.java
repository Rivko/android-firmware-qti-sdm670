...
import com.qti.snapdragon.digitalpen.DigitalPenGlobalControl.DigitalPenGlobalSettings.InputType;
import com.qti.snapdragon.digitalpen.DigitalPenGlobalControl.DigitalPenGlobalSettings.MouseSensitivity;
...
public class DigitalPenSettingsActivity extends Activity implements OnCheckedChangeListener {
    ...
    private void initializeWidgetValues() {
        ...
        if (config.getInputType() == InputType.STYLUS) {
            setCheckbox(R.id.inputTypeStylus, true);
        } else {
            setCheckbox(R.id.inputTypeMouse, true);
        }

        if (config.getMouseSensitivity() == MouseSensitivity.SLOW) {
            setCheckbox(R.id.mouseSensitivitySlow, true);
        } else if (config.getMouseSensitivity() == MouseSensitivity.MEDIUM) {
            setCheckbox(R.id.mouseSensitivityMedium, true);
        } else if (config.getMouseSensitivity() == MouseSensitivity.FAST) {
            setCheckbox(R.id.mouseSensitivityFast, true);
        }
    ...
    public void onClickInputType(View v) {
        switch (v.getId()) {
            case R.id.inputTypeStylus:
                config.setDefaultInputType(InputType.STYLUS);
                break;
            case R.id.inputTypeMouse:
                config.setDefaultInputType(InputType.MOUSE);
                break;
            default:
                throw new RuntimeException("Unknown ID:" + v.getId());
        }
    ...
    public void onClickMouseSensitivity(View v) {
        switch (v.getId()) {
            case R.id.mouseSensitivitySlow:
                config.setMouseSensitivity(MouseSensitivity.SLOW);
                break;
            case R.id.mouseSensitivityMedium:
                config.setMouseSensitivity(MouseSensitivity.MEDIUM);
                break;
            case R.id.mouseSensitivityFast:
                config.setMouseSensitivity(MouseSensitivity.FAST);
                break;
            default:
                throw new RuntimeException("Unknown ID:" + v.getId());
        }
