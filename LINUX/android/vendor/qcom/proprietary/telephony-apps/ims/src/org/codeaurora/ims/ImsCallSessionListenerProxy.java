...
public class ImsCallSessionListenerProxy extends ImsCallSessionListenerImplBase {
    ...
    public void callSessionMayHandover(IImsCallSession session, int srcAccessTech,
        ...
        if (mListener != null) {
            final Runnable r = new Runnable() {
                ...
                public void run() {
                    try {
                        Log.i(this, "callSessionMayHandover()");
                        mListener.callSessionMayHandover(session, srcAccessTech,
                                targetAccessTech);
                    } catch (Throwable t) {
                        handleError(t, "callSessionMayHandover()");
                    }
                }
            };
            postRunnable(r);
   ...
   /**
    ...
    public void callSessionRttModifyResponseReceived(final int status) {
        if (mListener != null) {
            final Runnable r = new Runnable() {
                ...
                public void run() {
                    try {
                        Log.i(this, "RTT: callSessionRttModifyResponseReceived()");
                        mListener.callSessionRttModifyResponseReceived(status);
                    } catch (RemoteException re) {
                        Log.e(this, "RTT: RemoteException @" +
                                "callSessionRttModifyResponseReceived() --> " + re);
                    }
                }
            };
            postRunnable(r);
    ...
    public void callSessionRttMessageReceived(final String rttMessage) {
        if (mListener != null) {
            final Runnable r = new Runnable() {
                ...
                public void run() {
                    try {
                        Log.i(this, "RTT: callSessionRttMessageReceived()");
                        mListener.callSessionRttMessageReceived(rttMessage);
                    } catch (RemoteException re) {
                        Log.e(this, "RTT: RemoteException @" +
                                "callSessionRttMessageReceived() --> " + re);
                    }
                }
            };
            postRunnable(r);
    ...
    public void callSessionRttModifyRequestReceived(final IImsCallSession session,
            final ImsCallProfile profile) {
        if (mListener != null) {
            final Runnable r = new Runnable() {
                @Override
                public void run() {
                    try {
                        Log.i(this, "RTT: callSessionRttModifyRequestReceived()");
                        mListener.callSessionRttModifyRequestReceived(session, profile);
                    } catch (RemoteException re) {
                        Log.e(this, "RTT: RemoteException @" +
                                "callSessionRttModifyRequestReceived() --> " + re);
                    }
                }
            };
            postRunnable(r);
