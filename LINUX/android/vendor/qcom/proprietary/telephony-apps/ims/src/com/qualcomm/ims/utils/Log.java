...
public class Log {
    ...
    public static final String TAG = "QImsService";
    ...
    /**
     * Used to hide private information like phone number, name etc by
     * creating a hash of the string in non verbose mode.
     */
