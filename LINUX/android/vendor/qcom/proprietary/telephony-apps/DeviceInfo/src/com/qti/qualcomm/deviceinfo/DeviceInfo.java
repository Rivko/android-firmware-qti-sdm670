...
public class DeviceInfo extends PreferenceActivity {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (systemService != null) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        DeviceInfo.this.setSummaryText(KEY_META_VERSION, mMetaInfo);
                    }
                });
            }
        }
    ...
    private class ObtainIdHandler extends Handler {
        ...
        public String getBasebandVersionForPhone(int phoneId, String defaultVal) {
            if (SubscriptionManager.isValidPhoneId(phoneId)) {
                String prop = SystemProperties.get(TelephonyProperties.PROPERTY_BASEBAND_VERSION +
    ...
    private void setPreferenceSummary() {
        ...
        String basebandVersion = mHandler.getBasebandVersionForPhone(mPhone.getPhoneId(), null);
