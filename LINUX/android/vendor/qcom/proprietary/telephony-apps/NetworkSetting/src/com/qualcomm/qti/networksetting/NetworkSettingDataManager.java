...
public class NetworkSettingDataManager {
    ...
    private boolean mAppDisableData = false;
    Message mMsg;
    ...
    public NetworkSettingDataManager(Context context) {
        ...
        mAppDisableData = SystemProperties.getBoolean("persist.radio.plmn_disable_data", false);
        ...
        if (!enable) {
            ...
            if (mAppDisableData &&
                ...
                mTelephonyManager.setDataEnabled( SubscriptionManager
                        .getDefaultDataSubscriptionId(), true);
    ...
    private final class ConfirmDialogListener
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (which == DialogInterface.BUTTON_POSITIVE){
                ...
                mTelephonyManager.setDataEnabled(SubscriptionManager
                        .getDefaultDataSubscriptionId(), false);
