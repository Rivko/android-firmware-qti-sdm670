...
public final class UimLpaConstants {
    ...
    public static final int UIM_LPA_ADD_PROFILE_GET_USER_CONSENT             = 5;

    public static final int UIM_LPA_PROFILE_DISABLE_NOT_ALLOWED   = 1;
    public static final int UIM_LPA_PROFILE_DELETE_NOT_ALLOWED    = 2;
    public static final int UIM_LPA_PROFILE_DELETE_ON_DISABLE     = 4;
    ...
    public static final int UIM_LPA_PROFILE_CLASS_TEST           = 0;
    public static final int UIM_LPA_PROFILE_CLASS_PROVISIONING   = 1;
    public static final int UIM_LPA_PROFILE_CLASS_OPERATIONAL    = 2;
