...
int loc_extended_init(GpsExtCallbacks* callbacks)
{
    ...
    LocCallbacks clientCallbacks = {NULL, /* location_cb */
                                    ...
                                    NULL, /* set_system_info_cb */
                                    NULL, /* gnss_sv_status_cb */
                                    };
...
{
    ENTRY_LOG();
    LocServerType serverType = LOC_AGPS_SUPL_SERVER;
    switch (type) {
...
===========================================================================*/
void loc_extended_ni_respond(int notif_id, LocGpsUserResponseType user_response)
{
    ENTRY_LOG();
...
===========================================================================*/
int loc_extended_inject_time(LocGpsUtcTime time, int64_t timeReference, int uncertainty)
{
    ENTRY_LOG();
