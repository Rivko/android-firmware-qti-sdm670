...
public:
    ...
    static inline bool ulpExists() { return (mUlp != NULL); }
    ...
    static bool reportBatchingSessionToUlp(const LocationOptions& options,
                                           bool active);
    static bool reportPositionsToUlp(const UlpLocation* ulpLocations,
