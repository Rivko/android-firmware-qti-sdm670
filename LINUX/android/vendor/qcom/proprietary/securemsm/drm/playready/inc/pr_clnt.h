...
--------   ---     ----------------------------------------------------------
04/05/16    kr     Add License acknowledge challenge & response support
...
#include "playready_entry.h"
    ...
    ********************************************************************************/
    ...
    /********************************************************************************
      ...
      @param[out]     *pbChallenge             Contains the resulting license ack challenge.
      @param[in,out]  *pcbChallenge            Contains the size of the resulting license ack challenge.
    ...
    ********************************************************************************/
    ...
    /********************************************************************************
      Store a license ack response info in the license database.
      ...
      None
    ********************************************************************************/
    unsigned long playready_licacq_process_ack_response
    (
        uint32             app_ctx_id,
        uint8             *pbResponse,
        uint32             cbResponse
