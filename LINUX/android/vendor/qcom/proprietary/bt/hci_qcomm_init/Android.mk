...
LOCAL_SHARED_LIBRARIES  += libbtnv liblog libcutils
#LOCAL_SRC_FILES += bt_qmi_dms_client.c
#LOCAL_CFLAGS := -DBT_QSOC_GET_ITEMS_FROM_NV
#LOCAL_SHARED_LIBRARIES = libbtnv
#LOCAL_SHARED_LIBRARIES  += libqmiservices libqmi_cci libqcci_legacy libqmi_client_qmux liblog libcutils
...
#Enabled LE 4.0 feature for all targets by default
...
# add libbtnv library
LOCAL_SHARED_LIBRARIES := libbtnv
LOCAL_SHARED_LIBRARIES  += libqmiservices libqmi_cci liblog
LOCAL_C_INCLUDES += $(TARGET_OUT_HEADERS)/qmi-framework/inc
LOCAL_C_INCLUDES += $(TARGET_OUT_HEADERS)/qmi/inc
endif
