...
using V1_0::LocHidlLocation;
using V1_0::LocHidlIzatLocation;
using V1_0::LocHidlIzatProviderStatus;
using V1_0::LocHidlSubscriptionDataItemId;
using V1_0::LocHidlIzatProviderStatus;
using V1_0::LocHidlIzatStreamType;
using V1_0::LocHidlIzatRequest;
using V1_1::LocHidlSubscriptionDataItemId_1_1;
...
public:
    ...
    static LocHidlSubscriptionDataItemId_1_1
