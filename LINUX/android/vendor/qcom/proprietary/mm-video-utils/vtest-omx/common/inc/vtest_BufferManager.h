...
struct PortBufferCapability
{
    ...
    OMX_U32 nExtraDataBufferSize;
    OMX_U32 nExtraDataBufferCount;
...
struct BufferPool {
    ...
    Node *pUseNode;
    BufferInfo *pBuffers;
    OMX_BUFFERHEADERTYPE *pExtraDataBuffer[64];
    OMX_U32 nWidth;
    OMX_U32 nHeight;
...
public:
    ...
    int GetBuffer(ISource *pNode, OMX_U32 ePortIndex,
            OMX_BUFFERHEADERTYPE *pHeader, BufferInfo **pBuffer, BufferPool ** ppBufferPool = NULL);
