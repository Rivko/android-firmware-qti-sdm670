...
FACEPROC_API INT32      FACEPROC_DT_SetThreshInfo(HDETECTION hDT, INT32 nPose, THRESHOLDINFO sNonTrackingThresholdInfo);
FACEPROC_API INT32      FACEPROC_DT_GetThreshInfo(HDETECTION hDT, INT32 nPose, THRESHOLDINFO *psNonTrackingThresholdInfo);
...
FACEPROC_API INT32      FACEPROC_DT_MV_SetThreshInfo(HDETECTION hDT,INT32 nPose, THRESHOLDINFO sTrackingThresholdInfo);
FACEPROC_API INT32      FACEPROC_DT_MV_GetThreshInfo(HDETECTION hDT,INT32 nPose, THRESHOLDINFO *psTrackingThresholdInfo);
