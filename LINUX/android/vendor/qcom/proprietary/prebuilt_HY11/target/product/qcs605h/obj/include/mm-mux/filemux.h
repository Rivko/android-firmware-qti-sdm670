...
/*!
   ...
   @detail   This is used to update the streamport.
             Only allowed in pause state

   @param[in] pParams - stream properties

   @return    MUX_STATUS.
*/
MUX_STATUS MUX_update_stream_params(MUX_create_params_type *pParams);
...
private:
  ...
  static const unsigned int MUX_THREAD_STACK_SIZE = 24576;//16384;
  ...
  uint64   m_nStreamPort;

  bool     m_bUpdateStreamPort;

  uint64 m_nMultipleIovDataAllocator;
