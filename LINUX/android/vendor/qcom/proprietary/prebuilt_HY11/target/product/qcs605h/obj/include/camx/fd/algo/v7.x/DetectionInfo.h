...
#define DET_ED      (0x00000500U)        /* Eye Detector        */
#define DET_HD      (0x00000600U)        /* Hand Detector       */
#define DET_AD      (0x00000700U)
...
#define OBJ_TYPE_EYE      (0x00200000U)
#define OBJ_TYPE_HAND     (0x00400000U)
#define OBJ_TYPE_PALM     (0x00400000U)
#define OBJ_TYPE_FIST     (0x00800000U)
...
#define DET_METHOD_TRACKED_TLD     (DET_METHOD_TRACKED |DET_METHOD_TLD)
#define DET_METHOD_MAJOR_HIGH      (DET_METHOD_MAJOR   |DET_METHOD_ACCURACY_HIGH)
