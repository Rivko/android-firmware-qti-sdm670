...
typedef enum {
    ...
    C2D_COLOR_FORMAT_COMPRESSED_ETC1_RGB = 21,  /* ETC1 compressed (in 64byte, 4x4 multiples) */
    C2D_COLOR_FORMAT_COMPRESSED_ETC2A_RGBA = 22, /* ETC2 compressed (in 128 byte, 4x4 multiple, alpha/RGB interleave) */
