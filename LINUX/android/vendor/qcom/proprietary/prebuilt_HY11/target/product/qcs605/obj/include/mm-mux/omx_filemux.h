...
#define  OMX_MUX_INDEX_PORT_GENERIC                4
#define  OMX_MUX_INDEX_MAX_PORT                    5
...
/*!
  ...
  the QTI movie file writer implementation. The private section  deals with
...
protected:
    ...
    video::iMultipleIovDataAllocator *pMultipleIovDataAllocator; /**< iMultipleIovData allocation
    ...
    */
    typedef union OMX_FileMux_MediaFormatConfig
    {
        ...
        OMX_VIDEO_PARAM_HEVCTYPE sHEVCInfo;
    ...
    */
    ...
    OMX_INDEXTYPE             m_CurrentVideoOmxIndex; /**<Video codec in use*/
    ...
    */
    typedef struct OMX_FileMuxAVSyncInfo
    {
        ...
        OMX_TICKS    nAudioStartTime;                  /**< Time stamp of first
                                                        * Sample
                                                        */
        OMX_TICKS    nGenericStartTime;                /**< Time stamp of first
                                                        * Sample
                                                        */
        OMX_BOOL     bAVSyncDone;                      /**< AV Sync has been
                                                        * performed
                                                        */
        OMX_BOOL     bGVSyncDone;                      /**< GV Sync has been
                                                        * performed
                                                        */
        ...
        OMX_BOOL     bAudioStarted;                    /**< Received a sample
                                                        * at audio input port
                                                        */
        OMX_BOOL     bGenericStarted;                  /**< Received a sample
                                                        * at generic input port
                                                        */
        OMX_U64      nAVTimeDiff;                      /**< Time difference
                                                        * between audio and
                                                        * video start times
                                                        */
        OMX_U64      nGVTimeDiff;                      /**< Time difference
                                                        * between generic and
                                                        * video start times
                                                        */
        ...
        OMX_U64      nCurrentVideoTime;                /**< Curent time duration
                                                        ...
                                                        * micro seconds
                                                        */
        OMX_U64      nCurrentGenericTime;              /**< Curent time duration
                                                        * of generic stream in
                                                        * micro seconds
                                                        */
        OMX_S64      nAVTimeDiffAdjust;                /**< Time in ms to be
                                                        ...
                                                        * audio or video
                                                        */
        OMX_S64      nGVTimeDiffAdjust;                /**< Time in ms to be
                                                        * adjusted at start of
                                                        * recording. Can be used
                                                        * for GVSync or for
                                                        * delay compensation in
        ...
        OMX_BOOL     bGenericStreamEnded;              /**< EOS for Generic came*/
 ...
 /*   int OMX_FileMux_FreeBuffer
    ...
    *//*======================================================================*/
    ...
    /*==========================================================================
             ...
             FUNCTION:         OMX_FileMux_QueueGenericStreamBuffer

             DESCRIPTION:
    *//**       @brief         This function queues stream buffer to inner layer
                                for decode for generic stream.
    *//**
    ...
    *//*======================================================================*/
    OMX_ERRORTYPE OMX_FileMux_QueueGenericStreamBuffer
    (
        OMX_Mux_BufferCmdType *
    );
    ...
    *//*======================================================================*/
    ...
    /*==========================================================================
             ...
             FUNCTION:         OMX_FileMux_PopulateGenericCommonParams

             DESCRIPTION:
    *//**       @brief         Populate generic codec independent parameters
    *//**
    ...
    *//*======================================================================*/
    OMX_BOOL OMX_FileMux_PopulateGenericCommonParams
    (
        void
    );
    ...
    */
    ...
    /*=========================================================================
             ...
             FUNCTION:         OMX_FileMux_CheckVideoCodecChange

             DESCRIPTION:
    *//**       @brief         Check if video codec has changed. If so, then
                               update new video codec and reset old codec info.
    *//**
    ...
    *//*=======================================================================
     */
    void OMX_FileMux_CheckVideoCodecChange(OMX_INDEXTYPE eIndex);
};
