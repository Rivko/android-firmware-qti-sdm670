...
/*!
   ...
   @param[in] pParams - stream properties

   @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_update_stream_params(
         MUX_create_params_type * /*pParams*/){return MUX_SUCCESS;};
...
/*!
   @brief  This is used to update HEVC Timing and HRD params.

   @detail   Params used to populate the Timing and
             HRD descriptor in HEVC is set using this function.

   @param[in] pHRDParams - pointer to MUX_HEVC_TimingHRD_params_type structure.

   @return    MUX_STATUS.
*/
virtual MUX_STATUS MUX_update_HEVC_Timing_HRD_Params
                   (MUX_HEVC_TimingHRD_params_type * /*pHRDParams*/){return MUX_FAIL;};
