...
typedef enum MMEventType {
  ...
  MM_EVENT_STREAMING_REQ,
  MM_EVENT_AUDIO_ENABLED,
  MM_EVENT_AUDIO_DISABLED,
  MM_EVENT_VIDEO_ENABLED,
  MM_EVENT_VIDEO_DISABLED,
  MAX_EVENT
}MMEventType;
