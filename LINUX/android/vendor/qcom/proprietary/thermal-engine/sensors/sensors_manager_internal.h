...
#define DEFAULT_SENSOR_SCALING_FACTOR  (1)
#define TSENS_TYPE                     "tsens"
#define ALARM_TYPE                     "alarm"
#define ADC_TYPE                       "adc"
#define LLM_TYPE                       "llm"
#define USERSPACE_TYPE                 "user_space"
...
struct sensor_info {
	...
	/* get_trip_temperature function to get sensor temperature
	 * caused trip notification */
	int (*get_trip_temperature)(struct sensor_info *sensor);
...
struct sensors_mgr_sensor_info {
	...
	int (*get_trip_temperature)(struct sensors_mgr_sensor_info *sensor);
