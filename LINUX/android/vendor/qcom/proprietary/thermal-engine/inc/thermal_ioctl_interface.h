...
int thermal_ioctl_get_cluster_freq_plan(int cluster_num, uint32_t *arr,
	uint32_t *len);
int thermal_ioctl_get_cluster_voltage_plan(int cluster_num, uint32_t *arr,
	uint32_t *len);
...
static inline int thermal_ioctl_get_cluster_voltage_plan(int cluster_num, uint32_t *arr,
	uint32_t *len)
{
	return -ENOSYS;
}
