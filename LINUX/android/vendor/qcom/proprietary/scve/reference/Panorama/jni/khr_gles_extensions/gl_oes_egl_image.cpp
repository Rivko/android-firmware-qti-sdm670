...
/*
 * Class:     com_qualcomm_qti_khronos_GLOESEGLImage
 * Method:    _nativeClassInit
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_qualcomm_qti_khronos_GLOESEGLImage__1nativeClassInit(
        JNIEnv *_env, jclass clazz)
{
    jclass image_class = _env->FindClass("com/qualcomm/qti/khronos/EGLImageKHR");
 ...
 * Signature: (ILcom/qualcomm/qti/khronos/EGLImageKHR;)V
 */
JNIEXPORT void JNICALL Java_com_qualcomm_qti_khronos_GLOESEGLImage_EGLImageTargetTexture2DOES(
 ...
 * Signature: (ILcom/qualcomm/qti/khronos/EGLImageKHR;)V
 */
JNIEXPORT void JNICALL Java_com_qualcomm_qti_khronos_GLOESEGLImage_EGLImageTargetRenderbufferStorageOES(
        JNIEnv *_env, jclass clazz, jint target, jobject image)
{
    GLeglImageOES _image = getImage(_env, image);
