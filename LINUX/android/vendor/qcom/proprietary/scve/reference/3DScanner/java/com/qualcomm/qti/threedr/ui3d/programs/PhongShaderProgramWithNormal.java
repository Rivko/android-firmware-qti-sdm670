...
public class PhongShaderProgramWithNormal extends ShaderProgram {
    ...
    public PhongShaderProgramWithNormal(Context context) {

        super(context, R.raw.phong_vertex_shader_with_normal,
