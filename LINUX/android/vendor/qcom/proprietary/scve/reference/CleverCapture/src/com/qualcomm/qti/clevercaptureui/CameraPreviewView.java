...
import com.qualcomm.qti.qces.khronos.CameraFrameRenderer;
import com.qualcomm.qti.qces.khronos.CameraFrameRenderer.TextureType;
import com.qualcomm.qti.qces.khronos.ColourFormat;
import com.qualcomm.qti.qces.khronos.EGLKHRFenceSync;
import com.qualcomm.qti.qces.khronos.EGLSyncKHR;
import com.qualcomm.qti.qces.khronos.GLES30Ext;
import com.qualcomm.qti.qces.khronos.GLES30Helper;
import com.qualcomm.qti.qces.khronos.GLES30Helper.FboDescriptor;
import com.qualcomm.qti.qces.khronos.ImageBufferUtils;
import com.qualcomm.qti.qces.khronos.GLES30Helper.SavedFboToken;
import com.qualcomm.qti.qces.khronos.GLOESEGLImage;
...
public class CameraPreviewView extends GLSurfaceView implements GLSurfaceView.Renderer,
    ...
    public void onDrawFrame(javax.microedition.khronos.opengles.GL10 gl) {
        ...
        synchronized (lock) {
            ...
            if (reconfigured && (previewWidth != 0) && (previewHeight != 0) && (displayWidth != 0) && (displayHeight != 0)) {
                reconfigured = false;
    ...
    private void renderCpuComplete(final OutputFrame outputFrame) {
        ...
        synchronized (lock) {
            if (frameListener != null && frameListener.onFrameAvailable(outputFrame)) {
    ...
    public void onFrameAvailable(SurfaceTexture surfaceTexture) {
        //Log.d(TAG, "keypoint camera preview frame is available");
        if(mFps != null) {
            mFps.updatefps();
        }
