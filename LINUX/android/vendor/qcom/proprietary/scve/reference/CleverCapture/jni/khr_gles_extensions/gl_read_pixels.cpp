...
/*
 * Class:     com_qualcomm_qti_qces_khronos_GLES30Ext
 * Method:    nClassInit
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_qualcomm_qti_qces_khronos_GLES30Ext_nClassInit(JNIEnv *env, jclass cls)
{
}
 ...
 * Signature: (IIIIIII)V
 */
JNIEXPORT void JNICALL Java_com_qualcomm_qti_qces_khronos_GLES30Ext_nGlReadPixels(JNIEnv *env, jclass cls,
