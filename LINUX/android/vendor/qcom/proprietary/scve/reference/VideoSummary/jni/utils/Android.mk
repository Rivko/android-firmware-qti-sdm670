...
LOCAL_MODULE    := libUtilsColorConv
LOCAL_SRC_FILES := UtilsColorConv.cpp
LOCAL_C_INCLUDES +=vendor/qcom/proprietary/fastcv-noship/inc
LOCAL_SHARED_LIBRARIES := liblog libGLESv2 libfastcvopt $(OPENGLES_LIB) libjnigraphics
