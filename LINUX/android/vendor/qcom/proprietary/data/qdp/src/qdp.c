...
#define QDP_ALLOW_UPDATE_MODEM_PROFILE_PROP "persist.data.profile_update"
...
(
  ...
  boolean                                *const un_pwd_auth_update_needed,
...
)
{
  ...
  boolean qdp_created_profile = FALSE;
  boolean un_passwd_auth_update_flag = FALSE;
  ...
  do
  {
    ...
    if (!p_params->username_valid)
    {
      ...
      if (ril_user_len > 0)
      {
        QDP_LOG_DEBUG("%s", "Modem user name:NULL but ril has username,LTE Reattach needed");
        un_passwd_auth_update_flag = TRUE;
        break;
      }
    ...
    if (!p_params->password_valid)
    {
      ...
      if (ril_pass_len > 0)
      {
        QDP_LOG_DEBUG("%s", "Modem pwd name:NULL but ril has password, LTE Reattach needed");
        un_passwd_auth_update_flag = TRUE;
        break;
      }
    ...
    {
      /* Modem protocol parameter not available */
      QDP_LOG_ERROR("%s", "Auth-Protocol info not available, LTE Reattach needed");
      un_passwd_auth_update_flag = TRUE;
      break;
    }
    else if (ril_auth)
  ...
  if ( un_pwd_auth_update_needed )
  {
    *un_pwd_auth_update_needed = un_passwd_auth_update_flag;
  }
...
)
{
  ...
  do
  {
             ...
             !p_params->user_id_valid)
    {
      ...
      if (ril_user_len > 0)
      {
        QDP_LOG_DEBUG("%s", "Modem user name:NULL but ril has username so do LTE attach");
        break;
      }
    }
    else if (ril_user_len > 0)
...
{
  return qdp_match_lte_attach_profile_params_v2(profile_id,param_strings,NULL);
}


/*===========================================================================
  FUNCTION:  qdp_match_lte_attach_profile_params_v2
===========================================================================*/
/*!
    @brief
...
*/
/*=========================================================================*/
int qdp_match_lte_attach_profile_params_v2
(
  unsigned int  profile_id,
  const char    **param_strings,
  boolean       *const un_pwd_auth_update_needed
