...
/**
 * Data type for the output from OmaDrmConv_ConvertData.
 */
typedef struct OmaDrmConv_ConvertData_Output {
    /// The converted data.
    void *pBuffer;
    ...
    off64_t errorPos;
} OmaDrmConv_ConvertData_Output_t;

/**
 * Data type for the output from OmaDrmConv_CloseSession.
 */
typedef struct OmaDrmConv_CloseSession_Output {
    ...
    /// The file position where the error occurred, in the case of a syntax error.
    off64_t errorPos;
} OmaDrmConv_CloseSession_Output_t;

/**
 * Data type for the output from the conversion process.
 */
typedef union OmaDrmConv_Output {
    OmaDrmConv_ConvertData_Output_t fromConvertData;
    OmaDrmConv_CloseSession_Output_t fromCloseSession;
} OmaDrmConv_Output_t;
 ...
 * @retval -1 Failure.
 */
typedef ssize_t OmaDrmConv_ReadFunc_t(int fileDesc, void *pBuffer,
        size_t numBytes);
 ...
 * @retval -1 Failure.
 */
typedef ssize_t OmaDrmConv_WriteFunc_t(int fileDesc, const void *pBuffer,
        size_t numBytes);
 ...
 * @retval OmaDrmConv_Status_OK
 * @retval OmaDrmConv_Status_InvalidArgument
 * @retval OmaDrmConv_Status_TooManySessions
 */
 ...
 * @retval OmaDrmConv_Status_OK
 * @retval OmaDrmConv_Status_InvalidArgument
 * @retval OmaDrmConv_Status_OutOfMemory
 * @retval OmaDrmConv_Status_SyntaxError
 * @retval OmaDrmConv_Status_UnsupportedFileFormat
 * @retval OmaDrmConv_Status_UnsupportedContentTransferEncoding
 * @retval OmaDrmConv_Status_RandomNumberGenerationFailed
 * @retval OmaDrmConv_Status_KeyEncryptionFailed
 * @retval OmaDrmConv_Status_DataEncryptionFailed
 */
 ...
 * @retval OmaDrmConv_Status_InvalidArgument
 * @retval OmaDrmConv_Status_OutOfMemory
 * @retval OmaDrmConv_Status_IntegrityProtectionFailed
 */
 ...
 * @retval OmaDrmConv_Status_InvalidArgument
 * @retval OmaDrmConv_Status_OutOfMemory
 * @retval OmaDrmConv_Status_FileReadError
 * @retval OmaDrmConv_Status_FileWriteError
 * @retval OmaDrmConv_Status_FileSeekError
 * @retval OmaDrmConv_Status_SyntaxError
 * @retval OmaDrmConv_Status_UnsupportedFileFormat
 * @retval OmaDrmConv_Status_UnsupportedContentTransferEncoding
 * @retval OmaDrmConv_Status_RandomNumberGenerationFailed
