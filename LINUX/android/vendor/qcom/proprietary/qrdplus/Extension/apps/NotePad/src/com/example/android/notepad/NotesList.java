...
public class NotesList extends Activity implements ConstInterfaceNotesList {
    ...
    private ImageView mEmptySloganImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // created.
        UpdateAdapterData();
        mEmptySloganImageView =(ImageView) findViewById(R.id.emptySloganImageView);
            ...
            Spinner.OnItemSelectedListener, SpinnerAdapter
    {
        ...
        public View getDropDownView(int position, View convertView, ViewGroup parent) {
            if (mDropView == null) {
                ...
                LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                        LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
                int left = getResources().getDimensionPixelSize(R.dimen.dropdown_view_margin_left);
                int top = getResources().getDimensionPixelSize(R.dimen.dropdown_view_margin_top);
                int right = getResources().getDimensionPixelSize(R.dimen.dropdown_view_margin_right);
                int bottom = getResources().getDimensionPixelSize(R.dimen.dropdown_view_margin_bottom);
        ...
        private void prepareObj() {
            if (mMultiSelectActionBarView == null) {
                ...
                mSpin.setSelection(DEFAULT_SELECTION_ITEM);
                mSpin.setDropDownVerticalOffset(mActionBar.getHeight()/2);
            }
        }
    ...
    public void deleteAll() {
        ...
        int listCnt = mListView.getCount();
        if (listCnt > 1) {
            msg = String.format(getString(R.string.confirm_delete_notes), listCnt);
        } else if (listCnt == 1) {
    ...
    private void updateEmptySloganImageView() {
        if (mEmptySloganImageView == null) {
            return;
        }
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) mEmptySloganImageView
                .getLayoutParams();
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            layoutParams.topMargin = getHorizontalMarginTop();
        } else {
            layoutParams.topMargin = getVerticalMarginTop();
        }
        mEmptySloganImageView.setLayoutParams(layoutParams);
    }

    private int getVerticalMarginTop(){
        return getResources().getDimensionPixelSize(R.dimen.empty_image_vertical_margin_top);
    }

    private int getHorizontalMarginTop(){
        return getResources().getDimensionPixelSize(R.dimen.empty_image_horizontal_margin_top);
    }
