...
public class LocalePicker extends LinearLayout {
    ...
    /**
     * The {@link android.graphics.drawable.Drawable} for pressed virtual
    ...
    public LocalePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionDivider = getResources().getDrawable(
                com.qualcomm.qti.setupwizard.R.drawable.ic_divider_line);

        mSelectionDividerHeight = getResources().getDimensionPixelSize(
                com.qualcomm.qti.setupwizard.R.dimen.size_1dp);
        ...
        mInputText.setTextColor(Color.WHITE); //set language text color white
        mInputText.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14); //set language text size 14sp
