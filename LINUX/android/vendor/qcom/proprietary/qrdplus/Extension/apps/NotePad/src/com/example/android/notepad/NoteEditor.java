...
public class NoteEditor extends Activity implements ConstInterfaceNotesList {
    ...
    //added for max charactors limit toast
    private Toast mMaxLimitToast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //create max limit toast
        mMaxLimitToast = Toast.makeText(this, R.string.content_full, Toast.LENGTH_SHORT);
    }
        ...
        if (mOperMode == MODE_DELETE) {
            ...
            if (text != null && text.length() > 0) {
                new AlertDialog.Builder(mContext)
                        ...
                        .setMessage(getString(R.string.confirm_delete_notes_single))
