...
public class UtilsSharedPreferences {
    ...
    public static void saveStringValue(Context mContext, String preferenceName, String key, String value) {

        SharedPreferences mSharedPreferences = mContext.getSharedPreferences(preferenceName, mContext.MODE_PRIVATE);
        SharedPreferences.Editor editor = mSharedPreferences.edit();
        editor.putString(key, value);
        editor.commit();
    }

    public static String getStringValueSaved(Context mContext, String preferenceName, String key, String def) {
