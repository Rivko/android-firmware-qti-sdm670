...
public class Utility {
    ...
    public static final String COMMAND_GOTO_LAST_MONTH = "com.qualcomm.qti.calendarwidget" +
            ".goto_last_month";
    public static final String COMMAND_GOTO_NEXT_MONTH = "com.qualcomm.qti.calendarwidget" +
            ".goto_next_month";
    public static final String UPDATE_PERMISSION = "com.qualcomm.qti.calendarwidget" +
            ".update_permission";
    ...
    public static int getStartDayOfWeek(Context mContext){
        SharedPreferences sp = mContext.getSharedPreferences(CalendarWidget
                .START_DAY, Context.MODE_PRIVATE);
        int startDay = sp.getInt(CalendarWidget.START_DAY,FIRST_DAY_OF_WEEK);
        return startDay;
    }
