...
static jint wifi_ftm_set_bandwidth(JNIEnv* env, jobject, jint cb) {
    return doCommand("SET CB %d", cb);
}
...
static jint wifi_ftm_set_packetlen(JNIEnv* env, jobject, jint len) {
    return doCommand("SET PACKET_LEN %d", len);
}

static jint wifi_ftm_set_packetcnt(JNIEnv* env, jobject, jint cnt) {
    return doCommand("SET PACKET_CNT %d", cnt);
}

static jint wifi_ftm_set_packetinterval(JNIEnv* env, jobject, jint cnt) {
    return doCommand("SET PACKET_INTERVAL %d", cnt);
}
...
static jstring wifi_ftm_get_band(JNIEnv* env, jobject) {
    char reply[64];
    size_t reply_len = 63;
    wifi_ftm_send_cmd("REPORT BAND", reply, &reply_len);
    reply[reply_len] = '\0';
...
static JNINativeMethod wifiFtmMethods[] = {
        ...
        { "SetTxBandwidth", "(I)I", (void *) wifi_ftm_set_bandwidth },
        { "SetPowerMode", "(I)I", (void *) wifi_ftm_set_power_mode },
        { "SetPacketLength", "(I)I", (void *) wifi_ftm_set_packetlen },
        { "SetPackeCnt", "(I)I", (void *) wifi_ftm_set_packetcnt },
        { "SetPackeInterval", "(I)I", (void *) wifi_ftm_set_packetinterval },
        { "StartTx", "()I", (void *) wifi_ftm_tx_start },
        { "StopTx", "()I", (void *) wifi_ftm_tx_stop },
        { "Getband", "()Ljava/lang/String;", (void *) wifi_ftm_get_band },
