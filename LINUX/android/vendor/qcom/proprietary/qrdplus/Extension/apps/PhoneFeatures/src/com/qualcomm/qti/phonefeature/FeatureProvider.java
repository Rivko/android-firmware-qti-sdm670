...
public class FeatureProvider extends ContentProvider {
    ...
    private Intent getNewIntent(String action, Bundle extras)  {
        Intent intent = new Intent(getContext(), FeatureService.class);
    ...
    public Bundle call(String method, String arg, Bundle extras) {
        ...
        if (METHOD_IS_PRIMARY_ENABLED.equals(method)) {
            ...
            getContext().startService(getNewIntent(FeatureService.ACTION_SET_PREF_NETWORK, extras));
        } else if (METHOD_GET_SMSC.equals(method) && extras != null) {
            getContext().startService(getNewIntent(FeatureService.ACTION_GET_SMSC, extras));
        } else if (METHOD_SET_SMSC.equals(method) && extras != null) {
            getContext().startService(getNewIntent(FeatureService.ACTION_SET_SMSC, extras));
            ...
            long currentId = extras.getLong(EXTRA_CURRENT_APN, -1);
