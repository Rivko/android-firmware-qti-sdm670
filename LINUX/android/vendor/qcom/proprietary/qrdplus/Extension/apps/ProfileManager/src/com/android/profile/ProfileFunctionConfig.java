...
public class ProfileFunctionConfig {
    ...
    private static boolean silentCtrlEnabled = false;
    private static boolean vibrateCtrlEnabled = false;
    private static boolean ringVolumeCtrlEnabled = false;
    private static boolean dataCtrlEnabled = false;
    private static boolean wifiCtrlEnabled = false;
    private static boolean bluetoothCtrlEnabled = false;
    private static boolean gpsLocationCtrlEnabled = false;
    private static boolean networkLocationCtrlEnabled = false;
    private static boolean brightnessCtrlEnabled = false;
