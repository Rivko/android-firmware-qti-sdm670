...
public class LockView extends View {
    ...
    public LockView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.android.internal.R.styleable.LockPatternView);

        final String aspect = a.getString(com.android.internal.R.styleable.LockPatternView_aspect);
        ...
        mRegularColor = context.getColor(R.color.circle);
        mErrorColor =context.getColor(com.android.internal.R.color.lock_pattern_view_error_color);
        mSuccessColor = context.getColor(R.color.success_color);

        int pathColor = a.getColor(
                com.android.internal.R.styleable.LockPatternView_pathColor, mRegularColor);
        ...
        mPathWidth = getResources().getDimensionPixelSize(
                com.android.internal.R.dimen.lock_pattern_dot_line_width);
        mPathPaint.setStrokeWidth(mPathWidth);

        mDotSize = getResources().getDimensionPixelSize(
                com.android.internal.R.dimen.lock_pattern_dot_size) ;
        mDotSizeActivated = getResources().getDimensionPixelSize(
                com.android.internal.R.dimen.lock_pattern_dot_size_activated);
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                ...
                mCellStates[i][j].radius =mRadius;
    ...
    private void handleActionMove(MotionEvent event) {
        ...
        for (int i = 0; i < historySize + 1; i++) {
            ...
            if (mPatternInProgress && patternSize > 0) {
                ...
                if (hitCell != null) {
                    final float width = mDotSizeActivated;
                    final float height = mDotSizeActivated;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        return new SavedState(superState,
                ChooseLockPatternFragment.patternToString(mPattern),
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link LockView#onSaveInstanceState()}
         */
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        private CharSequence getTextForVirtualView(int virtualViewId) {
            ...
            return shouldSpeakPassword() ? res.getString(
                    ...
                    virtualViewId) : res.getString(
                    com.android.internal.R.string.lockscreen_access_pattern_cell_added);
        }
