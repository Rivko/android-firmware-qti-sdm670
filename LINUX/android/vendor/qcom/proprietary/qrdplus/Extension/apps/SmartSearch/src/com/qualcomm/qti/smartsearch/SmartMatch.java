...
public class SmartMatch {
    ...
    private int getDigitType() {
        ...
        else if (locale.equals("zh_CN") || locale.equals("zh_Hans_CN"))
            return Constants.DIGITS_TYPE_PINYIN;
        ...
        else if (locale.equals("lo_LA"))
            return Constants.DIGITS_TYPE_LAO;
        else
            return Constants.DIGITS_TYPE_UNKNOW;
    }
    ...
    private String getSystemLocale() {
        ...
        String systemLocal = builder.toString();
        // Get current locale
        ...
        if (builder.toString().equals("")) {
            builder.append(SystemProperties.get("persist.sys.locale", "" ));
        }

        // Get orignal locale
        if (builder.toString().equals("")) {
            builder.append(SystemProperties.get("ro.product.locale", "" ));
        }

        // Change "-" to "_"(like en-US to en_US)
        if (!builder.toString().equals("")){
            systemLocal = builder.toString().replaceAll("-", "_");
        }
        return systemLocal;
    }
    ...
    private DigitMapTableLatin getDigitMapTable(int type) {
        switch (type) {
            ...
            case Constants.DIGITS_TYPE_VIETNAMESE:
                return DigitMapTableLatin.getInstance();
            case Constants.DIGITS_TYPE_LAO:
                return DigitMapTableLao.getInstance();
            default:
                return DigitMapTableLatin.getInstance();
        }
    }
