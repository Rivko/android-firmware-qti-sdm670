...
import com.qti.fcctest.TestContentFragment.OnEditTextChangedListener;
...
public class FccTestActivity extends Activity implements View.OnClickListener,
        OnSelectionChangedListener, OnEditTextChangedListener, DialogInterface.OnClickListener {
    private static final String TAG = "FccTestActivity";

    private static final int TIME_FOR_ENABLE_TEST_MODE = 5 * 1000;
    ...
    public void onSelectionChanged(SelectionsContent allSelection, int changedItemId) {
        ...
        switch (changedItemId) {
            ...
            case Utils.ID_TEST_ITEM_RATE:
                ...
                break;
            case Utils.ID_TEST_ITEM_BANDWIDTH:
                if (mCurTest == Utils.ID_TX_TEST) {
                    Log.d(TAG, "SetTxBandwidth: " + changed._value);
                    SetTxBandwidth(Integer.valueOf(changed._value));
                }
                break;
    ...
    public void onEditTextChanged(int editId, int editValue) {
        ...
        switch (editId) {
        case Utils.ID_TEST_ITEM_PACKETLENGTH:
            Log.d(TAG, "ID_TEST_ITEM_PACKETLENGTH: " + editValue);
            SetPacketLength(editValue);
            break;
        case Utils.ID_TEST_ITEM_PACKETCNT:
            Log.d(TAG, "ID_TEST_ITEM_PACKETCNT: " + editValue);
            SetPackeCnt(editValue);
            break;
        case Utils.ID_TEST_ITEM_PACKETINTERVAL:
            Log.d(TAG, "ID_TEST_ITEM_PACKETINTERVAL: " + editValue);
            SetPackeInterval(editValue);
            break;
        }
    ...
    private static class TabManager implements TabHost.OnTabChangeListener {
        ...
        public void addTab(TabSpec tabSpec) {
            ...
            if (testFragment == null) {
                ...
                testFragment.setOnEditTextChangedListener(activity);
    ...
    public static native int SetTxBandwidth(int cb);
    ...
    public static native int SetPacketLength(int len);
    public static native int SetPackeCnt(int cnt);
    public static native int SetPackeInterval(int num);
    public static native int StartTx();
    public static native int StopTx();
    public static native String Getband();
    public static native int SetDigitalGain(int dgain);
    public static native int SetRfGain(int rfgain);
