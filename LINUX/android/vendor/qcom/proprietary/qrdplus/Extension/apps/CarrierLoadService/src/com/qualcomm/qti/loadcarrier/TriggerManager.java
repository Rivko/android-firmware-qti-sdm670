...
public class TriggerManager implements Trigger.OnCompleteMatchListener{
    ...
    public static TriggerManager getInstance(TriggerService context,
        ...
        if (sInstance == null) {
            sInstance = new TriggerManager(context, accessCacheSerivce);
        }
        return sInstance;
    }

    public TriggerManager(TriggerService context, ICarrierAccessCacheService accessCacheSerivce) {
        mListener = (OnTriggerCompleteListener) context;
        registTrigger(new SIMTrigger(context, this, accessCacheSerivce));
        //registTrigger(new ModelTrigger(context, this, accessCacheSerivce));
    }
