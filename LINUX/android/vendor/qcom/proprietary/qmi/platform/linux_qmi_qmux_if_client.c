...
)
{
...
#ifdef FEATURE_QMUXD_DISABLED
  QMI_ERR_MSG_1 ("qmi_client [%d] QMUXD disabled", linux_qmi_qmux_pid);
  ret = QMI_QMUXD_NOT_SUPPORTED_ERR;
  goto init_exit;
#endif
  ...
  if (QMI_QMUX_DONT_USE_QMUXD_CLIENT_ID == *qmux_client_id)
  {
    QMI_ERR_MSG_1 ("qmi_client [%d] Shim layer present. Do not use QMUXD",
                  linux_qmi_qmux_pid);
    ret = QMI_QMUXD_NOT_SUPPORTED_ERR;
    goto init_exit;
  }
