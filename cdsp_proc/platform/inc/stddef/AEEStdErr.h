...
// Heap error codes
#define E_APPS_BUSY_RETRY_LATER 	-1
#define E_HLOS_CAP_REACHED 			-2
#define E_DPOOL_CAP_REACHED 		-3
#define E_NO_MORE_FREE_SECTIONS 	-4
...
#define AEE_EMAX_MMPM_CLIENTS	     (AEE_EOFFSET + 0x176)   /// MMPM Reached maximum clients per PD
#define AEE_EDCVSREGISTER	     (AEE_EOFFSET + 0x177)   /// MMPM Reached maximum clients per PD
