...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6/rfsa/src/remote_filesystem_access_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 5.6 
   It was generated on: Mon Oct 29 2012
...
static const qmi_idl_service_message_table_entry rfsa_service_command_messages_v01[] = {
  {QMI_RFSA_FILE_STAT_REQ_MSG_V01, TYPE16(0, 0), 258},
  {QMI_RFSA_FILE_CREATE_REQ_MSG_V01, TYPE16(0, 2), 269},
  {QMI_RFSA_FILE_READ_REQ_MSG_V01, TYPE16(0, 8), 279},
  {QMI_RFSA_GET_BUFF_ADDR_REQ_MSG_V01, TYPE16(0, 4), 14},
  {QMI_RFSA_RELEASE_BUFF_ADDR_REQ_MSG_V01, TYPE16(0, 6), 18},
  {QMI_RFSA_IOVEC_FILE_READ_REQ_MSG_V01, TYPE16(0, 10), 869},
  {QMI_RFSA_IOVEC_FILE_WRITE_REQ_MSG_V01, TYPE16(0, 12), 869}
};

static const qmi_idl_service_message_table_entry rfsa_service_response_messages_v01[] = {
  {QMI_RFSA_FILE_STAT_RESP_MSG_V01, TYPE16(0, 1), 25},
  {QMI_RFSA_FILE_CREATE_RESP_MSG_V01, TYPE16(0, 3), 7},
  {QMI_RFSA_FILE_READ_RESP_MSG_V01, TYPE16(0, 9), 22},
  {QMI_RFSA_GET_BUFF_ADDR_RESP_MSG_V01, TYPE16(0, 5), 18},
  {QMI_RFSA_RELEASE_BUFF_ADDR_RESP_MSG_V01, TYPE16(0, 7), 7},
  {QMI_RFSA_IOVEC_FILE_READ_RESP_MSG_V01, TYPE16(0, 11), 7},
  {QMI_RFSA_IOVEC_FILE_WRITE_RESP_MSG_V01, TYPE16(0, 13), 7}
};
