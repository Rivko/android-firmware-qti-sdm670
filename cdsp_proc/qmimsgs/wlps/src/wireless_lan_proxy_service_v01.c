...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6/wlps/src/wireless_lan_proxy_service_v01.c#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Wed Mar  1 2017 (Spin 1)
...
static const uint8_t wlps_rtt_oem_channel_info_s_data_v01[] = {
  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlps_rtt_oem_channel_info_s_v01, chan_number),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlps_rtt_oem_channel_info_s_v01, mhz),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlps_rtt_oem_channel_info_s_v01, band_center_freq1),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlps_rtt_oem_channel_info_s_v01, band_center_freq2),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlps_rtt_oem_channel_info_s_v01, info),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlps_rtt_oem_channel_info_s_v01, reg_info_1),

  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(wlps_rtt_oem_channel_info_s_v01, reg_info_2),
...
static const uint8_t wlps_update_client_status_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wlps_update_client_status_req_msg_v01, channel_info) - QMI_IDL_OFFSET8(wlps_update_client_status_req_msg_v01, channel_info_valid)),
  0x12,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wlps_update_client_status_req_msg_v01, rtt_oem_channel_info) - QMI_IDL_OFFSET16RELATIVE(wlps_update_client_status_req_msg_v01, rtt_oem_channel_info_valid)),
  0x13,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET16ARRAY(wlps_update_client_status_req_msg_v01, rtt_oem_channel_info),
  QMI_WLPS_MAX_NUM_RTT_CHAN_V01,
  QMI_IDL_OFFSET16RELATIVE(wlps_update_client_status_req_msg_v01, rtt_oem_channel_info) - QMI_IDL_OFFSET16RELATIVE(wlps_update_client_status_req_msg_v01, rtt_oem_channel_info_len),
  QMI_IDL_TYPE88(0, 2)
};
...
static const qmi_idl_type_table_entry  wlps_type_table_v01[] = {
  ...
  {sizeof(wlps_rtt_oem_channel_info_s_v01), wlps_rtt_oem_channel_info_s_data_v01}
};
...
static const qmi_idl_service_message_table_entry wlps_service_command_messages_v01[] = {
  ...
  {QMI_WLPS_UPDATE_CLIENT_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 2), 5691}
};
