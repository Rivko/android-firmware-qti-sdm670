...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6/sns_common/src/sns_sam_common_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.13 
   It was generated on: Fri Sep 26 2014 (Spin 0)
...
static const uint8_t sns_sam_get_algo_attrib_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_sam_get_algo_attrib_resp_msg_v01, sensorUID) - QMI_IDL_OFFSET8(sns_sam_get_algo_attrib_resp_msg_v01, sensorUID_valid)),
  0x10,
