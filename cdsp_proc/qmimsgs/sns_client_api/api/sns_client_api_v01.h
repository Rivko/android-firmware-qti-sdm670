...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6/sns_client_api/api/sns_client_api_v01.h#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SNS_CLIENT_SVC_V01_IDL_MINOR_VERS 0x03
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SNS_CLIENT_SVC_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SNS_CLIENT_SVC_V01_MAX_MESSAGE_ID 0x0023
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Default: False.  If false, clients will receive all single and batched
  events only within sns_client_report_ind_msg.  Individual events larger than
  SNS_CLIENT_REPORT_LEN_MAX will be dropped and not sent; batches of events
  will be split to fit.  If true, enables service to use indication message
  sns_client_jumbo_report_ind_msg; events may be sent within either indication
  message.  The payload size is only guaranteed to be less than
  SNS_CLIENT_JUMBO_REPORT_LEN_MAX. */
...
}sns_client_info_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_SNS_CLIENT_INFO_V01
...
#define SNS_CLIENT_INFO_REQ_V01 0x0023
#define SNS_CLIENT_INFO_RESP_V01 0x0023
/**
    @}
  */
