/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
                        ...
                        S E R V I C E _ R E G I S T R Y _ L O C A T O R _ V 0 1  . C

GENERAL DESCRIPTION
  This is the file which defines the servreg_loc service Data structures.
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6/servreg_loc/src/service_registry_locator_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Tue Dec 20 2016 (Spin 0)
