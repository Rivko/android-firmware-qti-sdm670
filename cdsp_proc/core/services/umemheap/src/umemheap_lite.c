...
$Header: //components/rel/core.qdsp6/2.1.c4/services/umemheap/src/umemheap_lite.c#1 $ $DateTime: 2018/07/30 01:21:36 $ $Author: pwbldsvc $
...
mem_heap_enter_crit_sect( void * ptr)
{
  ...
  qurt_rmutex_lock((qurt_mutex_t*) &(((mem_heap_type *)ptr)->memheap_crit_sect));
...
mem_heap_leave_crit_sect( void * ptr)
{
  ...
  qurt_rmutex_unlock((qurt_mutex_t*) &(((mem_heap_type *)ptr)->memheap_crit_sect));
...
)
{
  ...
  qurt_rmutex_init ( (qurt_mutex_t *)&(heap_ptr->memheap_crit_sect) );
