...
$Header: //components/rel/core.qdsp6/2.1.c4/services/utils/src_sec_pd/memheap.c#1 $ $DateTime: 2018/08/14 07:21:53 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------
07/09/18   rks     initial for secure PD
...
)
{
 ...
 if(heap_ptr->used_bytes == 0)
 {
   ...
   memset(&(heap_ptr->memheap_crit_sect),0,sizeof(qurt_mutex_t));
   memset(heap_ptr, 0, sizeof(mem_heap_type));
 }
 else
 {
