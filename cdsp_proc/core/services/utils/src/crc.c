...
Copyright (c) 2005-2017 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.qdsp6/2.1.c4/services/utils/src/crc.c#1 $ $DateTime: 2018/07/30 01:21:36 $ $Author: pwbldsvc $
