...
/*===========================================================================
 ...
 $Header: //components/rel/core.qdsp6/2.1.c4/services/diag/platform/cfg/slpi_core/diag_param.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
01/19/17   sa      Added #ifdef to allow buffer sizes to be configurable.
08/17/17   sp      New file created to support common PW for ADSP/CDSP/SLPI
===========================================================================*/
...
#define DIAG_DCM_CMD_REG_TEST_OFFSET DIAG_DCM_CMD_REG_TEST_SLPI_OFFSET

/* Set the processor ID for the Ulog Diag subsystem */
#define ULOGDIAG_PROCESSOR_ID ULOGDIAG_PROCESSOR_SLPI
