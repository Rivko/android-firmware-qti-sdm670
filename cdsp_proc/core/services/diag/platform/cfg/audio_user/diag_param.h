...
/*===========================================================================
 ...
 $Header: //components/rel/core.qdsp6/2.1.c4/services/diag/platform/cfg/audio_user/diag_param.h#1 $
...
#define DIAG_LSM_CMD_REG_TEST_OFFSET DIAG_LSM_CMD_REG_TEST_AUDIO_OFFSET

/* Set the processor ID for the Ulog Diag subsystem */
#define ULOGDIAG_PROCESSOR_ID ULOGDIAG_PROCESSOR_AUDIOPD
...
#define DIAG_DIAGID_USER            DIAG_DIAGID_AUDIO_USER
