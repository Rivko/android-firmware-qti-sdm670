...
/*===========================================================================
 ...
 $Header: //components/rel/core.qdsp6/2.1.c4/services/diag/platform/cfg/cdsp_core/diag_param.h#1 $
...
#define DIAG_DCM_CMD_REG_TEST_OFFSET DIAG_DCM_CMD_REG_TEST_CDSP_OFFSET

/* Set the processor ID for the Ulog Diag subsystem */
#define ULOGDIAG_PROCESSOR_ID ULOGDIAG_PROCESSOR_CDSP
