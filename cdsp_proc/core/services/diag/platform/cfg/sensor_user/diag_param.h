...
/*===========================================================================
 ...
 $Header: //components/rel/core.qdsp6/2.1.c4/services/diag/platform/cfg/sensor_user/diag_param.h#1 $
...
#define DIAG_LSM_CMD_REG_TEST_OFFSET DIAG_LSM_CMD_REG_TEST_SENSOR_OFFSET

/* Set the processor ID for the Ulog Diag subsystem */
#define ULOGDIAG_PROCESSOR_ID ULOGDIAG_PROCESSOR_SENSORPD
...
#define DIAG_DIAGID_USER          DIAG_DIAGID_SENSOR_USER
