...
Copyright (c) 2010-2013, 2017 Qualcomm Technologies Incorporated.
All Rights Reserved.
Qualcomm Confidential and Proprietary

$Header: //components/rel/core.qdsp6/2.1.c4/services/diag/diagbuffer/src/ULogDiagFormat.h#1 $
============================================================================*/
...
#define ULOGDIAG_PROCESSOR_ADSP      0x0500 // rootPD for audio processor
#define ULOGDIAG_PROCESSOR_WCN       0x0600
#define ULOGDIAG_PROCESSOR_AUDIOPD   0x0700 // audio userPD
#define ULOGDIAG_PROCESSOR_SENSORPD  0x0800 // sensor userPD
#define ULOGDIAG_PROCESSOR_WLANPD    0x0900 // WLAN userPD
#define ULOGDIAG_PROCESSOR_CDSP      0x0A00 // rootPD for computeDSP
#define ULOGDIAG_PROCESSOR_SLPI      0x0B00 // rootPD for sensor processor
