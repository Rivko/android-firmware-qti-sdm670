...
Copyright (c) 2003-2013, 2015-2017 Qualcomm Technologies Incorporated.
All Rights Reserved.
...
$Header: //components/rel/core.qdsp6/2.1.c4/services/diag/diagbuffer/src/ULogDiag.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/12/17   sp      Added support for ULog diag commands for ADSP/CDSP/SLPI rootPD and userPD
05/25/17   ph      Verify input validation for ULOGDIAG_PLUGIN_EXT command.
============================================================================*/
    ...
    /*  Verify that the command code is valid */
    {
      switch (command_code)
      {
        ...
        case ULOGDIAG_PLUGIN_EXT:
          ...
          if(pkt_len <= FPOS(ulogdiag_cmd_type_plugin_ext, msg_to_plugin))
          {
