...
/**@ingroup func_qurt_mem_cache_clean
  ...
  Does a syncht on all the data cache operations if Hexagon processor version V60 or greater.
...
/**@ingroup func_qurt_mem_cache_clean2
  ...
  @note1hang This API only performs the following data cache operations: \n  #QURT_MEM_CACHE_FLUSH\n
             #QURT_MEM_CACHE_INVALIDATE\n  #QURT_MEM_CACHE_FLUSH_INVALIDATE\n
