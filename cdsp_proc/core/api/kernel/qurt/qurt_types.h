...
typedef enum {
        ...
        QURT_MEM_CACHE_DEVICE_SFC = 2, /**< Enables limitations to be placed on the number of outstanding transactions */
...
#define QURT_MMU_EXTRACT_CCCC(ent)  (((unsigned long long)ent >> 23) & 0xF)
...
static inline int qurt_mmu_entry_cmp_by_vaddr (const void *a, const void *b)      // could be passed to sorting routines as compare function
{
