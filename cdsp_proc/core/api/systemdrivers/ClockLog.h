...
$Header: //components/rel/core.qdsp6/2.1.c4/api/systemdrivers/ClockLog.h#1 $
...
{
   return ((DalClockHandle *)_h)->pVtbl->LogState(DALDEVICE_LOCAL_CLIENTID, _h, (void *)hULog, nFlags);
}
