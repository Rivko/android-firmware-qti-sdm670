...
/*=============================================================================
                             Edit History
$Header: //components/rel/core.qdsp6/2.1.c4/api/systemdrivers/DDIPlatformInfo.h#1 $
...
struct DalPlatformInfo
{
   ...
   DALResult (*GetPlatform)(uint32 ClientHandle, DalDeviceHandle * _h,  DalPlatformInfoPlatformType * pType);
   DALResult (*GetPlatformInfo)(uint32 ClientHandle, DalDeviceHandle * _h,  DalPlatformInfoPlatformInfoType * pInfo);
   DALResult (*GetKeyValue)(uint32 ClientHandle, DalDeviceHandle * _h,  DalPlatformInfoKeyType eKey, uint32 *pValue);
   DALResult (*CDTConfigPreDDR)(uint32 ClientHandle, DalDeviceHandle * _h, void *platformAddress);
   DALResult (*CDTConfigPostDDR)(uint32 ClientHandle, DalDeviceHandle * _h, void *platformAddress);
};
...
{
   return ((DalPlatformInfoHandle *)_h)->pVtbl->GetPlatform(DALDEVICE_LOCAL_CLIENTID, _h, pType);
}
...
{
   return ((DalPlatformInfoHandle *)_h)->pVtbl->GetPlatformInfo(DALDEVICE_LOCAL_CLIENTID,  _h, pInfo);
}

static __inline DALResult
DalPlatformInfo_GetKeyValue (DalDeviceHandle * _h, DalPlatformInfoKeyType eKey, uint32 *pValue)
{
   return ((DalPlatformInfoHandle *)_h)->pVtbl->GetKeyValue(DALDEVICE_LOCAL_CLIENTID,  _h, eKey, pValue);
}
...
{
   return ((DalPlatformInfoHandle *)_h)->pVtbl->CDTConfigPreDDR(DALDEVICE_LOCAL_CLIENTID,  _h, pCDTConfig);
}
...
{
   return ((DalPlatformInfoHandle *)_h)->pVtbl->CDTConfigPostDDR(DALDEVICE_LOCAL_CLIENTID,  _h, pCDTConfig);
}
