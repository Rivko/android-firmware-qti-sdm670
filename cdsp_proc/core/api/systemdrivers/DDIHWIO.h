...
/*  
  ...
  ==================================================================== 
  $Header: //components/rel/core.qdsp6/2.1.c4/api/systemdrivers/DDIHWIO.h#1 $ $DateTime: 2018/07/30 01:21:36 $ $Author: pwbldsvc $
  ====================================================================
*/ 
...
struct DalHWIO
{
   ...
   DALResult (*MapRegion)(uint32 ClientId, DalDeviceHandle * _h, const char * szBase, uint8 **ppAddress);
   DALResult (*UnMapRegion)(uint32 ClientId, DalDeviceHandle * _h, uint8 *pVirtAddress);
   DALResult (*MapRegionByAddress)(uint32 ClientId, DalDeviceHandle * _h, uint8 *pPhysAddress, uint8 **ppAddress);
   DALResult (*MapAllRegions)(uint32 ClientId, DalDeviceHandle * _h);
};
...
{
  return ((DalHWIOHandle *)_h)->pVtbl->MapRegion(DALDEVICE_LOCAL_CLIENTID, _h, szBase, ppAddress);
}
...
{
  return
    ((DalHWIOHandle *)_h)->pVtbl->MapRegionByAddress(DALDEVICE_LOCAL_CLIENTID, 
...
{
  return ((DalHWIOHandle *)_h)->pVtbl->UnMapRegion(DALDEVICE_LOCAL_CLIENTID,  _h, pVirtAddress);
}
...
{
  return ((DalHWIOHandle *)_h)->pVtbl->MapAllRegions(DALDEVICE_LOCAL_CLIENTID, _h);
}
