...
============================================================================
  $Header: //components/rel/core.qdsp6/2.1.c4/api/systemdrivers/DDIChipInfo.h#1 $
...
struct DalChipInfo
{
   ...
   DALResult (*GetChipVersion)(uint32 ClientHandle, DalDeviceHandle * _h, ChipInfoVersionType * pnVersion);
   DALResult (*GetRawChipVersion)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 * pnVersion);
   DALResult (*GetChipId)(uint32 ClientHandle, DalDeviceHandle * _h, ChipInfoIdType * peId);
   DALResult (*GetRawChipId)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 * pnId);
   DALResult (*GetChipIdString)(uint32 ClientHandle, DalDeviceHandle * _h, char * szIdString, uint32  nMaxLength);
   DALResult (*GetChipFamily)(uint32 ClientHandle, DalDeviceHandle * _h, ChipInfoFamilyType * peFamily);
   DALResult (*GetModemSupport)(uint32 ClientHandle, DalDeviceHandle * _h, ChipInfoModemType * pnModem);
   DALResult (*GetMarketingNameString)(uint32 ClientHandle, DalDeviceHandle * _h, char * pszMarketingNameStr, uint32  nMaxLength);
   DALResult (*GetSerialNumber)(uint32 ClientHandle, DalDeviceHandle * _h, ChipInfoSerialNumType * pnSerialNum);
   DALResult (*GetFoundryId)(uint32 ClientHandle, DalDeviceHandle * _h, ChipInfoFoundryIdType * peFoundryId);
   DALResult (*GetRawDeviceFamily)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 * pnId);
   DALResult (*GetRawDeviceNumber)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 * pnId);
   DALResult (*GetQFPROMChipId)(uint32 ClientHandle, DalDeviceHandle * _h, ChipInfoQFPROMChipIdType * pnChipId);
   DALResult (*GetDefectivePart)(uint32 ClientHandle, DalDeviceHandle * _h, ChipInfoPartType ePart, uint32 *pnMask);
   DALResult (*GetDefectiveCPUs)(uint32 ClientHandle, DalDeviceHandle * _h, uint32 nCPUCluster, uint32 *pnMask);
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetChipVersion(DALDEVICE_LOCAL_CLIENTID, _h, pnVersion);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetRawChipVersion(DALDEVICE_LOCAL_CLIENTID, _h, pnVersion);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetChipId(DALDEVICE_LOCAL_CLIENTID, _h, peId);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetRawChipId(DALDEVICE_LOCAL_CLIENTID, _h, pnId);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetChipIdString(DALDEVICE_LOCAL_CLIENTID, _h, szIdString, nMaxLength);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetChipFamily(DALDEVICE_LOCAL_CLIENTID, _h, peFamily);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetModemSupport(DALDEVICE_LOCAL_CLIENTID, _h, pnModem);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetMarketingNameString(DALDEVICE_LOCAL_CLIENTID, _h, pszMarketingNameStr, nMaxLength);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetSerialNumber(DALDEVICE_LOCAL_CLIENTID, _h, pnSerialNum);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetFoundryId(DALDEVICE_LOCAL_CLIENTID, _h, peId);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetRawDeviceFamily(DALDEVICE_LOCAL_CLIENTID, _h, pnId);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetRawDeviceNumber(DALDEVICE_LOCAL_CLIENTID, _h, pnId);
}
...
{
   return ((DalChipInfoHandle *)_h)->pVtbl->GetQFPROMChipId(DALDEVICE_LOCAL_CLIENTID, _h, pnQFPROMChipId);
}
...
{
  return ((DalChipInfoHandle *)_h)->pVtbl->GetDefectivePart(DALDEVICE_LOCAL_CLIENTID, _h, ePart, pnMask);
}
...
{
  return ((DalChipInfoHandle *)_h)->pVtbl->GetDefectiveCPUs(DALDEVICE_LOCAL_CLIENTID, _h, nCPUCluster, pnMask);
}
/**
  @}
*/ /* end_group Functions */
