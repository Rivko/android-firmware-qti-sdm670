...
$Header: //components/rel/core.qdsp6/2.1.c4/api/dal/DalDevice.h#1 $
=============================================================================*/
...
#define DALDEVICE_LOCAL_CLIENTID              3 //QDI_HANDLE_LOCAL_CLIENT
...
struct DalDevice
{
   ...
   uint32    (*Detach)(uint32 ClientHandle, DalDeviceHandle *);
   DALResult (*Init)(uint32 ClientHandle, DalDeviceHandle *);
   DALResult (*DeInit)(uint32 ClientHandle, DalDeviceHandle *);
   DALResult (*Open)(uint32 ClientHandle, DalDeviceHandle *, uint32);
   DALResult (*Close)(uint32 ClientHandle, DalDeviceHandle *);
   DALResult (*Info)(uint32 ClientHandle, DalDeviceHandle *, DalDeviceInfo *, uint32);
   DALResult (*PowerEvent)(uint32 ClientHandle, DalDeviceHandle *, DalPowerCmd, DalPowerDomain);
   DALResult (*SysRequest)(uint32 ClientHandle, DalDeviceHandle *, DalSysReq, const void *, uint32,
                           void *,uint32, uint32*);
};
...
DalDevice_Detach(DalDeviceHandle *_h)
{
   ...
   return _h->pVtbl->DalDevice.Detach(DALDEVICE_LOCAL_CLIENTID, _h);
}
...
{
   DALPREPREMOTEHANDLE(_h);
   return _h->pVtbl->DalDevice.Init(DALDEVICE_LOCAL_CLIENTID, _h);
}
...
{
   DALPREPREMOTEHANDLE(_h);
   return _h->pVtbl->DalDevice.DeInit(DALDEVICE_LOCAL_CLIENTID, _h);
}
...
{
   DALPREPREMOTEHANDLE(_h);
   return _h->pVtbl->DalDevice.PowerEvent(DALDEVICE_LOCAL_CLIENTID, _h,PowerCmd,PowerDomain);
}
...
{
   DALPREPREMOTEHANDLE(_h);
   return _h->pVtbl->DalDevice.Open(DALDEVICE_LOCAL_CLIENTID, _h,mode);
}
...
{
   DALPREPREMOTEHANDLE(_h);
   return _h->pVtbl->DalDevice.Close(DALDEVICE_LOCAL_CLIENTID, _h);
}
...
{
   DALPREPREMOTEHANDLE(_h);
   return _h->pVtbl->DalDevice.Info(DALDEVICE_LOCAL_CLIENTID, _h,info,infoSize);
}
...
{
   DALPREPREMOTEHANDLE(_h);
   return _h->pVtbl->DalDevice.SysRequest(DALDEVICE_LOCAL_CLIENTID, _h,ReqIdx,SrcBuf,SrcBufLen,
