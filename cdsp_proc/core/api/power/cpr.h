 ...
 * $Header: //components/rel/core.qdsp6/2.1.c4/api/power/cpr.h#1 $
 * $Change: 16759227 $
 */
#ifndef CPR_H
#define CPR_H
...
/**
 * @brief API to enable closed loop.
 */
void cpr_enable_closed_loop(uint64 tick);

/**
 * @brief API to disable closed loop.
 */
void cpr_disable_closed_loop(void);
