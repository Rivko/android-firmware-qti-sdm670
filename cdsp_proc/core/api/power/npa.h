...
$Header: //components/rel/core.qdsp6/2.1.c4/api/power/npa.h#1 $
============================================================================*/
#ifndef NPA_H
#define NPA_H
...
typedef enum 
{
  ...
  /* Pre- and post- change event triggers */
  NPA_TRIGGER_PRE_CHANGE_EVENT  = 0x0100,
  NPA_TRIGGER_POST_CHANGE_EVENT = 0x0200,
  
  /* Sleep state change event trigger */
  NPA_TRIGGER_SLEEP_CHANGE_EVENT = 0x0400,

  NPA_TRIGGER_MAX_EVENT = 0x0000ffff,

  /* If npa_create_event_cb is invoked with this bit ORd with the actual
   * trigger_type, invoke the event callback once with available data even if
   * the actual event has not occurred. Not all trigger_types support this.
   */
  NPA_TRIGGER_ON_REGISTER = 0x20000000,
