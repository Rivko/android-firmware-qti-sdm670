...
===========================================================================*/
/*
Copyright (c) 1997-2017 Qualcomm Technologies Incorporated.
All rights reserved.
...
$Header: //components/rel/core.qdsp6/2.1.c4/api/services/umemheap_lite.h#1 $ $DateTime: 2018/07/30 01:21:36 $ $Author: pwbldsvc $
