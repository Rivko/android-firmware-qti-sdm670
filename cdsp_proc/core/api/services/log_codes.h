...
$Header: //components/rel/core.qdsp6/2.1.c4/api/services/log_codes.h#1 $
   
when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
07/11/17   sa      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.105
03/30/17   sa      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.101
...
/* The last defined DMSS log code */
 #define LOG_1X_LAST_C                                       ((0xC06) + LOG_1X_BASE_C)
