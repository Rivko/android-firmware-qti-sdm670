...
$Header: //components/rel/core.qdsp6/2.1.c4/api/services/ULogFront.h#1 $
============================================================================*/
#ifndef ULOGFRONT_H
#define ULOGFRONT_H
 ...
 * @param name : The log name (24 chars max, including NULL). ULog is case insensitive, duplicate ulogs with 
 ...
 * @param logName : Ascii log name (must be less than 24 chars). ULog is case insensitive, duplicate ulogs with 
 *                  same name but different upper/lowercase combinations will just be appended
