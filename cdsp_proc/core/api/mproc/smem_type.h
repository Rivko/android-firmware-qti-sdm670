...
$Header: //components/rel/core.qdsp6/2.1.c4/api/mproc/smem_type.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/09/17   vr      SMEM Version 0x000C0000 update
...
typedef enum
{
  ...
  SMEM_APPS_POWER_STATUS =
  		SMEM_RESERVED_SLEEP_POWER_COLLAPSE_DISABLED,/*APSS power status*/
...
typedef enum 
{
  ...
  SMEM_SDC          =  10,                    /**< SDC processor */
  SMEM_NUM_HOSTS,                             /**< Max number of host in target */
