...
$Header: //components/rel/core.qdsp6/2.1.c4/api/mproc/smd_type.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/21/14   bc      Add Sensor <-> RPM channel type and change DSPS to SSC
...
typedef enum
{
  ...
  /* Keep DSPS for legacy reason. New code should use _SSC */
  SMD_APPS_DSPS  = SMD_APPS_SSC,             /**< &nbsp; */
  SMD_MODEM_DSPS = SMD_MODEM_SSC,            /**< &nbsp; */
  SMD_QDSP_DSPS  = SMD_QDSP_SSC,             /**< &nbsp; */
  SMD_DSPS_RIVA  = SMD_SSC_RIVA,             /**< &nbsp; */
  SMD_DSPS_Q6FW  = SMD_SSC_Q6FW              /**< &nbsp; */
} smd_channel_type;
