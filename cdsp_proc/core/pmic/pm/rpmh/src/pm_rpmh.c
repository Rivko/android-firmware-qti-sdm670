                       ...
                       boolean             is_nas_req)
{
  ...
  if(active_set == NULL || sleep_set == NULL || rpmh_data  == NULL)
  {
    PM_LOG_MSG_ERR_FATAL("active=%d, sleep = %d, rpmh_data = %d",
                          active_set, sleep_set, rpmh_data);
  }
  ...
  {   
    ...
    active_set->commands[count].completion = TRUE;
                 ...
                 boolean             is_nas_req)
{
  ...
  if(active_set == NULL || sleep_set == NULL || 
     rpmh_data  == NULL || curr_msg_id == NULL)
  {
    PM_LOG_MSG_ERR_FATAL("active=%d, sleep=%d, rpmh_data=%d, msgid=%d",
                          active_set, sleep_set, rpmh_data, curr_msg_id);
  }
