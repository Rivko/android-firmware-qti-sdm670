...
/**
  ...
  Reference chip release:
    SDM845 (Napali) [napali_v1.0_p3q1r51.1.0_MTO_partitioned_rtl]
...
/*
  ...
  $Header: //components/rel/core.qdsp6/2.1.c4/settings/systemdrivers/icb/config/adsp/sdm845/ABTimeout_HWIO.h#1 $
...
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_ADDR                      (LPASS_AHBE_TIME_REG_BASE      + 0x00000000)
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_RMSK                      0xffffffff
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_HW_VERSION_ADDR, HWIO_LPASS_AHBE_ABT_HW_VERSION_RMSK)
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_HW_VERSION_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_MAJOR_BMSK                0xf0000000
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_MAJOR_SHFT                      0x1c
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_MINOR_BMSK                 0xfff0000
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_MINOR_SHFT                      0x10
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_STEP_BMSK                     0xffff
#define HWIO_LPASS_AHBE_ABT_HW_VERSION_STEP_SHFT                        0x0

#define HWIO_LPASS_AHBE_ABT_INST_ID_ADDR                         (LPASS_AHBE_TIME_REG_BASE      + 0x00000004)
#define HWIO_LPASS_AHBE_ABT_INST_ID_RMSK                         0xffffffff
#define HWIO_LPASS_AHBE_ABT_INST_ID_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_INST_ID_ADDR, HWIO_LPASS_AHBE_ABT_INST_ID_RMSK)
#define HWIO_LPASS_AHBE_ABT_INST_ID_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_INST_ID_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_INST_ID_OUT(v)      \
        out_dword(HWIO_LPASS_AHBE_ABT_INST_ID_ADDR,v)
#define HWIO_LPASS_AHBE_ABT_INST_ID_OUTM(m,v) \
        out_dword_masked_ns(HWIO_LPASS_AHBE_ABT_INST_ID_ADDR,m,v,HWIO_LPASS_AHBE_ABT_INST_ID_IN)
#define HWIO_LPASS_AHBE_ABT_INST_ID_INSTID_BMSK                  0xffffffff
#define HWIO_LPASS_AHBE_ABT_INST_ID_INSTID_SHFT                         0x0

#define HWIO_LPASS_AHBE_ABT_NUM_SLAVES_ADDR                      (LPASS_AHBE_TIME_REG_BASE      + 0x00000008)
#define HWIO_LPASS_AHBE_ABT_NUM_SLAVES_RMSK                            0x3f
#define HWIO_LPASS_AHBE_ABT_NUM_SLAVES_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_NUM_SLAVES_ADDR, HWIO_LPASS_AHBE_ABT_NUM_SLAVES_RMSK)
#define HWIO_LPASS_AHBE_ABT_NUM_SLAVES_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_NUM_SLAVES_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_NUM_SLAVES_NUMSLAVES_BMSK                  0x3f
#define HWIO_LPASS_AHBE_ABT_NUM_SLAVES_NUMSLAVES_SHFT                   0x0

#define HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_ADDR                   (LPASS_AHBE_TIME_REG_BASE      + 0x0000000c)
#define HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_RMSK                         0xff
#define HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_ADDR, HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_RMSK)
#define HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_OUT(v)      \
        out_dword(HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_ADDR,v)
#define HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_OUTM(m,v) \
        out_dword_masked_ns(HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_ADDR,m,v,HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_IN)
#define HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_LOADVAL_BMSK                 0xff
#define HWIO_LPASS_AHBE_ABT_TIMER_LOADVAL_LOADVAL_SHFT                  0x0

#define HWIO_LPASS_AHBE_ABT_TIMER_MODE_ADDR                      (LPASS_AHBE_TIME_REG_BASE      + 0x00000010)
#define HWIO_LPASS_AHBE_ABT_TIMER_MODE_RMSK                             0x1
#define HWIO_LPASS_AHBE_ABT_TIMER_MODE_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_TIMER_MODE_ADDR, HWIO_LPASS_AHBE_ABT_TIMER_MODE_RMSK)
#define HWIO_LPASS_AHBE_ABT_TIMER_MODE_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_TIMER_MODE_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_TIMER_MODE_OUT(v)      \
        out_dword(HWIO_LPASS_AHBE_ABT_TIMER_MODE_ADDR,v)
#define HWIO_LPASS_AHBE_ABT_TIMER_MODE_OUTM(m,v) \
        out_dword_masked_ns(HWIO_LPASS_AHBE_ABT_TIMER_MODE_ADDR,m,v,HWIO_LPASS_AHBE_ABT_TIMER_MODE_IN)
#define HWIO_LPASS_AHBE_ABT_TIMER_MODE_MODE_BMSK                        0x1
#define HWIO_LPASS_AHBE_ABT_TIMER_MODE_MODE_SHFT                        0x0

#define HWIO_LPASS_AHBE_ABT_INTR_STATUS_ADDR                     (LPASS_AHBE_TIME_REG_BASE      + 0x00000014)
#define HWIO_LPASS_AHBE_ABT_INTR_STATUS_RMSK                            0x1
#define HWIO_LPASS_AHBE_ABT_INTR_STATUS_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_INTR_STATUS_ADDR, HWIO_LPASS_AHBE_ABT_INTR_STATUS_RMSK)
#define HWIO_LPASS_AHBE_ABT_INTR_STATUS_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_INTR_STATUS_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_INTR_STATUS_INTRSTATUS_BMSK                 0x1
#define HWIO_LPASS_AHBE_ABT_INTR_STATUS_INTRSTATUS_SHFT                 0x0

#define HWIO_LPASS_AHBE_ABT_INTR_CLEAR_ADDR                      (LPASS_AHBE_TIME_REG_BASE      + 0x00000018)
#define HWIO_LPASS_AHBE_ABT_INTR_CLEAR_RMSK                             0x1
#define HWIO_LPASS_AHBE_ABT_INTR_CLEAR_OUT(v)      \
        out_dword(HWIO_LPASS_AHBE_ABT_INTR_CLEAR_ADDR,v)
#define HWIO_LPASS_AHBE_ABT_INTR_CLEAR_INTRCLEAR_BMSK                   0x1
#define HWIO_LPASS_AHBE_ABT_INTR_CLEAR_INTRCLEAR_SHFT                   0x0

#define HWIO_LPASS_AHBE_ABT_INTR_ENABLE_ADDR                     (LPASS_AHBE_TIME_REG_BASE      + 0x0000001c)
#define HWIO_LPASS_AHBE_ABT_INTR_ENABLE_RMSK                            0x1
#define HWIO_LPASS_AHBE_ABT_INTR_ENABLE_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_INTR_ENABLE_ADDR, HWIO_LPASS_AHBE_ABT_INTR_ENABLE_RMSK)
#define HWIO_LPASS_AHBE_ABT_INTR_ENABLE_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_INTR_ENABLE_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_INTR_ENABLE_OUT(v)      \
        out_dword(HWIO_LPASS_AHBE_ABT_INTR_ENABLE_ADDR,v)
#define HWIO_LPASS_AHBE_ABT_INTR_ENABLE_OUTM(m,v) \
        out_dword_masked_ns(HWIO_LPASS_AHBE_ABT_INTR_ENABLE_ADDR,m,v,HWIO_LPASS_AHBE_ABT_INTR_ENABLE_IN)
#define HWIO_LPASS_AHBE_ABT_INTR_ENABLE_INTRENABLE_BMSK                 0x1
#define HWIO_LPASS_AHBE_ABT_INTR_ENABLE_INTRENABLE_SHFT                 0x0

#define HWIO_LPASS_AHBE_ABT_SYND_VALID_ADDR                      (LPASS_AHBE_TIME_REG_BASE      + 0x00000020)
#define HWIO_LPASS_AHBE_ABT_SYND_VALID_RMSK                             0x1
#define HWIO_LPASS_AHBE_ABT_SYND_VALID_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_VALID_ADDR, HWIO_LPASS_AHBE_ABT_SYND_VALID_RMSK)
#define HWIO_LPASS_AHBE_ABT_SYND_VALID_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_VALID_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_SYND_VALID_SYNDVALID_BMSK                   0x1
#define HWIO_LPASS_AHBE_ABT_SYND_VALID_SYNDVALID_SHFT                   0x0

#define HWIO_LPASS_AHBE_ABT_SYND_CLEAR_ADDR                      (LPASS_AHBE_TIME_REG_BASE      + 0x00000024)
#define HWIO_LPASS_AHBE_ABT_SYND_CLEAR_RMSK                             0x1
#define HWIO_LPASS_AHBE_ABT_SYND_CLEAR_OUT(v)      \
        out_dword(HWIO_LPASS_AHBE_ABT_SYND_CLEAR_ADDR,v)
#define HWIO_LPASS_AHBE_ABT_SYND_CLEAR_SYNDCLEAR_BMSK                   0x1
#define HWIO_LPASS_AHBE_ABT_SYND_CLEAR_SYNDCLEAR_SHFT                   0x0

#define HWIO_LPASS_AHBE_ABT_SYND_ID_ADDR                         (LPASS_AHBE_TIME_REG_BASE      + 0x00000028)
#define HWIO_LPASS_AHBE_ABT_SYND_ID_RMSK                             0xffff
#define HWIO_LPASS_AHBE_ABT_SYND_ID_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_ID_ADDR, HWIO_LPASS_AHBE_ABT_SYND_ID_RMSK)
#define HWIO_LPASS_AHBE_ABT_SYND_ID_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_ID_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_SYND_ID_BID_BMSK                         0xe000
#define HWIO_LPASS_AHBE_ABT_SYND_ID_BID_SHFT                            0xd
#define HWIO_LPASS_AHBE_ABT_SYND_ID_PID_BMSK                         0x1f00
#define HWIO_LPASS_AHBE_ABT_SYND_ID_PID_SHFT                            0x8
#define HWIO_LPASS_AHBE_ABT_SYND_ID_MID_BMSK                           0xff
#define HWIO_LPASS_AHBE_ABT_SYND_ID_MID_SHFT                            0x0

#define HWIO_LPASS_AHBE_ABT_SYND_ADDR0_ADDR                      (LPASS_AHBE_TIME_REG_BASE      + 0x0000002c)
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR0_RMSK                      0xffffffff
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR0_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_ADDR0_ADDR, HWIO_LPASS_AHBE_ABT_SYND_ADDR0_RMSK)
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR0_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_ADDR0_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR0_SYNDADDR0_BMSK            0xffffffff
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR0_SYNDADDR0_SHFT                   0x0

#define HWIO_LPASS_AHBE_ABT_SYND_ADDR1_ADDR                      (LPASS_AHBE_TIME_REG_BASE      + 0x00000030)
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR1_RMSK                      0xffffffff
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR1_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_ADDR1_ADDR, HWIO_LPASS_AHBE_ABT_SYND_ADDR1_RMSK)
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR1_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_ADDR1_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR1_SYNDADDR1_BMSK            0xffffffff
#define HWIO_LPASS_AHBE_ABT_SYND_ADDR1_SYNDADDR1_SHFT                   0x0

#define HWIO_LPASS_AHBE_ABT_SYND_HREADY_ADDR                     (LPASS_AHBE_TIME_REG_BASE      + 0x00000034)
#define HWIO_LPASS_AHBE_ABT_SYND_HREADY_RMSK                     0xffffffff
#define HWIO_LPASS_AHBE_ABT_SYND_HREADY_IN          \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_HREADY_ADDR, HWIO_LPASS_AHBE_ABT_SYND_HREADY_RMSK)
#define HWIO_LPASS_AHBE_ABT_SYND_HREADY_INM(m)      \
        in_dword_masked(HWIO_LPASS_AHBE_ABT_SYND_HREADY_ADDR, m)
#define HWIO_LPASS_AHBE_ABT_SYND_HREADY_SYNDHREADY_BMSK          0xffffffff
#define HWIO_LPASS_AHBE_ABT_SYND_HREADY_SYNDHREADY_SHFT                 0x0
...
#define LPASS_AHBL_TIME_REG_BASE                                 (LPASS_BASE      + 0x00143000)
