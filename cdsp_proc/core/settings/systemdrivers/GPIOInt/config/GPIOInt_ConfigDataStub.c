...
$Header: //components/rel/core.qdsp6/2.1.c4/settings/systemdrivers/GPIOInt/config/GPIOInt_ConfigDataStub.c#1 $
...
{
  {GPIOINT_NONE, HAL_GPIOINT_DIRECTCONNECT_0, 0,0}, /* Direct connect  0 */
};
