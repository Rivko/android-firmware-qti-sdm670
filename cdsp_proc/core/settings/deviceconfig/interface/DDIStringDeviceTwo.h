/*=============================================================================	
   ...
   All Rights Reserved.
	$Header: //components/rel/core.qdsp6/2.1.c4/settings/deviceconfig/interface/DDIStringDeviceTwo.h#1 $
=============================================================================*/
#ifndef __DALISTRINGDEVICETWO_H__
#define __DALISTRINGDEVICETWO_H__
