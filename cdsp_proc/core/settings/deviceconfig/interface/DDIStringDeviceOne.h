/*=============================================================================	
   ...
   All Rights Reserved.
	$Header: //components/rel/core.qdsp6/2.1.c4/settings/deviceconfig/interface/DDIStringDeviceOne.h#1 $
=============================================================================*/
...
struct DalStringDevice
{
   ...
   DALResult (*ReadTest)(uint32 ClientHandle, DalDeviceHandle * _h, void * dest_buffer, uint32  blen);
   DALResult (*WriteTest)(uint32 ClientHandle, DalDeviceHandle * _h, void * src_buffer, uint32  blen);
};
...
{
   return ((DalStringDeviceHandle *)_h)->pVtbl->ReadTest(DALDEVICE_LOCAL_CLIENTID,  _h, dest_buffer, blen);
}
...
{
   return ((DalStringDeviceHandle *)_h)->pVtbl->WriteTest(DALDEVICE_LOCAL_CLIENTID,  _h, src_buffer, blen);
}
