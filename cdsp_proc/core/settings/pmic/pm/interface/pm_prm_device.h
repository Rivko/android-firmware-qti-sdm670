...
$Header: //components/rel/core.qdsp6/2.1.c4/settings/pmic/pm/interface/pm_prm_device.h#1 $
...
typedef enum
{   
  PM_PRM_BOB_MODE_PASS    = PM_BOB_MODE_PASS, 
  PM_PRM_BOB_MODE_PFM     = PM_BOB_MODE_PFM,
  PM_PRM_BOB_MODE_AUTO    = PM_BOB_MODE_AUTO,
  PM_PRM_BOB_MODE_PWM     = PM_BOB_MODE_PWM,
  PM_PRM_BOB_MODE_INVALID    
}pm_prm_bob_mode_type;
