...
$Header: //components/rel/core.qdsp6/2.1.c4/settings/power/qdsp_pm/config/845/cdsp/qdsp_pm_configdata_845_cdsp.c#1 $
*/
...
#include "icbid.h"
#include "DDIIPCInt.h"
#include "qdsp_pm_clocks_hwio_845_cdsp.h"
#include "msmhwiobase.h"
#include "limits.h"
#include "systemcache/systemcache.h"
#include "qdsp_pm_configdata_arch_845_cdsp.h"
...
const AdsppmBusPortIdType masterPorts_CDSP_845[]    = {AdsppmBusPort_Q6DSP_Master};
const AdsppmBusPortIdType masterPorts_HCP_845[]    = {AdsppmBusPort_Vapss_Hcp_Master};
const AdsppmBusPortIdType masterPorts_DMA_845[]    = {AdsppmBusPort_Vapss_Dma_Master};


/**
 * Array of 845 Slave Bus Ports per core. Arranged by to core ID
 */
const AdsppmBusPortIdType slavePorts_CDSP_845[]    = {AdsppmBusPort_Cdsp_TCM_Slave};
...
const AsicCoreDescType cores_array_845[] =
{
        {   //Adsppm_Core_Id_CDSP Q6
                ...
                {ADSPPM_ARRAY(masterPorts_CDSP_845)}, //Master port instances
        ...
        {   //Adsppm_Core_Id_Compute_HCP
                ...
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_HCP_845)}, //Master port instances
                {0, NULL}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_Compute_DMA
                ...
                AsicPowerDomain_ComputeCore, //Power Domain
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_DMA_845)}, //Master port instances
                {0, NULL}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_HVX
...
const AdsppmBusRouteType extBusRoutes_array_845[] =
{
        ...
        {
                AdsppmBusPort_Vapss_Hcp_Master, //master
                AdsppmBusPort_Ddr_Slave //slave
        },
        {
