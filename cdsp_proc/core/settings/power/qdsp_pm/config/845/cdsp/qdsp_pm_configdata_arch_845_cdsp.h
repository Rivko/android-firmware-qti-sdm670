...
$Header: //components/rel/core.qdsp6/2.1.c4/settings/power/qdsp_pm/config/845/cdsp/qdsp_pm_configdata_arch_845_cdsp.h#1 $
*/
...
const AsicAdspToAhbeFreqTableEntry adspToAhbeFreq_array_845v1[] = {
    ...
    {   249600000,       25600000 }, // MinSVS f-max
    {   384000000,       51200000 }, // lowSVS f-max
    {   499200000,      102400000 }, // svs f-max
    {   691200000,      122880000 }, // svs_l1 f-max                                     //
    {   787000000,      204800000 }, // nominal ADSP f-max
    {   998400000,      263690000 }, // turbo
};
