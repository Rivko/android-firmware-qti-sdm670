...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/2.1.c4/storage/tftp/common/inc/tftp_config.h#1 $ $DateTime: 2018/07/30 01:21:36 $ $Author: pwbldsvc $
...
enum tftp_server_instance_id_type
{
  ...
  TFTP_SERVER_INSTANCE_ID_MDM_TN       = 5,
  TFTP_SERVER_INSTANCE_ID_APQ_GSS      = 6,
  TFTP_SERVER_INSTANCE_ID_MSM_SLPI     = 7,
  TFTP_SERVER_INSTANCE_ID_MDM_SLPI     = 8,
  TFTP_SERVER_INSTANCE_ID_MAX          = 9,
};
