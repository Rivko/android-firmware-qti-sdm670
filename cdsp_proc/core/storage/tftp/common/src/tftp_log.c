...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/2.1.c4/storage/tftp/common/src/tftp_log.c#1 $ $DateTime: 2018/07/30 01:21:36 $ $Author: pwbldsvc $
...
static int tftp_log_check_msg_level (enum tftp_log_msg_level_type msg_level)
{

  switch (msg_level)
  {
    case TFTP_LOG_MSG_LEVEL_ERROR:
      return tftp_log_config_inst.enable_err_logging;

    case TFTP_LOG_MSG_LEVEL_WARN:
      return tftp_log_config_inst.enable_warn_logging;

    case TFTP_LOG_MSG_LEVEL_DEBUG:
      return tftp_log_config_inst.enable_debug_logging;

    case TFTP_LOG_MSG_LEVEL_INFO:
      return tftp_log_config_inst.enable_info_logging;
              ...
              const char *msg_format, ...)
{
  ...
  if (!tftp_log_check_msg_level (msg_level))
    return;
