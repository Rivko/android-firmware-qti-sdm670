...
/*
  ...
  $Header: //components/rel/core.qdsp6/2.1.c4/power/rsc/hal/hwio/670/rsc_HALhwioBase.h#1 $
...
#define RSCC_RSC_REG_BASE                                                                                       (LPASS_BASE      + 0x00b90000)
...
#define HWIO_SOLVER_OVERRIDE_CTRL_DRV0_IN(x)      \
        in_dword_masked(HWIO_SOLVER_OVERRIDE_CTRL_DRV0_ADDR(x), HWIO_SOLVER_OVERRIDE_CTRL_DRV0_RMSK)
...
#define HWIO_SOLVER_OVERRIDE_MODE_DRV0_IN(x)      \
        in_dword_masked(HWIO_SOLVER_OVERRIDE_MODE_DRV0_ADDR(x), HWIO_SOLVER_OVERRIDE_MODE_DRV0_RMSK)
...
#define HWIO_SOLVER_OVERRIDE_IDLE_TIME_DRV0_IN(x)      \
        in_dword_masked(HWIO_SOLVER_OVERRIDE_IDLE_TIME_DRV0_ADDR(x), HWIO_SOLVER_OVERRIDE_IDLE_TIME_DRV0_RMSK)
...
#define HWIO_TCSm_CMDn_DRV0_READ_RESPONSE_DATA_ADDR(base,m,n)                                                   ((base) + 0x00001c40 + 0x2A0 * (m) + 0x14 * (n))
