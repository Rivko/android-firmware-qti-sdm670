...
/**
  ...
  { u'filename': u'hwio_lpass_qos_generic.h',
    ...
    u'modules': [u'LPASS_QOS_QOS_LPASS_GENERIC'],
...
/*
  ...
  $Header: //components/rel/core.qdsp6/2.1.c4/power/dangergen/src/target/670/hwio_lpass_qos_generic.h#1 $
...
/*----------------------------------------------------------------------------
 * MODULE: LPASS_QOS_QOS_LPASS_GENERIC
 *--------------------------------------------------------------------------*/

#define LPASS_QOS_QOS_LPASS_GENERIC_REG_BASE          (LPASS_BASE      + 0x00b60000)
#define LPASS_QOS_QOS_LPASS_GENERIC_REG_BASE_OFFS     0x00b60000

#define HWIO_LPASS_QOS_HW_VERSION_ADDR                (LPASS_QOS_QOS_LPASS_GENERIC_REG_BASE      + 0x00000000)
#define HWIO_LPASS_QOS_HW_VERSION_OFFS                (LPASS_QOS_QOS_LPASS_GENERIC_REG_BASE_OFFS + 0x00000000)
...
#define HWIO_LPASS_QOS_NOC_CGC_ADDR                   (LPASS_QOS_QOS_LPASS_GENERIC_REG_BASE      + 0x00000004)
#define HWIO_LPASS_QOS_NOC_CGC_OFFS                   (LPASS_QOS_QOS_LPASS_GENERIC_REG_BASE_OFFS + 0x00000004)
