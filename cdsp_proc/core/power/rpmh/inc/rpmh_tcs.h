...
#define TCS_TIMEOUT_THRESHOLD 0x1D4C00 //100mS in qtmr ticks
...
/**
 * <!-- tcs_island_mode_status -->
 *
 * @brief  Whether or not the TCS layer thinks we are in island mode
 *
 * @return TRUE if the TCS layer thinks we are in island mode
 */
