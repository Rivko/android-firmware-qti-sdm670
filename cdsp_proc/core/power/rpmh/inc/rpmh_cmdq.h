 ...
 * <!-- rpmh_delete_cmd -->
 *
 * @brief Add the given command back to the free_cmds pool 
 *
 * @param self : The command queue to use
 ...
 * <!-- rpmh_delete_cmd -->
 *
 * @brief Retrieve a new command 
 *
 * @param self : The command queue to use
 * @return A new command from the free command pool
 */ 
 ...
 * <!-- log_cmd_set -->
 *
 * @brief Add the given cmd details to the log 
 *
