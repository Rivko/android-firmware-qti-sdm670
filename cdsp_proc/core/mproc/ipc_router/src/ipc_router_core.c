/*===========================================================================
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2007-2013,2015 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/core.qdsp6/2.1.c4/mproc/ipc_router/src/ipc_router_core.c#1 $
