...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/2.1.c4/debugtools/dog/src/dog_hal_mpss.c#1 $
...
void HAL_dogEnable(void)
{
   ...
   {
      // SET NMI TIMEOUT
      HWIO_MSS_QDSP6SS_WDOG_NMI_TIME_OUTM(HWIO_MSS_QDSP6SS_WDOG_NMI_TIME_DATA_BMSK, DOG_NMI_ENABLE_TIMEOUT_SCLK);
      ...
      // SET BITE TIMEOUT
      HWIO_MSS_QDSP6SS_WDOG_BITE_TIME_OUTM(HWIO_MSS_QDSP6SS_WDOG_BITE_TIME_DATA_BMSK, DOG_BITE_ENABLE_TIMEOUT_SCLK);
...
void HAL_dogDisable(void)
{
   ...
   {
      // DISABLE WDOG
      HWIO_MSS_QDSP6SS_WDOG_CTL_OUTM(HWIO_MSS_QDSP6SS_WDOG_CTL_ENABLE_BMSK, 0 << HWIO_MSS_QDSP6SS_WDOG_CTL_ENABLE_SHFT);
   }
}
...
{
   // SET BARK TIMEOUT
   HWIO_MSS_QDSP6SS_WDOG_BARK_TIME_OUTM(HWIO_MSS_QDSP6SS_WDOG_BARK_TIME_DATA_BMSK, DOG_BARK_ENABLE_TIMEOUT_SCLK);
}
...
void HAL_dogIsAutokicking(unsigned int* status)
{
   if (NULL != status)
   {
      if (0 != (HWIO_MSS_QDSP6SS_WDOG_CTL_INM(HWIO_MSS_QDSP6SS_WDOG_CTL_ENABLE_BMSK) & HWIO_MSS_QDSP6SS_WDOG_CTL_ENABLE_BMSK))
      {
