...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/2.1.c4/debugtools/dog/src/udog_hal_adsp.c#1 $
...
void HAL_dogForceBite(void)
{
   if(dog_hal_disable_for_bringup != TRUE)
   {
      ...
      // SET MINIMUM TIMEOUT
      HWIO_LPASS_QDSP6SS_WDOG_BITE_TIME_OUTM(HWIO_LPASS_QDSP6SS_WDOG_BITE_TIME_DATA_BMSK, DOG_BITE_ENABLE_TIMEOUT_NOW_SCLK);
...
void HAL_dogForceNMI(void)
{
   if(dog_hal_disable_for_bringup != TRUE)
   {
      ...
      // SET BITE TIMEOUT
      HWIO_LPASS_QDSP6SS_WDOG_BITE_TIME_OUTM(HWIO_LPASS_QDSP6SS_WDOG_BITE_TIME_DATA_BMSK, DOG_BITE_ENABLE_TIMEOUT_SCLK_FORCE);

      // SET NMI TIMEOUT
      HWIO_LPASS_QDSP6SS_WDOG_NMI_TIME_OUTM(HWIO_LPASS_QDSP6SS_WDOG_NMI_TIME_DATA_BMSK, DOG_NMI_ENABLE_TIMEOUT_SCLK_FORCE);
