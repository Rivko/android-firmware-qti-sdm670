#ifndef __DOG_HAL_SDM855_SLPI_H__
#define __DOG_HAL_SDM855_SLPI_H__
/*
===========================================================================
*/
/**
  @file dog_hal_sdm855_slpi.h
  ...
  'Include' filters applied: WDOG[SSC_QDSP6V66SS_CSR] 
...
/*
  ...
  $Header: //components/rel/core.qdsp6/2.1.c4/debugtools/dog/src/hal/dog_hal_sdm855_slpi.h#1 $
...
/*----------------------------------------------------------------------------
 * MODULE: SSC_QDSP6V66SS_CSR
 *--------------------------------------------------------------------------*/

#define SSC_QDSP6V66SS_CSR_REG_BASE                                                      (SSC_BASE      + 0x00480000)
#define SSC_QDSP6V66SS_CSR_REG_BASE_OFFS                                                 0x00480000

#define HWIO_SSC_QDSP6SS_WDOG_RESET_ADDR                                                 (SSC_QDSP6V66SS_CSR_REG_BASE      + 0x00004000)
#define HWIO_SSC_QDSP6SS_WDOG_RESET_OFFS                                                 (SSC_QDSP6V66SS_CSR_REG_BASE_OFFS + 0x00004000)
...
#define HWIO_SSC_QDSP6SS_WDOG_CTL_ADDR                                                   (SSC_QDSP6V66SS_CSR_REG_BASE      + 0x00004004)
#define HWIO_SSC_QDSP6SS_WDOG_CTL_OFFS                                                   (SSC_QDSP6V66SS_CSR_REG_BASE_OFFS + 0x00004004)
...
#define HWIO_SSC_QDSP6SS_WDOG_STATUS_ADDR                                                (SSC_QDSP6V66SS_CSR_REG_BASE      + 0x00004008)
#define HWIO_SSC_QDSP6SS_WDOG_STATUS_OFFS                                                (SSC_QDSP6V66SS_CSR_REG_BASE_OFFS + 0x00004008)
...
#define HWIO_SSC_QDSP6SS_WDOG_BARK_TIME_ADDR                                             (SSC_QDSP6V66SS_CSR_REG_BASE      + 0x0000400c)
#define HWIO_SSC_QDSP6SS_WDOG_BARK_TIME_OFFS                                             (SSC_QDSP6V66SS_CSR_REG_BASE_OFFS + 0x0000400c)
...
#define HWIO_SSC_QDSP6SS_WDOG_BITE_TIME_ADDR                                             (SSC_QDSP6V66SS_CSR_REG_BASE      + 0x00004010)
#define HWIO_SSC_QDSP6SS_WDOG_BITE_TIME_OFFS                                             (SSC_QDSP6V66SS_CSR_REG_BASE_OFFS + 0x00004010)
...
#define HWIO_SSC_QDSP6SS_WDOG_NMI_TIME_ADDR                                              (SSC_QDSP6V66SS_CSR_REG_BASE      + 0x00004014)
#define HWIO_SSC_QDSP6SS_WDOG_NMI_TIME_OFFS                                              (SSC_QDSP6V66SS_CSR_REG_BASE_OFFS + 0x00004014)
...
#define HWIO_SSC_QDSP6SS_WDOG_TEST_LOAD_ADDR                                             (SSC_QDSP6V66SS_CSR_REG_BASE      + 0x00004018)
#define HWIO_SSC_QDSP6SS_WDOG_TEST_LOAD_OFFS                                             (SSC_QDSP6V66SS_CSR_REG_BASE_OFFS + 0x00004018)
...
#define HWIO_SSC_QDSP6SS_WDOG_TEST_ADDR                                                  (SSC_QDSP6V66SS_CSR_REG_BASE      + 0x0000401c)
#define HWIO_SSC_QDSP6SS_WDOG_TEST_OFFS                                                  (SSC_QDSP6V66SS_CSR_REG_BASE_OFFS + 0x0000401c)
...
#endif /* __DOG_HAL_SDM855_SLPI_H__ */
