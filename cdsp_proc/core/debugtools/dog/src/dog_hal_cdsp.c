...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/2.1.c4/debugtools/dog/src/dog_hal_cdsp.c#1 $
...
void HAL_dogEnable(void)
{
   ...
   {
      // SET NMI TIMEOUT
      HWIO_TURING_QDSP6SS_WDOG_NMI_TIME_OUTM(HWIO_TURING_QDSP6SS_WDOG_NMI_TIME_DATA_BMSK, DOG_NMI_ENABLE_TIMEOUT_SCLK);
      ...
      // SET BITE TIMEOUT
      HWIO_TURING_QDSP6SS_WDOG_BITE_TIME_OUTM(HWIO_TURING_QDSP6SS_WDOG_BITE_TIME_DATA_BMSK, DOG_BITE_ENABLE_TIMEOUT_SCLK);
...
{
   // SET BARK TIMEOUT
   HWIO_TURING_QDSP6SS_WDOG_BARK_TIME_OUTM(HWIO_TURING_QDSP6SS_WDOG_BARK_TIME_DATA_BMSK, DOG_BARK_ENABLE_TIMEOUT_SCLK);
}
