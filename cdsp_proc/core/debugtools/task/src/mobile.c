...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/2.1.c4/debugtools/task/src/mobile.c#1 $
...
NOTICE_TYPE rel_date[] = "Oct 30 2020";
...
NOTICE_TYPE mob_sw_rev[] = "CDSP.VT.2.0-00249-SDM710-2";
