...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SDM670v1 (napaliq_1.0):
      ...
      TURING_CC : napaliq_turing_p3q1r5.4_fix_dbg_map [napali_v2_turing_cc.r3]


==============================================================================

$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/image/cdsp/hw/sdm670/ClockBSP.c#1 $
...
static ClockMuxConfigType ClockDomainBSP_TURINGCC_AON[] =
{
  ...
  {  245760000, &ClockSource_TURINGCC_TURINGDIGPLL,       { 1,     5,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR,        },                                                            /* Mux[1] = TURING_DIG_PLL_OUT_MAIN */
};
...
{
  {  288000000, &ClockSource_TURINGCC_TURINGQDSP6SSPLL,   { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    {{ 0 }}, &ClockSourceBSP_TURINGCC_TURINGQDSP6SSPLL[ 0] /* 288.0  */ },  /* Mux[2] = TURING_QDSP6SS_PLL_OUT_MAIN */
  {  460800000, &ClockSource_TURINGCC_TURINGQDSP6SSPLL,   { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_LOW_SVS,    {{ 0 }}, &ClockSourceBSP_TURINGCC_TURINGQDSP6SSPLL[ 1] /* 460.0  */ },  /* Mux[2] = TURING_QDSP6SS_PLL_OUT_MAIN */
  {  614400000, &ClockSource_TURINGCC_TURINGQDSP6SSPLL,   { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS,        {{ 0 }}, &ClockSourceBSP_TURINGCC_TURINGQDSP6SSPLL[ 2] /* 614.0  */ },  /* Mux[2] = TURING_QDSP6SS_PLL_OUT_MAIN */
  {  787200000, &ClockSource_TURINGCC_TURINGQDSP6SSPLL,   { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_SVS_L1,     {{ 0 }}, &ClockSourceBSP_TURINGCC_TURINGQDSP6SSPLL[ 3] /* 787.0  */ },  /* Mux[2] = TURING_QDSP6SS_PLL_OUT_MAIN */
  {  940800000, &ClockSource_TURINGCC_TURINGQDSP6SSPLL,   { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_NOM,        {{ 0 }}, &ClockSourceBSP_TURINGCC_TURINGQDSP6SSPLL[ 4] /* 940.0  */ },  /* Mux[2] = TURING_QDSP6SS_PLL_OUT_MAIN */
  { 1190400000, &ClockSource_TURINGCC_TURINGQDSP6SSPLL,   { 2,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_TUR,        {{ 0 }}, &ClockSourceBSP_TURINGCC_TURINGQDSP6SSPLL[ 5] /* 1190.0 */ },  /* Mux[2] = TURING_QDSP6SS_PLL_OUT_MAIN */
};
