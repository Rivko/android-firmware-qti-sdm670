...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/image/cdsp/hw/sdm670/HALclkTest.c#1 $
...
/*=========================================================================
      TURING_CC Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxTURINGCC
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
{
  HWIO_OUTF(TURING_TURING_CC_DEBUG_MUX_MUXR, MUX_SEL, nMuxSel);
  HWIO_OUTF(TURING_TURING_CC_DEBUG_DIV_CDIVR, CLK_DIV, 0);
  HWIO_OUTF(TURING_TURING_CC_DEBUG_CBCR, CLK_ENABLE, 1);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlTURINGCC =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxTURINGCC,
};


/*=========================================================================
      TURING_CC_Q6 Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxTURINGCCQ6
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
{
  HWIO_OUTF(TURING_QDSP6SS_TEST_CLK_CTL, DBG_CLK_SEL, nMuxSel);
  HWIO_OUTF(TURING_QDSP6SS_TEST_CLK_CTL, Q6_DBG_CLK_EN, 1);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlTURINGCCQ6 =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxTURINGCCQ6,
};
