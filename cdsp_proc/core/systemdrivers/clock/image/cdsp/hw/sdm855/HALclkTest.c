...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/image/cdsp/hw/sdm855/HALclkTest.c#1 $
...
{
  HWIO_OUTF(TURING_DEBUG_MUX_MUXR, MUX_SEL, nMuxSel);
  HWIO_OUTF(TURING_DEBUG_DIV_CDIVR, CLK_DIV, 1);
  HWIO_OUTF(TURING_DEBUG_CBCR, CLK_ENABLE, 1);
}
