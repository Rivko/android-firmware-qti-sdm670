...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/image/adsp/hw/sdm670/HALclkTest.c#1 $
...
/*=========================================================================
      LPASS_AON_CC Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxLPASSAONCC
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
{
  HWIO_OUTF(SSC_SCC_DEBUG_CLK_CTL, MUX_SEL, nMuxSel);
  HWIO_OUTF(SSC_SCC_DEBUG_CBCR, CLK_ENABLE, 1);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlLPASSAONCC =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxLPASSAONCC,
};


/*=========================================================================
      LPASS_AON_CC_Q6 Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxLPASSAONCCQ6
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
{
  HWIO_OUTF(SSC_QDSP6SS_TEST_CLK_CTL, DBG_CLK_SEL, nMuxSel);
  HWIO_OUTF(SSC_QDSP6SS_TEST_CLK_CTL, Q6_DBG_CLK_EN, 1);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlLPASSAONCCQ6 =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxLPASSAONCCQ6,
};


/*=========================================================================
      LPASS_CORE_CC Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxLPASSCORECC
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlLPASSCORECC =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxLPASSCORECC,
};
