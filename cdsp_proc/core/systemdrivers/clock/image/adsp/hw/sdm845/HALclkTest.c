...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/image/adsp/hw/sdm845/HALclkTest.c#1 $
...
/*=========================================================================
      LPASS_Q6 Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxLPASSQ6
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
{
  HWIO_OUTF(LPASS_QDSP6SS_TEST_CLK_CTL, DBG_CLK_SEL, nMuxSel);
  HWIO_OUTF(LPASS_QDSP6SS_TEST_CLK_CTL, Q6_DBG_CLK_EN, 1);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlLPASSQ6 =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxLPASSQ6,
};
