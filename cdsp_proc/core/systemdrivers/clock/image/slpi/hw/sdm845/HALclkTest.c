...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/image/slpi/hw/sdm845/HALclkTest.c#1 $
...
/*=========================================================================
      SCC Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxSCC
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlSCC =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxSCC,
};


/*=========================================================================
      SCC_Q6 Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxSCCQ6
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32                     nMuxSel
)
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlSCCQ6 =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxSCCQ6,
};
