...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SDM845v1 (napali_1.0):
      GCC       : napali_clk_ctl_prj_v1.0_p3q3r36_final_mto_review_02162017 [napali_gcc.r29]
      SCC       : ssc_cc_napali_1.0_p3q2r35 [napaliq_scc.r10]


==============================================================================

$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/image/slpi/hw/sdm845/ClockBSP.c#1 $
...
extern HAL_clk_DebugMuxControlType        HAL_clk_DebugMuxControlSCCQ6;
...
static ClockDebugMuxType ClockDebugMux_SCCQ6 =
{
  .szName       = "scc_q6",
  .pParent      = &ClockDebugMux_SCC,
  .nParentSel   = 30,
  .HALDebugMux  = {
    .pmControl  = &HAL_clk_DebugMuxControlSCCQ6,
  },
};
...
static ClockMuxConfigType ClockDomainBSP_SCC_SCCQUPV3SE0[] =
{
  ...
  {   19200000, NULL,                                     { 0,     2,     0,     0,     0x00 }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    },                                                            /* Mux[0] = AOSS_CC_RO_CLK */
...
{
  {   19200000, NULL,                                     { 0,     2,     0,     0,     0xFF }, RAIL_VOLTAGE_LEVEL_MIN_SVS,    },                                                            /* Mux[0] = AOSS_CC_RO_CLK */
...
static ClockNodeType aClocks[] =
{
  ...
  },
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_2XCORE_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_CORE_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x400} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 42,
    },
  },
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_CORE_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_CORE_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x800} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 43,
    },
  },
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_M_HCLK_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_BUS_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x2} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 32,
    },
  },
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_S_HCLK_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_BUS_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x1} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 18,
    },
  },
  ...
  /*-----------------------------------------------------------------------*/
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_SE0_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_SE0_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x8} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 2,
    },
  },
  ...
  /*-----------------------------------------------------------------------*/
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_SE1_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_SE1_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x10} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 3,
    },
  },
  ...
  /*-----------------------------------------------------------------------*/
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_SE2_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_SE2_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x20} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 4,
    },
  },
  ...
  /*-----------------------------------------------------------------------*/
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_SE3_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_SE3_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x40} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 6,
    },
  },
  ...
  /*-----------------------------------------------------------------------*/
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_SE4_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_SE4_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x80} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 7,
    },
  },
  ...
  /*-----------------------------------------------------------------------*/
  {
    ...
    .nFlags    = 0x0,
    .HALClock  = {
      .mRegisters   = { HWIO_ADDR(SSC_SCC_QUPV3_SE5_CBCR), HWIO_ADDR(SSC_SCC_QUPV3_SE5_BCR), {HWIO_ADDR(SCC_PROC_CLK_BRANCH_ENA_VOTE), 0x100} },
      .pmControl    = &HAL_clk_GenericClockControl,
      .nDebugMuxSel = 8,
    },
  },
