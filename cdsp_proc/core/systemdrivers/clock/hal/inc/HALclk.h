...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/hal/inc/HALclk.h#1 $
...
boolean HAL_clk_IsPowerDomainSupported  ( HAL_clk_PowerDomainDescType *pmPowerDomainDesc );
