...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/clock/hal/hw/v1/HALclkTrionPLL.c#1 $
...
/* ===========================================================================
**  HAL_clk_TrionPLLEnableFromStandby
**
...
**
**  This procedure applies only to Trion PLL types.
**
**  The following fields must have remained unchanged from the values present
**  when the HAL_clk_TrionPLLDisableToStandby function was executed:
**  - PLL_L_VAL
**  - PLL_ALPHA_VAL
**
**  Returns:
...
static boolean HAL_clk_TrionPLLEnableFromStandby
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_TrionPLLEnableFromStandby */


/* ===========================================================================
**  HAL_clk_TrionPLLEnableFromSaved
**
...
**
**  The following fields must have remained unchanged from the values present
**  when the HAL_clk_TrionPLLDisableToSaved function was executed:
**  - PLL_L_VAL
**  - PLL_ALPHA_VAL
**
**  Returns:
...
static boolean HAL_clk_TrionPLLEnableFromSaved
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
...
} /* END HAL_clk_TrionPLLEnableFromSaved */


/* ===========================================================================
**  HAL_clk_TrionPLLEnableNormal
**
**  PLL initial bringup.
**  When in the off state, the bias is off and draws no power.
**  This procedure results in calibration being performed.
**
**  This procedure applies only to both Trion PLL types.
**
**  Returns:
**    boolean - TRUE if successfully enabled. FALSE otherwise.
** ======================================================================== */

static boolean HAL_clk_TrionPLLEnableNormal
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_TrionPLLEnableNormal */


/* ===========================================================================
**  HAL_clk_TrionPLLEnableFromFreeze
**
...
**  when the HAL_clk_TrionPLLEnableFromFreeze function was executed:
...
static boolean HAL_clk_TrionPLLEnableFromFreeze
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_TrionPLLEnableFromFreeze */
...
)
{
   ...
   */
  if (HAL_clk_TrionPLLIsEnabled(pSource))
  {
    return TRUE;
  }
  ...
  switch (eMode)
  {
    case HAL_CLK_SOURCE_DISABLE_MODE_STANDBY:
      bResult = HAL_clk_TrionPLLEnableFromStandby(pSource);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_SAVE:
      bResult = HAL_clk_TrionPLLEnableFromSaved(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_FREEZE:
      bResult = HAL_clk_TrionPLLEnableFromFreeze(pSource);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_NORMAL:
      bResult = HAL_clk_TrionPLLEnableNormal(pSource);
      break;
    default:
      bResult = FALSE;
      break;
...
/* ===========================================================================
**  HAL_clk_TrionPLLDisableToStandby
**
**  PLL shutdown to standby state.
**  This procedure leaves the bias on:
**    skips calibration when enabling via HAL_clk_TrionPLLEnableFromStandby.
...
static void HAL_clk_TrionPLLDisableToStandby
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_TrionPLLDisableToStandby */


/* ===========================================================================
**  HAL_clk_TrionPLLDisableToSaved
**
**  PLL shutdown with save state.
**  When in the saved state, the bias is off and draws no power.
**  The calibration data is saved in *pData to be used later when
**  calling HAL_clk_TrionPLLEnableFromSaved.
**
**  This procedure applies only to Trion PLL types.
**
...
static void HAL_clk_TrionPLLDisableToSaved
(
  HAL_clk_SourceDescType *pSource,
  void                   *pData
)
...
} /* END HAL_clk_TrionPLLDisableToSaved */


/* ===========================================================================
**  HAL_clk_TrionPLLDisableNormal
**
**  PLL shutdown.
**  When in the off state, the bias is off and draws no power.
...
static void HAL_clk_TrionPLLDisableNormal
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_TrionPLLDisableNormal */


/* ===========================================================================
**  HAL_clk_TrionPLLDisableToFreeze
**
...
static void HAL_clk_TrionPLLDisableToFreeze
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_TrionPLLDisableToFreeze */
...
)
{
  ...
  {
    case HAL_CLK_SOURCE_DISABLE_MODE_STANDBY:
      HAL_clk_TrionPLLDisableToStandby(pSource);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_SAVE:
      HAL_clk_TrionPLLDisableToSaved(pSource, pData);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_FREEZE:
      HAL_clk_TrionPLLDisableToFreeze(pSource);
      break;
    case HAL_CLK_SOURCE_DISABLE_MODE_NORMAL:
      HAL_clk_TrionPLLDisableNormal(pSource);
      break;
    default:
      break;
  }
...
)
{
   ...
   * support the slewing feature.  The Trion HPG specifies that the PLL will
  ...
  {
    HAL_clk_TrionPLLEnableNormal(pSource);
  }
