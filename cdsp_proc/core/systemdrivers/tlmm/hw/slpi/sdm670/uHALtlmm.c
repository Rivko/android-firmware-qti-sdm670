...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/tlmm/hw/slpi/sdm670/uHALtlmm.c#1 $
...
static uHAL_tlmm_ConfigsType uHAL_tlmm_Configs[] =
{
  ...
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_18),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_18)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_19),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_19)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_20),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_20)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_21),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_21)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_22),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_22)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_23),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_23)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_24),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_24)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_25),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_25)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_26),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_26)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_27),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_27)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_28),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_28)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_29),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_29)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_30),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_30)
  },
  {
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_CFG_31),
    HWIO_ADDR(SSC_TLMM_LITE_GPIO_IN_OUT_31)
  },
};
