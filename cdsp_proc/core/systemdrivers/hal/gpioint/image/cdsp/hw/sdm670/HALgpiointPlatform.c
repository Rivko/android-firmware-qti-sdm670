...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/hal/gpioint/image/cdsp/hw/sdm670/HALgpiointPlatform.c#1 $
...
void HAL_gpioint_PlatformInitEarly (HAL_gpioint_PlatformType *pmPlatform)
{
  ...
  pmPlatform->pmCtl.eProcessorID                   = HAL_GPIOINT_TURING_PROC;
