...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/ipcint/hw/sdm670/cdsp/DalIPCInt_ConfigData.c#1 $
...
IPCIntConfigType IPCIntConfigMap[DALIPCINT_NUM_PROCS] =
{
  ...
  { IPC_BASE,      IPC_BASE_OFFSET,      24, 3 }, //DALIPCINT_PROC_ADSP
  { IPC_BASE,      IPC_BASE_OFFSET,      8,  2 }, //DALIPCINT_PROC_SPS
  ...
  { IPC_BASE,      IPC_BASE_OFFSET,      24, 3 }, //DALIPCINT_PROC_LPASS
  ...
  { IPC_BASE,      IPC_BASE_OFFSET,      8,  2 }  //DALIPCINT_PROC_SDC
};
