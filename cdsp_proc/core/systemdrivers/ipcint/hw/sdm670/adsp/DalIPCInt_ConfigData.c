...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/ipcint/hw/sdm670/adsp/DalIPCInt_ConfigData.c#1 $
...
IPCIntConfigType IPCIntConfigMap[DALIPCINT_NUM_PROCS] =
{
  ...
  { IPC_BASE,      IPC_BASE_OFFSET_R1,   24, 2 }, //DALIPCINT_PROC_SPS
  ...
  { IPC_BASE,      IPC_BASE_OFFSET_R1,   24, 2 }  //DALIPCINT_PROC_SDC
};
