...
$Header: //components/rel/core.qdsp6/2.1.c4/systemdrivers/ipcint/hw/sdm845/slpi/DalIPCInt_ConfigData.c#1 $
...
IPCIntConfigType IPCIntConfigMap[DALIPCINT_NUM_PROCS] =
{
  ...
  { IPC_BASE,      IPC_BASE_OFFSET_R1,   24, 4 }  //DALIPCINT_PROC_SDC
};
