...
class BaseStager(object):
    ...
    def _create_imageinfo(self, img_config_parser, parsegen_config, sign_id, image_path, src_image=None, dest_image=None):
        ...
        image_info = ImageInfo(image_path, sign_id, img_config_block, img_config_parser, parsegen_config, authority=self.authority)
