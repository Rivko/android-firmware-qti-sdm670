...
class SecParseGenElf(SecParseGenMbn):
    ...
    def __init__(self,
        ...
        if elf_properties.has_multi_image_segment is not None:
            ...
            self.multi_image_segment_addr = self.imageinfo.multi_image_segment_addr
    ...
    def add_or_update_multi_image_segment(self):
        if self.has_multi_image_segment:
            ...
            self._multi_image_segment = MultiImageSegment(self.debug_dir if self.signing else None, self.segment_hash_algorithm, data=multi_image_segment_data, images=self.dependent_parsegens)
