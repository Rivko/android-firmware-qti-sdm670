...
def get_sw_id(signing_attributes):
    if signing_attributes.anti_rollback_version is not None:
        return int("{0:#0{1}x}".format(int(signing_attributes.anti_rollback_version, 16), 10) + "{0:0{1}x}".format(int(signing_attributes.sw_id, 16), 8), 16)
