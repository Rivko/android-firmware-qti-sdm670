...
CONFIG_STRUCTURE_IMAGE_TYPE = \
{
    ...
    'elf_properties' :
    {
        ...
        'image_type' : 0,
        'max_elf_segments' : (0,),
        'hash_seg_placement' : (('POST_PHDR_ALIGNED', 'POST_PHDR', 'POST_PHDR_LOAD_ALIGNED', 'END_64B_ALIGNED', 'END_128B_ALIGNED', ()),),
        'validate_ph_addrs' : (True,),
        'validate_vir_addrs' : (False,),
        'has_multi_image_segment' : (False,),
        'has_license_manager_segment' : (False,),
    },
