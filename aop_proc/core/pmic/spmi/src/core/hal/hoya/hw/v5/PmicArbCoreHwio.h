...
/*
  ...
  $Header: //components/rel/aop.ho/1.1.c1/aop_proc/core/pmic/spmi/src/core/hal/hoya/hw/v5/PmicArbCoreHwio.h#1 $
...
#define PMIC_ARB_MGPI_REG_BASE                                        (AOSS_BASE      + 0x01460000)
#define PMIC_ARB_MGPI_REG_BASE_OFFS                                   0x01460000
...
#define QDSS_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE                           (QDSS_SOC_DBG_BASE      + 0x00b22000)
#define QDSS_PMIC_ARB_PMIC_ARB_PMIC_ARB_DEBUG_REG_BASE_OFFS                      0x00b22000
