...
/*
  ...
  $Header: //components/rel/aop.ho/1.1.c1/aop_proc/core/pmic/spmi/src/core/hal/hoya/hw/v5/SpmiCoreHwio.h#1 $
...
#define HWIO_SPMI_MID_REG_ADDR(x)                                                     ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000800)
...
#define HWIO_SPMI_CFG_REG_ADDR(x)                                                     ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000804)
...
#define HWIO_SPMI_SEC_DISABLE_REG_ADDR(x)                                             ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000808)
...
#define HWIO_SPMI_HW_VERSION_ADDR(x)                                                  ((x) + SPMI_CFG_REG_BASE_OFFS + 0x0000080c)
...
#define HWIO_SPMI_CGC_CTRL_ADDR(x)                                                    ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000810)
...
#define HWIO_SPMI_MWB_ENABLE_REG_ADDR(x)                                              ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000814)
...
#define HWIO_SPMI_CHAR_CFG_ADDR(x)                                                    ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000840)
...
#define HWIO_SPMI_CHAR_DATA_n_ADDR(base,n)                                            ((base) + SPMI_CFG_REG_BASE_OFFS + 0x00000844 + 0x4 * (n))
...
#define HWIO_SPMI_CMPR_EN_REG_ADDR(x)                                                 ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000854)
...
#define HWIO_SPMI_PIC_RCS_VIOCTL_ADDR(x)                                              ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00000858)
...
#define HWIO_SPMI_PIC_RCS_VIOCTL_N_ADDR(x)                                            ((x) + SPMI_CFG_REG_BASE_OFFS + 0x0000085c)
...
#define HWIO_SPMI_PROTOCOL_IRQ_STATUS_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00005900)
...
#define HWIO_SPMI_PROTOCOL_IRQ_ENABLE_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00005904)
...
#define HWIO_SPMI_PROTOCOL_IRQ_CLEAR_ADDR(x)                                          ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00005908)
...
#define HWIO_SPMI_PROTOCOL_IRQ_EN_SET_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x0000590c)
...
#define HWIO_SPMI_PROTOCOL_IRQ_EN_CLEAR_ADDR(x)                                       ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00005910)
...
#define HWIO_SPMI_TEST_BUS_CTRL_ADDR(x)                                               ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00015900)
...
#define HWIO_SPMI_HW_SW_EVENTS_CTRL_ADDR(x)                                           ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00015904)
...
#define HWIO_SPMI_HW_SW_EVENTS_BITWISE_REGj_ADDR(base,j)                              ((base) + SPMI_CFG_REG_BASE_OFFS + 0x00015908 + 0x4 * (j))
...
#define HWIO_SPMI_DEBUG_REG_ADDR(x)                                                   ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00015928)
...
#define SPMI_PIC_OWNER_REG_BASE                                       (AOSS_BASE      + 0x03700000)
#define SPMI_PIC_OWNER_REG_BASE_OFFS                                  0x03700000

#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_ADDR(base,m,n)               ((base) + SPMI_PIC_OWNER_REG_BASE_OFFS + 0x00000000 + 0x10000 * (m) + 0x4 * (n))
#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_OFFS(base,m,n)               (0x00000000 + 0x10000 * (m) + 0x4 * (n))
