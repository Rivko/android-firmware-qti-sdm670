...
/*
  ...
  $Header: //components/rel/aop.ho/1.1.c1/aop_proc/core/api/power/670/arc_rm_hwio.h#1 $
...
#define HWIO_RPMH_ARC_RMm_AGGR_BLOCK_EN_MAXm                                                              8
...
#define HWIO_RPMH_ARC_RMm_AGGR_UNBLOCK_MAXm                                                               8
...
#define HWIO_RPMH_ARC_RMm_OPERATIONAL_LEVEL_MAXm                                                          8
...
#define HWIO_RPMH_ARC_RMm_MIN_IDLE_TIME_SOLVING_LOW_MAXm                                                  8
...
#define HWIO_RPMH_ARC_RMm_MIN_IDLE_TIME_SOLVING_HIGH_MAXm                                                 8
...
#define HWIO_RPMH_ARC_RMm_WAKEUP_TIMER_STATUS_LOW_MAXm                                                    8
...
#define HWIO_RPMH_ARC_RMm_WAKEUP_TIMER_STATUS_HIGH_MAXm                                                   8
...
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_ADDR(m,i)                                              (RPMH_ARC_ARC_RM_REG_BASE      + 0x00001240 + 0x40 * (m) + 0x4 * (i))
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_RMSK                                                        0xfff
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_MAXm                                                            8
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_MAXi                                                           15
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_INI2(m,i)        \
        in_dword_masked(HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_ADDR(m,i), HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_RMSK)
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_INMI2(m,i,mask)    \
        in_dword_masked(HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_ADDR(m,i), mask)
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_OUTI2(m,i,val)    \
        out_dword(HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_ADDR(m,i),val)
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_OUTMI2(m,i,mask,val) \
        out_dword_masked_ns(HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_ADDR(m,i),mask,val,HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_INI2(m,i))
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_HW_UP_BR_ADDR_BMSK                                          0xfff
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_ADDRi_HW_UP_BR_ADDR_SHFT                                            0x0

#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_ADDR(m,i)                                            (RPMH_ARC_ARC_RM_REG_BASE      + 0x00001640 + 0x40 * (m) + 0x4 * (i))
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_RMSK                                                      0xfff
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_MAXm                                                          8
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_MAXi                                                         15
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_INI2(m,i)        \
        in_dword_masked(HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_ADDR(m,i), HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_RMSK)
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_INMI2(m,i,mask)    \
        in_dword_masked(HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_ADDR(m,i), mask)
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_OUTI2(m,i,val)    \
        out_dword(HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_ADDR(m,i),val)
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_OUTMI2(m,i,mask,val) \
        out_dword_masked_ns(HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_ADDR(m,i),mask,val,HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_INI2(m,i))
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_HW_DOWN_BR_ADDR_BMSK                                      0xfff
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_ADDRi_HW_DOWN_BR_ADDR_SHFT                                        0x0

#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_ADDR(m,i)                                            (RPMH_ARC_ARC_RM_REG_BASE      + 0x00001a40 + 0x40 * (m) + 0x4 * (i))
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_RMSK                                                      0xfff
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_MAXm                                                          8
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_MAXi                                                         15
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_INI2(m,i)        \
        in_dword_masked(HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_ADDR(m,i), HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_RMSK)
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_INMI2(m,i,mask)    \
        in_dword_masked(HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_ADDR(m,i), mask)
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_OUTI2(m,i,val)    \
        out_dword(HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_ADDR(m,i),val)
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_OUTMI2(m,i,mask,val) \
        out_dword_masked_ns(HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_ADDR(m,i),mask,val,HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_INI2(m,i))
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_SW_CONF_BR_ADDR_BMSK                                      0xfff
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_ADDRi_SW_CONF_BR_ADDR_SHFT                                        0x0
...
#define HWIO_RPMH_ARC_RMm_SEQ_UP_BR_EVENT_MAXm                                                            8
...
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_BR_EVENT_MAXm                                                          8
...
#define HWIO_RPMH_ARC_RMm_SEQ_SW_CONF_EVENT_MAXm                                                          8
...
#define HWIO_RPMH_ARC_RMm_SEQ_UP_START_ADDR_MAXm                                                          8
...
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_START_ADDR_ADDR(m)                                            (RPMH_ARC_ARC_RM_REG_BASE      + 0x00002700 + 0x40 * (m))
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_START_ADDR_RMSK                                                    0xfff
#define HWIO_RPMH_ARC_RMm_SEQ_DOWN_START_ADDR_MAXm                                                        8
...
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_ADDR(m,i)                                                   (RPMH_ARC_ARC_RM_REG_BASE      + 0x00002a00 + 0x40 * (m) + 0x4 * (i))
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_RMSK                                                           0xfffff
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_MAXm                                                                 8
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_MAXi                                                                 3
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_INI2(m,i)        \
        in_dword_masked(HWIO_RPMH_ARC_RMm_SEQ_DELAYi_ADDR(m,i), HWIO_RPMH_ARC_RMm_SEQ_DELAYi_RMSK)
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_INMI2(m,i,mask)    \
        in_dword_masked(HWIO_RPMH_ARC_RMm_SEQ_DELAYi_ADDR(m,i), mask)
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_OUTI2(m,i,val)    \
        out_dword(HWIO_RPMH_ARC_RMm_SEQ_DELAYi_ADDR(m,i),val)
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_OUTMI2(m,i,mask,val) \
        out_dword_masked_ns(HWIO_RPMH_ARC_RMm_SEQ_DELAYi_ADDR(m,i),mask,val,HWIO_RPMH_ARC_RMm_SEQ_DELAYi_INI2(m,i))
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_DELAY_CNT_BMSK                                                 0xfffff
#define HWIO_RPMH_ARC_RMm_SEQ_DELAYi_DELAY_CNT_SHFT                                                     0x0
...
#define HWIO_RPMH_ARC_RMm_SOLVER_TABLE_MODEi_MAXm                                                         8
...
#define HWIO_RPMH_ARC_RMm_SOLVER_TABLE_MIN_SLEEP_TIMEi_MAXm                                               8
...
#define HWIO_RPMH_ARC_RMm_SEQUENCER_STATUS_CSR_MAXm                                                       8
