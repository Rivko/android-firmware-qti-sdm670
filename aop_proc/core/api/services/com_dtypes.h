...
DESCRIPTION
  Dummy common type-definitions header file.
...
$Header: //components/rel/aop.ho/1.1.c1/aop_proc/core/api/services/com_dtypes.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/24/14   jz      Fixed uint32/int32 sizes
01/14/14   ck      Integrated uintnt type from BOOT.BF.2.3
