...
=============================================================================
$Header: //components/rel/aop.ho/1.1.c1/aop_proc/core/power/pdc/tcs/src/os/rex/pdcTcs.c#1 $
...
void pdcTcs_initialize(void)
{
  ...
  {
    g_pdcResourceList[nRes].base_addr = cmd_db_query_addr(g_pdcResourceList[nRes].name);
    ...
    if(g_pdcResourceList[nRes].base_addr == 0)
    {
      nullCnt++;
    }
  }
