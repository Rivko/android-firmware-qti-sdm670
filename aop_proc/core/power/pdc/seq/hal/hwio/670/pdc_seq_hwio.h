...
/*
  ...
  $Header: //components/rel/aop.ho/1.1.c1/aop_proc/core/power/pdc/seq/hal/hwio/670/pdc_seq_hwio.h#1 $
...
#define AOP_PDC_REG_BASE                                                                        (AOSS_BASE      + 0x00260000)
...
#define HWIO_IRQ_ENABLE_BANKb_DRVd_MAXd                                                                  0
#define HWIO_IRQ_ENABLE_BANKb_DRVd_MAXb                                                                  0
...
#define HWIO_IRQ_i_CFG_DRVd_MAXd                                                                         0
#define HWIO_IRQ_i_CFG_DRVd_MAXi                                                                        24
...
#define HWIO_IRQ_STATUS_BANKb_DRVd_MAXd                                                                  0
#define HWIO_IRQ_STATUS_BANKb_DRVd_MAXb                                                                  0
...
#define HWIO_TCSt_DRVd_STATUS_MAXt                                                                       3
...
#define HWIO_TCSt_CMDn_DRVd_STATUS_MAXt                                                                  3
...
#define HWIO_GP_IRQ_SELECTgp_MAXgp                                                                       9
...
#define HWIO_TCSt_CONTROL_MAXt                                                                           3
...
#define HWIO_TCSt_CMD_ENABLE_BANK_MAXt                                                                   3
...
#define HWIO_TCSt_CMD_WAIT_FOR_CMPL_BANK_MAXt                                                            3
...
#define HWIO_TCSt_CMDn_MSGID_MAXt                                                                        3
...
#define HWIO_TCSt_CMDn_ADDR_MAXt                                                                         3
...
#define HWIO_TCSt_CMDn_DATA_MAXt                                                                         3
...
/*----------------------------------------------------------------------------
 * MODULE: AOP_PDC_SEQ_MEM
 *--------------------------------------------------------------------------*/

#define AOP_PDC_SEQ_MEM_REG_BASE                                    (AOSS_BASE      + 0x00460000)
