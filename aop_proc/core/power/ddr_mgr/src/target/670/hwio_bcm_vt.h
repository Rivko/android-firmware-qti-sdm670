#ifndef __HWIO_BCM_VT_H__
#define __HWIO_BCM_VT_H__
/*
===========================================================================
*/
/**
...
/*
  ...
  $Header: //components/rel/aop.ho/1.1.c1/aop_proc/core/power/ddr_mgr/src/target/670/hwio_bcm_vt.h#1 $
...
#define RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS                                                0x00a00000

#define HWIO_RPMH_BCM_VOTETABLE_DRVr_NDd_ADDR(r,d)                                          (RPMH_BCM_BCM_VOTETABLE_REG_BASE      + 0x00000000 + 0x10000 * (r) + 0x4 * (d))
#define HWIO_RPMH_BCM_VOTETABLE_DRVr_NDd_OFFS(r,d)                                          (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x00000000 + 0x10000 * (r) + 0x4 * (d))
#define HWIO_RPMH_BCM_VOTETABLE_DRVr_NDd_RMSK                                               0xefffffff
#define HWIO_RPMH_BCM_VOTETABLE_DRVr_NDd_MAXr                                                       12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_FE_AGG_FSM_OFFS(r)                                 (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x00000200 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_FE_AGG_FSM_RMSK                                        0xffff
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_FE_AGG_FSM_MAXr                                            12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_FE_CDm_OFFS(r,m)                                   (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x00000204 + 0x10000 * (r) + 0x4 * (m))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_FE_CDm_RMSK                                        0x7fff10ff
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_FE_CDm_MAXr                                                12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_DIRTY_ND_0_OFFS(r)                                 (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x00000284 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_DIRTY_ND_0_RMSK                                    0xffffffff
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_DIRTY_ND_0_MAXr                                            12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_DIRTY_ND_1_OFFS(r)                                 (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x00000288 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_DIRTY_ND_1_RMSK                                    0xffffffff
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_DIRTY_ND_1_MAXr                                            12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_SNDs_OFFS(r,s)                                     (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x0000028c + 0x10000 * (r) + 0x4 * (s))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_SNDs_RMSK                                                 0xf
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_SNDs_MAXr                                                  12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_AGG_BW_NDd_OFFS(r,d)                               (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x000002ac + 0x10000 * (r) + 0x4 * (d))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_AGG_BW_NDd_RMSK                                        0x7fff
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_AGG_BW_NDd_MAXr                                            12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_AGG_BW_Z_NDs_OFFS(r,s)                             (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x000004ac + 0x10000 * (r) + 0x4 * (s))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_AGG_BW_Z_NDs_RMSK                                      0x7fff
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_AGG_BW_Z_NDs_MAXr                                          12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CDm_OFFS(r,m)                                   (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x000004cc + 0x10000 * (r) + 0x4 * (m))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CDm_RMSK                                           0xfffff
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CDm_MAXr                                                12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_SEQ_CDm_OFFS(r,m)                               (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x0000054c + 0x10000 * (r) + 0x4 * (m))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_SEQ_CDm_RMSK                                        0xff01
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_SEQ_CDm_MAXr                                            12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_ISSUE_STATUS_CDm_OFFS(r,m)                  (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x000005cc + 0x10000 * (r) + 0x4 * (m))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_ISSUE_STATUS_CDm_RMSK                              0xf
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_ISSUE_STATUS_CDm_MAXr                               12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_ISSUE_STATUS_CDm_ISSUE_STATUS_BMSK                 0xf
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_SENT_STATUS_CDm_OFFS(r,m)                   (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x0000064c + 0x10000 * (r) + 0x4 * (m))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_SENT_STATUS_CDm_RMSK                               0xf
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_SENT_STATUS_CDm_MAXr                                12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_SENT_STATUS_CDm_SENT_STATUS_BMSK                   0xf
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_CMPL_STATUS_CDm_OFFS(r,m)                   (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x000006cc + 0x10000 * (r) + 0x4 * (m))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_CMPL_STATUS_CDm_RMSK                               0xf
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_CMPL_STATUS_CDm_MAXr                                12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_CMD_CMPL_STATUS_CDm_CMPL_STATUS_BMSK                   0xf
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_TCS_STATUS_CDm_OFFS(r,m)                        (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x0000074c + 0x10000 * (r) + 0x4 * (m))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_TCS_STATUS_CDm_RMSK                                    0x7
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BE_TCS_STATUS_CDm_MAXr                                     12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_CE_CTT_EMPTY_ADDR(r)                               (RPMH_BCM_BCM_VOTETABLE_REG_BASE      + 0x00000860 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_CE_CTT_EMPTY_OFFS(r)                               (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x00000860 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_CE_CTT_EMPTY_RMSK                                    0x1fff01
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_CE_CTT_EMPTY_MAXr                                          12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_CE_CTT_EMPTY_CTT_EMPTY_DRV_BMSK                      0x1fff00
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BCM_ADDR(r)                                        (RPMH_BCM_BCM_VOTETABLE_REG_BASE      + 0x00000864 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BCM_OFFS(r)                                        (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x00000864 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BCM_RMSK                                                  0x1
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_BCM_MAXr                                                   12
...
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_HW_VERSION_ADDR(r)                                 (RPMH_BCM_BCM_VOTETABLE_REG_BASE      + 0x00000868 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_HW_VERSION_OFFS(r)                                 (RPMH_BCM_BCM_VOTETABLE_REG_BASE_OFFS + 0x00000868 + 0x10000 * (r))
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_HW_VERSION_RMSK                                      0xffffff
#define HWIO_RPMH_BCM_SHADOW_STATUS_DRVr_HW_VERSION_MAXr                                            12
