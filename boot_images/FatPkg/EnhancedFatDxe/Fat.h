...
Portions Copyright (c) 2005 - 2013, Intel Corporation. All rights reserved.<BR>
...
// Qualcomm: Reduced FAT and Data cache sizes to reduce memory usage
#define FAT_FATCACHE_PAGE_MIN_ALIGNMENT   10
#define FAT_FATCACHE_PAGE_MAX_ALIGNMENT   12
#define FAT_DATACACHE_PAGE_MIN_ALIGNMENT  10
#define FAT_DATACACHE_PAGE_MAX_ALIGNMENT  12
#define FAT_DATACACHE_GROUP_COUNT         16
#define FAT_FATCACHE_GROUP_MIN_COUNT      1
#define FAT_FATCACHE_GROUP_MAX_COUNT      8
