/** @file
  ...
  Portions Copyright (c) 2014, AMR Ltd. All rights reserved.<BR>
...
#ifdef ENABLE_DEP_64
  /* Set XN */  
  Status = ArmSetMemoryRegionNoExec ((UINT64)Memory,  EFI_PAGES_TO_SIZE (Pages));
  if (Status != EFI_SUCCESS)
  {
    DEBUG ((EFI_D_ERROR, "XN: 0x%016lx--0x%016lx [Failed]\n", (UINT64)Memory, EFI_PAGES_TO_SIZE (Pages)));
  }
#endif
#endif
