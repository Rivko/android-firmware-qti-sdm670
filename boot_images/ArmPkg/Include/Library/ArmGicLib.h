...
// GIC Redistributor
#define ARM_GICR_WAKER      0x014

/* Bit mask for GICR_WAKER */
#define ARM_GICR_WAKER_CA   0x04
#define ARM_GICR_WAKER_PS   0x02

/* Bit mask for GICR_TYPER */
#define ARM_GICR_TYPER_VLPI  0x02
#define ARM_GICR_TYPER_LAST  0x10

/* GIC Redistributor SGI Offsets */
#define SGI_BASE                 SIZE_64KB          // 1 page offset from Redistributor base
#define ARM_GICR_ICDISR          (SGI_BASE + 0x080) // Interrupt Security Registers
#define ARM_GICR_ICDISER         (SGI_BASE + 0x100) // Interrupt Set-Enable Registers
#define ARM_GICR_ICDICER         (SGI_BASE + 0x180) // Interrupt Clear-Enable Registers
#define ARM_GICR_ICDIPR          (SGI_BASE + 0x400) // Interrupt Priority Registers

/* GIC Identification */
#define GICV3ID                  (0x3 << 16)
