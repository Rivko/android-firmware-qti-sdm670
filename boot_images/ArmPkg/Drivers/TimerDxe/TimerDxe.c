...
// Large compare value to make sure we don't get an unwanted interrupt
const UINT64 cmTimerMaxVal = 0xFFFFFFFFFF0000uLL;
#endif
...
#if defined (QCOM_EDK2_PATCH)
  // Set compare value for next period
  ArmGenericTimerSetCompareVal (cmTimerMaxVal);
#endif
