...
$Header: //components/rel/boot.xf/2.1/QcomPkg/SDM670Pkg/Settings/PMIC/loader/pm_spmi_config.c#3 $
...
/*SID, Periph ID, IRQ Owner,    Periph Owner */ 
  ...
  {0, 0xC6, SPMI_OWNER_MSS, SPMI_OWNER_MSS    }, /* GPIO07 */
  ...
  {1, 0x17, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* S2_CTRL */
  {1, 0x18, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S2_PS */
  {1, 0x19, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S2_FREQ */
  {1, 0x1A, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* S3_CTRL */
  ...
  {2, 0x04, SPMI_OWNER_AOP, SPMI_OWNER_AOP|SPMI_OWNER_TZ |SPMI_OWNER_MSS|SPMI_OWNER_APPS }, /* BUS */
  {2, 0x05, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* INT */
  {2, 0x06, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* SPMI */
  {2, 0x08, SPMI_OWNER_APPS, SPMI_OWNER_AOP|SPMI_OWNER_TZ| SPMI_OWNER_APPS }, /* PON */
  {2, 0x09, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* MISC */
  {2, 0x20, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* BCL_D */
  {2, 0x21, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* BCL_D_PLM */
  ...
  {2, 0x3F, SPMI_OWNER_MSS, SPMI_OWNER_MSS    }, /* BCL_COMP_MDM */
  ...
  {2, 0x73, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* PBS_CLIENT2 */
  {2, 0xC0, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* GPIO01 */
  {2, 0xC1, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO02 */
  {2, 0xC2, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO03 */
  {2, 0xC3, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO04 */
  {2, 0xC4, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO05 */
  {2, 0xC5, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO06 */
  {2, 0xC6, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO07 */
  {2, 0xC7, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO08 */
  {2, 0xC8, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO09 */
  {2, 0xC9, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* GPIO10 */
  {2, 0xCA, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* GPIO11 */
  {2, 0xCB, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* GPIO12 */
  {3, 0x01, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* REVID1 */
  {3, 0x10, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* BUCK_CMN_MOD */
  {3, 0x14, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S1_CTRL */
  {3, 0x15, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S1_PS */
  {3, 0x16, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S1_FREQ */
  {3, 0x17, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S2_CTRL */
  {3, 0x18, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S2_PS */
  {3, 0x19, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S2_FREQ */
  {3, 0x1A, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S3_CTRL */
  {3, 0x1B, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S3_PS */
  {3, 0x1C, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S3_FREQ */
  {3, 0x1D, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S4_CTRL */
  {3, 0x1E, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S4_PS */
  {3, 0x1F, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S4_FREQ */
  {3, 0x20, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S5_CTRL */
  {3, 0x21, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S5_PS */
  {3, 0x22, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* S5_FREQ */
  {3, 0x23, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* CDC_BOOST_FREQ */
  {3, 0x24, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* CDC_NCP_FREQ */
  {3, 0x40, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO01 */
  {3, 0x41, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO02 */
  {3, 0x42, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO03 */
  {3, 0x43, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO04 */
  {3, 0x44, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO05 */
  {3, 0x45, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO06 */
  {3, 0x46, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO07 */
  {3, 0x47, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO08 */
  {3, 0x48, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO09 */
  {3, 0x49, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* LDO10 */
  ...
  {3, 0xE0, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* OLEDB */
  {3, 0xEC, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* LCDB */
  {3, 0xF0, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* CDC_D */
  {3, 0xF1, SPMI_OWNER_APPS, SPMI_OWNER_APPS    }, /* CDC_A */
  {14, 0x72, SPMI_OWNER_AOP, SPMI_OWNER_AOP    }, /* PBS_CLIENT1  broadcast write*/
};
