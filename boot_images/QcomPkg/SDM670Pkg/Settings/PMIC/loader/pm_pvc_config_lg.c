...
$Header: //components/rel/boot.xf/2.1/QcomPkg/SDM670Pkg/Settings/PMIC/loader/pm_pvc_config_lg.c#1 $
...
{
  {0x0, 0x105},/* PM660,  Dummy write as UIM rail is not there*/
  {0x0, 0x105}, /* PM660, Dummy write as UIM rail is not there */
};
...
const SpmiBusCfg_VioctlCfg pm_vioctl_cfg0 =
{
   ...
   0x00,                 /* Positive edge periph interrupt mask */
