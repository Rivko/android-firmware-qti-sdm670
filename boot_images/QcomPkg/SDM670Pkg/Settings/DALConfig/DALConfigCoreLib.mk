...
#
#  Copyright (c) 2016-2017, 2020 Qualcomm Technologies, Inc. All rights reserved.
...
XML_DEPS = $(WORKSPACE)/QcomPkg/SDM670Pkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           $(WORKSPACE)/QcomPkg/SDM670Pkg/Settings/PMIC/$(MACRO_NAME)/pm_config_target_$(MACRO_NAME).xml \
           ...
           $(WORKSPACE)/QcomPkg/SDM670Pkg/Settings/SPI/core/spi_devcfg.xml \
