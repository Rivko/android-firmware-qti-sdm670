...
INC =  \
    ...
    -I$(WORKSPACE)/QcomPkg/$(CHIP_ID)Pkg/Library/CPRTargetLib/image/core/target/$(TARGET_ID) \
...
$(OUTPUT_DIR)/image/core/target/$(TARGET_ID)/cpr_image_target_init.obj : $(WORKSPACE)/QcomPkg/$(CHIP_ID)Pkg/Library/CPRTargetLib/image/core/target/$(TARGET_ID)/cpr_image_target_init.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/$(CHIP_ID)Pkg/Library/CPRTargetLib/image/core/target/$(TARGET_ID)/cpr_image_target_init.c
...
$(OUTPUT_DIR)/image/core/target/$(TARGET_ID)/cpr_image_target.obj : $(WORKSPACE)/QcomPkg/$(CHIP_ID)Pkg/Library/CPRTargetLib/image/core/target/$(TARGET_ID)/cpr_image_target.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/$(CHIP_ID)Pkg/Library/CPRTargetLib/image/core/target/$(TARGET_ID)/cpr_image_target.c
