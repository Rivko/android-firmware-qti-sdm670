...
$Header: //components/rel/boot.xf/2.1/QcomPkg/SDM670Pkg/Library/TLMMTargetLib/HALtlmm.h#1 $
...
typedef struct
{
  ...
  uint8 nOutVal;      /* The output value for a GPIO configured as generic output. */
