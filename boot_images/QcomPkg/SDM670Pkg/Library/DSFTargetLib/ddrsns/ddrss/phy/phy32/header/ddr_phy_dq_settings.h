...
#ifndef _DDR_PHY_DQ_SETTINGS_H
#define _DDR_PHY_DQ_SETTINGS_H

#ifndef _DDR_PHY_DQ_SETTINGS_SEQ_HEADER_
#define _DDR_PHY_DQ_SETTINGS_SEQ_HEADER_
...
void DDR_PHY_ddr_phy_dq_settings( uint32 _inst_ );
