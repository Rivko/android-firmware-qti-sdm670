/** @file EFIUSBDevice.h
  ...
  Copyright (c) 2014-2016 Qualcomm Technologies, Inc . All rights reserved.<BR>
...
/*=============================================================================
 ...
 11/23/15    ck     Include EFIUsbfnIo.h instead of EFIUsbIo.h
 09/17/14    ck     Modify and removed unused events
 08/21/14    ck     Add support for client to configure endpoints
 08/15/14    ml     Clean up
 08/15/14    ml     Initial version
=============================================================================*/
