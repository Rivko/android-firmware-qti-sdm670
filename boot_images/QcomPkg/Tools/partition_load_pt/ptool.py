...
#            print "===============================================================================\n"
	    ...
	    #print "===============================%i of %i===========================================" % (z,len(FileToProgram))
            ...
            UpdateRawProgram(RawProgramXML,FirstLBA+FilePartitionOffset[z], ((LastLBA-FirstLBA)+1)*SECTOR_SIZE_IN_BYTES/1024.0, PhysicalPartitionNumber, FileOffset[z], LastLBA-FirstLBA-FilePartitionOffset[z]+1, FileToProgram[z], FileSparse[z], PartitionLabel, PhyPartition[k][j]['readbackverify'], PhyPartition[k][j]['partofsingleimage'])
            if (j+1) == len(PhyPartition[k]):
                ## last partition, and if GROW was set to True, it will only have a size of 0
                UpdateRawProgram(RawProgramXML_Wipe,FirstLBA+FilePartitionOffset[z], (ConvertKBtoSectors(PhyPartition[k][j]['original_size_in_kb'])+(LastLBA-FirstLBA)+1)*SECTOR_SIZE_IN_BYTES/1024.0, PhysicalPartitionNumber, FileOffset[z], ConvertKBtoSectors(PhyPartition[k][j]['original_size_in_kb'])+LastLBA-FirstLBA-FilePartitionOffset[z]+1, "zeros_33sectors.bin", "false", PartitionLabel, PhyPartition[k][j]['readbackverify'], PhyPartition[k][j]['partofsingleimage'])
            else:
                UpdateRawProgram(RawProgramXML_Wipe,FirstLBA+FilePartitionOffset[z], ((LastLBA-FirstLBA)+1)*SECTOR_SIZE_IN_BYTES/1024.0, PhysicalPartitionNumber, FileOffset[z], LastLBA-FirstLBA-FilePartitionOffset[z]+1, "zeros_33sectorS.bin", "false", PartitionLabel, PhyPartition[k][j]['readbackverify'], PhyPartition[k][j]['partofsingleimage'])
