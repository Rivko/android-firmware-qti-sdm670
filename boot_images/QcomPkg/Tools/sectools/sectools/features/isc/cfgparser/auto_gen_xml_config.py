...
class complex_general_properties(GeneratedsSuper):
    ...
    def __init__(self, selected_signer=None, selected_encryptor=None, selected_cert_config=None, max_cert_size=None, key_size=None, num_certs_in_certchain=None, num_root_certs=None, max_num_root_certs=None, testsig_serialnum=None, mrc_index=None, msm_part=None, oem_id=None, model_id=None, sw_id=None, anti_rollback_version=None, app_id=None, crash_dump=None, rot_en=None, soc_hw_version=None, soc_vers=None, mask_soc_hw_version=None, in_use_soc_hw_version=None, use_serial_number_in_signing=None, serial_number=None, debug=None, multi_serial_numbers=None, exponent=None, object_id=None, pmbl_properties=None, cass_capability=None, hash_pageseg_as_segment=None, hash_algorithm=None, segment_hash_algorithm=None, cass_attest_cert=None, rsa_padding=None, hmac=None, secboot_version=None, qti_sign=False, oem_sign=True, UIE_key=None, UIE_capability=None, UIE_root_key_type=None, uie_key_switch_enable=None, oem_id_independent=None, revocation_enablement=None, activation_enablement=None, root_revoke_activate_enable=None, dsa_type=None, ecdsa_curve=None, multi_image_segment_phys_addr=None, client_id=None, lib_id=None):
        ...
        self.multi_image_segment_phys_addr = multi_image_segment_phys_addr
    ...
    def get_multi_image_segment_phys_addr(self): return self.multi_image_segment_phys_addr
    def set_multi_image_segment_phys_addr(self, multi_image_segment_phys_addr): self.multi_image_segment_phys_addr = multi_image_segment_phys_addr
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='complex_general_properties', fromsubclass_=False):
        ...
        if self.multi_image_segment_phys_addr is not None:
            showIndent(outfile, level)
            outfile.write('<%smulti_image_segment_phys_addr>%s</%smulti_image_segment_phys_addr>\n' % (namespace_, self.gds_format_string(quote_xml(self.multi_image_segment_phys_addr).encode(ExternalEncoding), input_name='multi_image_segment_phys_addr'), namespace_))
    ...
    def hasContent_(self):
        if (
            ...
            self.multi_image_segment_phys_addr is not None or
            self.client_id is not None or
            self.lib_id is not None
            ):
            return True
        else:
            return False
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.multi_image_segment_phys_addr is not None:
            showIndent(outfile, level)
            outfile.write('multi_image_segment_phys_addr=%s,\n' % quote_python(self.multi_image_segment_phys_addr).encode(ExternalEncoding))
        if self.client_id is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'multi_image_segment_phys_addr':
            multi_image_segment_phys_addr_ = child_.text
            multi_image_segment_phys_addr_ = self.gds_validate_string(multi_image_segment_phys_addr_, node, 'multi_image_segment_phys_addr')
            self.multi_image_segment_phys_addr = multi_image_segment_phys_addr_
...
class complex_elf_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, has_hash_table=None, has_multi_image_segment=None, has_license_manager_segment=None, max_elf_segments=None, image_type=None, hash_seg_placement=None, validate_ph_addrs=None, validate_vir_addrs=None):
