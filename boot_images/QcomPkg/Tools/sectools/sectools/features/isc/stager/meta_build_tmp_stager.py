...
class MetaBuildTmpStager(MetaBuildStager):
    ...
    def __init__(self, meta_build_path, config_dir_obj, img_config_parser, parsegen_config_parser, authority, sign_id_list=[], gen_multi_image=False):
        ...
        MetaBuildStager.__init__(self, meta_build_path, config_dir_obj, parsegen_config_parser, authority, sign_id_list, gen_multi_image)
