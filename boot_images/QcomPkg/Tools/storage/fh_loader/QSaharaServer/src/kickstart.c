 ...
 * ==========================================================================================
 *   $Header: //components/rel/boot.xf/2.1/QcomPkg/Tools/storage/fh_loader/QSaharaServer/src/kickstart.c#1 $
...
int main (int argc, char *argv[])
{
    ...
    const char *const short_options = "hp:v:c:mis:g:w:r:lt:j:b:ku:";  // possible cmd line short options
