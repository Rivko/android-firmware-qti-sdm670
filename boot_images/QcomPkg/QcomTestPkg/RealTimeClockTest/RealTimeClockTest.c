/** @file RealTimeClockTest.c
   
  Tests for Get and Set time via the RTC
...
07/30/11   sy      Adding TestInterface Library
 03/10/11   EBR     Created test for GetTime and SetTime
