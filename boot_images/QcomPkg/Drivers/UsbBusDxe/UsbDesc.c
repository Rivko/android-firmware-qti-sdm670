...
/*=============================================================================
 ...
 --------   ---      ----------------------------------------------------------
 04/06/17   pm       Fetch wLANGID[0] along with String length in UsbGetOneString API
  ...
  )
{
  ...
  //
  // First get four bytes which contains the string length and wLANGID[0] .
  //
  Status = UsbCtrlGetDesc (UsbDev, USB_DESC_TYPE_STRING, Index, LangId, &Desc, 4, AsyncFlag, AsyncConext);
