...
#ifndef _EHCI_PCI_ROOT_BRIDGE_H_
#define _EHCI_PCI_ROOT_BRIDGE_H_
...
// EHCI
#define QUALCOMM_EHCI_DEVICE_ID              0x0101
...
#define PCI_ROOT_BRIDGE_SIGNATURE SIGNATURE_32 ('u', 's', 'b', 'R')
...
/**
  ...
  be supported if protocol instance supports EHCI.
