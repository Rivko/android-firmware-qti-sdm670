/** @file
  Zlib Decompress GUIDed Section Extraction Library.

  Copyright (c) 2016, Qualcomm Technologies Inc. All rights reserved.
  Portions Copyright (c) 2009 - 2011, Intel Corporation. All rights reserved.<BR>
...
/**
  Register ZlibDecompress and ZlibGetInfo handlers with ZlibDecompressGuid.
