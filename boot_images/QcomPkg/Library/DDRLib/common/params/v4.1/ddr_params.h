...
extern BOOT_DDR_STRUCT *ddrsns_share_data; // TODO: This should be declared in scl file and used here ..also as of now it is RPM code ram start address , but need to finalize the address correctly .
