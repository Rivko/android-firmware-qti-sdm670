...
#define MISC_VSET1_L5_ACTIVE_ADDR_LB                (MISC_BASE_ADDRESS + 0x4C)
#define MISC_VSET1_L5_ACTIVE_ADDR_UB                (MISC_BASE_ADDRESS + 0x4D)
#define MISC_VSET2_L5_RET_ADDR_LB                   (MISC_BASE_ADDRESS + 0x4E)
#define MISC_VSET2_L5_RET_ADDR_UB                   (MISC_BASE_ADDRESS + 0x4F)
