  ...
  )
{
  ...
  if (GetDevicePathSize (BdsLoadOption->FilePathList) != BdsLoadOption->FilePathListLength)
  {
    DEBUG((EFI_D_ERROR,"%a: ERROR Invalid FilePathListLength !\n"));
    return EFI_INVALID_PARAMETER;
  }
