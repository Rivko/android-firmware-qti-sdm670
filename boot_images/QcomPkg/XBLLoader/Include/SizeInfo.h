...
/*===========================================================================
GENERAL DESCRIPTION
  This header file contains  size related macros
...
--------   --------     ----------------------------------------------------------
08/14/17   yps          Added SIZE_5KB
08/10/17   yps          Added SIZE_78KB and SIZE_466KB
08/04/17   naa          Added 724KB for DDI offset
07/19/16   vk           Initial version
============================================================================*/
