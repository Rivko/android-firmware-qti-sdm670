...
#if defined (QCOM_EDK2_PATCH)
typedef struct _FV_CACHE_NODE_TYPE {
  struct _FV_CACHE_NODE_TYPE              *Next;
  EFI_GUID                                Guid;
...
#if defined (QCOM_EDK2_PATCH)
  FV_CACHE_LIST_TYPE                      FvCacheList;
  FFS_FILE_LIST_ENTRY                     *CachedFfsFileEntry;
  EFI_FFS_FILE_HEADER                     *CachedFfsFileHeader;
  EFI_SECTION_TYPE                        CurrentSectionType;
#endif
} FV_DEVICE;
