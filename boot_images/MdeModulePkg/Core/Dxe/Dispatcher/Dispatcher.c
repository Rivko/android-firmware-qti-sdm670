...
#ifdef DISABLE_QCOM_OPTIMIZATIONS
  EFI_FV_FILETYPE_COMBINED_SMM_DXE, // Not supported in UEFI
  EFI_FV_FILETYPE_COMBINED_PEIM_DRIVER, // Not supported in UEFI
  EFI_FV_FILETYPE_DXE_CORE, // Not required at this stage of loading drivers
