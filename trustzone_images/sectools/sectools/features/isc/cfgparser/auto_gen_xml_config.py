...
class complex_metadata(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, chipset='default', version='2.0'):
...
class complex_general_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, selected_signer=None, selected_encryptor=None, selected_cert_config='default', max_cert_size=2048, key_size=2048, num_certs_in_certchain=3, max_num_certs_in_certchain=3, num_root_certs=1, max_num_root_certs=4, testsig_serialnum=None, mrc_index=0, msm_part='0x00000000', oem_id='0x0000', model_id='0x0000', sw_id='0x0000000000000000', anti_rollback_version='0x0000000000000000', app_id=None, crash_dump='disable', rot_en='disable', soc_hw_version='0x00000000', soc_vers=None, mask_soc_hw_version=None, in_use_soc_hw_version='disable', use_serial_number_in_signing='disable', serial_number=None, multi_serial_numbers=None, debug='nop', exponent=257, object_id=None, pmbl_properties=None, cass_capability=None, hash_pageseg_as_segment=False, hash_algorithm='sha256', segment_hash_algorithm='sha256', cass_attest_cert=None, rsa_padding='pkcs', hmac=True, secboot_version='1.0', qti_sign=False, oem_sign=True, UIE_key='default', UIE_capability=None, UIE_server_cert_path=None, UIE_server_url=None, UIE_root_key_type='otp_oem', uie_key_switch_enable='disable', oem_id_independent='disable', revocation_enablement='disable', activation_enablement='disable', root_revoke_activate_enable='disable', dsa_type='rsa', ecdsa_curve='secp384r1', multi_image_segment_addr=None, client_id=None, lib_id=None, image_entry=None, UIE_feature_id='0x1'):
        ...
        self.max_num_certs_in_certchain = max_num_certs_in_certchain
        ...
        self.UIE_feature_id = UIE_feature_id
    def factory(*args_, **kwargs_):
    ...
    def get_max_num_certs_in_certchain(self): return self.max_num_certs_in_certchain
    def set_max_num_certs_in_certchain(self, max_num_certs_in_certchain): self.max_num_certs_in_certchain = max_num_certs_in_certchain
    ...
    def get_UIE_feature_id(self): return self.UIE_feature_id
    def set_UIE_feature_id(self, UIE_feature_id): self.UIE_feature_id = UIE_feature_id
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='complex_general_properties', fromsubclass_=False):
        ...
        if self.max_num_certs_in_certchain is not None:
            showIndent(outfile, level)
            outfile.write('<%smax_num_certs_in_certchain>%s</%smax_num_certs_in_certchain>\n' % (namespace_, self.gds_format_integer(self.max_num_certs_in_certchain, input_name='max_num_certs_in_certchain'), namespace_))
        ...
        if self.in_use_soc_hw_version is not None:
            showIndent(outfile, level)
            outfile.write('<%sin_use_soc_hw_version>%s</%sin_use_soc_hw_version>\n' % (namespace_, self.gds_format_string(quote_xml(self.in_use_soc_hw_version).encode(ExternalEncoding), input_name='in_use_soc_hw_version'), namespace_))
        if self.use_serial_number_in_signing is not None:
            showIndent(outfile, level)
            outfile.write('<%suse_serial_number_in_signing>%s</%suse_serial_number_in_signing>\n' % (namespace_, self.gds_format_string(quote_xml(self.use_serial_number_in_signing).encode(ExternalEncoding), input_name='use_serial_number_in_signing'), namespace_))
        ...
        if self.UIE_root_key_type is not None:
            showIndent(outfile, level)
            outfile.write('<%sUIE_root_key_type>%s</%sUIE_root_key_type>\n' % (namespace_, self.gds_format_string(quote_xml(self.UIE_root_key_type).encode(ExternalEncoding), input_name='UIE_root_key_type'), namespace_))
        ...
        if self.oem_id_independent is not None:
            showIndent(outfile, level)
            outfile.write('<%soem_id_independent>%s</%soem_id_independent>\n' % (namespace_, self.gds_format_string(quote_xml(self.oem_id_independent).encode(ExternalEncoding), input_name='oem_id_independent'), namespace_))
        ...
        if self.UIE_feature_id is not None:
            showIndent(outfile, level)
            outfile.write('<%sUIE_feature_id>%s</%sUIE_feature_id>\n' % (namespace_, self.gds_format_string(quote_xml(self.UIE_feature_id).encode(ExternalEncoding), input_name='UIE_feature_id'), namespace_))
    def hasContent_(self):
        if (
            ...
            self.max_num_certs_in_certchain is not None or
            ...
            self.UIE_feature_id is not None
            ):
            return True
        else:
            return False
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.max_num_certs_in_certchain is not None:
            showIndent(outfile, level)
            outfile.write('max_num_certs_in_certchain=%d,\n' % self.max_num_certs_in_certchain)
        if self.num_root_certs is not None:
            showIndent(outfile, level)
        ...
        if self.in_use_soc_hw_version is not None:
            showIndent(outfile, level)
            outfile.write('in_use_soc_hw_version=%s,\n' % quote_python(self.in_use_soc_hw_version).encode(ExternalEncoding))
        if self.use_serial_number_in_signing is not None:
            showIndent(outfile, level)
            outfile.write('use_serial_number_in_signing=%s,\n' % quote_python(self.use_serial_number_in_signing).encode(ExternalEncoding))
        if self.serial_number is not None:
            showIndent(outfile, level)
        ...
        if self.UIE_root_key_type is not None:
            showIndent(outfile, level)
            outfile.write('UIE_root_key_type=%s,\n' % quote_python(self.UIE_root_key_type).encode(ExternalEncoding))
        if self.uie_key_switch_enable is not None:
            showIndent(outfile, level)
            outfile.write('uie_key_switch_enable=%s,\n' % quote_python(self.uie_key_switch_enable).encode(ExternalEncoding))
        if self.oem_id_independent is not None:
            showIndent(outfile, level)
            outfile.write('oem_id_independent=%s,\n' % quote_python(self.oem_id_independent).encode(ExternalEncoding))
        if self.revocation_enablement is not None:
            showIndent(outfile, level)
        ...
        if self.UIE_feature_id is not None:
            showIndent(outfile, level)
            outfile.write('UIE_feature_id=%s,\n' % quote_python(self.UIE_feature_id).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'selected_signer':
        ...
        elif nodeName_ == 'max_num_certs_in_certchain':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'max_num_certs_in_certchain')
            self.max_num_certs_in_certchain = ival_
            ...
            in_use_soc_hw_version_ = child_.text
            in_use_soc_hw_version_ = self.gds_validate_string(in_use_soc_hw_version_, node, 'in_use_soc_hw_version')
            self.in_use_soc_hw_version = in_use_soc_hw_version_
        elif nodeName_ == 'use_serial_number_in_signing':
            use_serial_number_in_signing_ = child_.text
            use_serial_number_in_signing_ = self.gds_validate_string(use_serial_number_in_signing_, node, 'use_serial_number_in_signing')
            self.use_serial_number_in_signing = use_serial_number_in_signing_
            ...
            UIE_root_key_type_ = child_.text
            UIE_root_key_type_ = self.gds_validate_string(UIE_root_key_type_, node, 'UIE_root_key_type')
            self.UIE_root_key_type = UIE_root_key_type_
            ...
            oem_id_independent_ = child_.text
            oem_id_independent_ = self.gds_validate_string(oem_id_independent_, node, 'oem_id_independent')
            self.oem_id_independent = oem_id_independent_
        ...
        elif nodeName_ == 'UIE_feature_id':
            UIE_feature_id_ = child_.text
            UIE_feature_id_ = self.gds_validate_string(UIE_feature_id_, node, 'UIE_feature_id')
            self.UIE_feature_id = UIE_feature_id_
...
class complex_elf_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, has_hash_table=None, has_multi_image_segment=False, has_license_manager_segment=False, has_sections=False, persist_encr=False, max_elf_segments=None, image_type=None, hash_seg_placement=None, validate_ph_addrs=None, validate_vir_addrs=None):
        ...
        self.persist_encr = persist_encr
    ...
    def get_persist_encr(self): return self.persist_encr
    def set_persist_encr(self, persist_encr): self.persist_encr = persist_encr
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='complex_elf_properties', fromsubclass_=False):
        ...
        if self.persist_encr is not None:
            showIndent(outfile, level)
            outfile.write('<%spersist_encr>%s</%spersist_encr>\n' % (namespace_, self.gds_format_boolean(self.gds_str_lower(str(self.persist_encr)), input_name='persist_encr'), namespace_))
    ...
    def hasContent_(self):
        if (
            ...
            self.persist_encr is not None or
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'has_hash_table':
            ...
            if sval_ in ('true', '1'):
                ...
                raise_parse_error(child_, 'requires boolean')
            ival_ = self.gds_validate_boolean(ival_, node, 'persist_encr')
            self.persist_encr = ival_
