...
WORD_BOUNDARY = 4
SSD_MAGIC = b'<?xml version="1.0" encoding="UTF-8"?><SSD_METADATA>'


class EncryptionParameters(BaseEncryptionParameters):

    def __init__(self, encryption_params_blob=None, private_key=None, config=None, debug_dir=None, validating=False, encrypted_segments_indices=None):
    ...
    def _generate_new_encryption_params_blob(self):
        enc_xml_fname=c_path.create_tmp_file()
    ...
    def _decode_encryption_parameters_blob(self, encryption_params_blob, private_key):
        ...
        tmp_config_file_path = c_path.create_tmp_file(data=encryption_params_blob)
