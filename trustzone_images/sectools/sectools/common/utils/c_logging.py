...
class CoreLogger(object):
    ...
    def __init__(self):
        ...
        self._fileLogger.propagate = False
        self._consoleLogger = logging.getLogger('tool_console_logging')
        self._consoleLogger.propagate = False
        ...
        # Variable to retain most recent error message
        self._last_error = None

    @property
    def lastError(self):
        """ Return the most recently logged error message """
        last_error = self._last_error
        self._last_error = None
        return last_error

    @lastError.setter
    def lastError(self, msg):
