...
from .datautils import hex16_handler, hex32_handler, hex64_handler, hex16_list_handler

PATH = path_handler.type_path
DICT = dict_handler
HEX = hex_handler.type_hex
HEX16 = hex16_handler.type_hex_16
HEX32 = hex32_handler.type_hex_32
HEX64 = hex64_handler.type_hex_64
HEX16LIST = hex16_list_handler.type_hex_16_list
    ...
    def __init__(self, config_module, config_path):
        ...
        try:
            ...
            err = 'Error parsing config file: {}\n    config_path: {}\n{}' \
                .format(str(e), self.config_path, traceback.format_exc())
