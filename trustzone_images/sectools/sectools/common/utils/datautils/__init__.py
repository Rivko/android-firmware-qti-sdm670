...
from . import boolean_handler
from . import dict_handler
from . import hex16_handler
from . import hex16_list_handler
from . import hex32_handler
from . import hex64_handler
from . import hex_handler
from . import integer_handler
from . import list_handler
from . import path_handler
from . import string_handler
from . import tuple_handler
...
_data_handlers_list = [boolean_handler.BooleanHandler,
                       ...
                       hex16_handler.Hex16Handler,
                       hex32_handler.Hex32Handler,
                       hex64_handler.Hex64Handler,
                       hex16_list_handler.Hex16ListHandler,
...
try:
    from . import enumerated_handler
