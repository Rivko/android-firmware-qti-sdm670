...
DECODE_HASH_ALGO = dict((v, k) for k, v in ENCODE_HASH_ALGO.items())
...
FILE_EXTRACTED = "multi_image_segment_extracted"
FILE_EXTRACTED_READABLE = "multi_image_segment_extracted_repr.txt"
FILE_GENERATED = "multi_image_segment_generated"
FILE_GENERATED_READABLE = "multi_image_segment_generated_repr.txt"
