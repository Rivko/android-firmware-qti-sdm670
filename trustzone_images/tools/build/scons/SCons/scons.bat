...
set CRM_PYTHON=%PYTHON_PATH%
set CRM_PYTHON_OPT=%PYTHON_PATH%

set SCONS_ROOT=%~dp0..

set PYTHON_PATH=
IF EXIST %CRM_PYTHON% SET PYTHON_PATH=%CRM_PYTHON%
IF EXIST %CRM_PYTHON_OPT% SET PYTHON_PATH=%CRM_PYTHON_OPT%
IF EXIST %COREBSP_PYTHON% SET PYTHON_PATH=%COREBSP_PYTHON%

set PYTHONCMD=%PYTHON_PATH%\python
