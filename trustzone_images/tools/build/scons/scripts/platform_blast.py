...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/scons.tz/2.0.2/build/scons/scripts/platform_blast.py#1 $
...
def generate(env):
   ...
   if do_post_link:
      ...
      if 'USES_PIL' in env:
         ...
         #-------------------------------------------------------------------------
         env.LoadToolScript("${BUILD_ROOT}/ssg/bsp/build/scripts/pil_splitter_builder.py")
