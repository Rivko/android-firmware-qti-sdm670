...
class EncryptionParameters(BaseEncryptionParameters):
    ...
    def __init__(self, encryption_params_blob=None, private_key=None, config=None, debug_dir=None, l3_key_blob=None, validating=False, encrypted_segments_indices=None):
        ...
        if encryption_params_blob is None and private_key is None and l3_key_blob is None:
            ...
            encryption_params_blob, private_key = self._generate_new_blob(config, debug_dir, encrypted_segments_indices=encrypted_segments_indices)
            # Set the base params
