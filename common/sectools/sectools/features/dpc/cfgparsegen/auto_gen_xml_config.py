...
class complex_file_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, revision=None, serial_number_start=None, serial_number_end=None, flags=None, image_bit_map=None, image_id_list=None, root_cert_hash_list=None, serial_num_list=None, root_cert_hash_qti_list=None, elf=None):
        ...
        self.root_cert_hash_qti_list = root_cert_hash_qti_list
        self.elf = elf
    def factory(*args_, **kwargs_):
    ...
    def get_root_cert_hash_qti_list(self): return self.root_cert_hash_qti_list
    def set_root_cert_hash_qti_list(self, root_cert_hash_qti_list): self.root_cert_hash_qti_list = root_cert_hash_qti_list
    ...
    def exportChildren(self, outfile, level, namespace_='tns:', name_='complex_file_properties', fromsubclass_=False):
        ...
        if self.root_cert_hash_qti_list is not None:
            self.root_cert_hash_qti_list.export(outfile, level, namespace_, name_='root_cert_hash_qti_list')
    ...
    def hasContent_(self):
        if (
            ...
            self.root_cert_hash_qti_list is not None or
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.root_cert_hash_qti_list is not None:
            showIndent(outfile, level)
            outfile.write('root_cert_hash_qti_list=model_.complex_root_cert_hash_qti_list(\n')
            self.root_cert_hash_qti_list.exportLiteral(outfile, level, name_='root_cert_hash_qti_list')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.elf is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'root_cert_hash_qti_list':
            obj_ = complex_root_cert_hash_qti_list.factory()
            obj_.build(child_)
            self.set_root_cert_hash_qti_list(obj_)
        elif nodeName_ == 'elf':
...
class complex_root_cert_hash_qti_list(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, root_cert_hash_qti=None):
        if root_cert_hash_qti is None:
            self.root_cert_hash_qti = []
        else:
            self.root_cert_hash_qti = root_cert_hash_qti
    def factory(*args_, **kwargs_):
        if complex_root_cert_hash_qti_list.subclass:
            return complex_root_cert_hash_qti_list.subclass(*args_, **kwargs_)
        else:
            return complex_root_cert_hash_qti_list(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_root_cert_hash_qti(self): return self.root_cert_hash_qti
    def set_root_cert_hash_qti(self, root_cert_hash_qti): self.root_cert_hash_qti = root_cert_hash_qti
    def add_root_cert_hash_qti(self, value): self.root_cert_hash_qti.append(value)
    def insert_root_cert_hash_qti(self, index, value): self.root_cert_hash_qti[index] = value
    def export(self, outfile, level, namespace_='tns:', name_='complex_root_cert_hash_qti_list', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='complex_root_cert_hash_qti_list')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='tns:', name_='complex_root_cert_hash_qti_list'):
        pass
    def exportChildren(self, outfile, level, namespace_='tns:', name_='complex_root_cert_hash_qti_list', fromsubclass_=False):
        for root_cert_hash_qti_ in self.root_cert_hash_qti:
            showIndent(outfile, level)
            outfile.write('<%sroot_cert_hash_qti>%s</%sroot_cert_hash_qti>\n' % (namespace_, self.gds_format_string(quote_xml(root_cert_hash_qti_).encode(ExternalEncoding), input_name='root_cert_hash_qti'), namespace_))
    def hasContent_(self):
        if (
            self.root_cert_hash_qti
            ):
            ...
            return False
    def exportLiteral(self, outfile, level, name_='complex_root_cert_hash_qti_list'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('root_cert_hash_qti=[\n')
        level += 1
        for root_cert_hash_qti_ in self.root_cert_hash_qti:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(root_cert_hash_qti_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'root_cert_hash_qti':
            root_cert_hash_qti_ = child_.text
            root_cert_hash_qti_ = self.gds_validate_string(root_cert_hash_qti_, node, 'root_cert_hash_qti')
            self.root_cert_hash_qti.append(root_cert_hash_qti_)
# end class complex_root_cert_hash_qti_list
...
__all__ = [
    ...
    "complex_root_cert_hash_qti_list",
