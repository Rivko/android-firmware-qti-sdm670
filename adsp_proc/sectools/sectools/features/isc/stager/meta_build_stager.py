...
class MetaBuildStager(BaseStager):
    ...
    def __init__(self, meta_build_path, config_dir_obj, parsegen_config, authority, sign_id_list=[]):
        ...
        for sign_id, chipset, image_src_path, image_dest_path, err_code in self.get_image_info_from_meta(meta_info):
            ...
            try:
                ...
                imageinfo = self._create_imageinfo(img_config_parser, parsegen_config, sign_id, "", image_src_path, image_dest_path)
