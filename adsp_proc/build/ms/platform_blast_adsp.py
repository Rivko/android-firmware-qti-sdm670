...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/dspbuild.adsp/5.0/ms/platform_blast_adsp.py#2 $
#  $DateTime: 2017/10/13 07:18:43 $
#  $Author: pwbldsvc $
#  $Change: 14606686 $
...
def generate(env):
   ...
   if do_link:
      ...
      if 'USES_FEATURE_DYNAMIC_LOADING_SENSORS' in env and 'BUILD_BAREBONE' not in env:
         env.Depends(image_elf, '${BUILD_ROOT}/build/bsp/sensor_img/build/${SHORT_BUILDPATH}/externs.lst')
         env.Depends(image_elf, '${BUILD_ROOT}/build/bsp/sensor_img/build/${SHORT_BUILDPATH}/dynsymbols.lst')
