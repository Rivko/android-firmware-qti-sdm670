#ifndef __MSMHWIOREG_SDM845_H__
#define __MSMHWIOREG_SDM845_H__
/*
===========================================================================
*/
/**
  ...
  Reference chip release:
    SDM845 (Napali) [napali_v1.0_p2q1r39.0.0]
 
  This file contains HWIO register definitions for the following modules:
    SECURITY_CONTROL_CORE

  'Include' filters applied: 
  'Exclude' filters applied: RESERVED DUMMY[SECURITY_CONTROL_CORE] 
...
/*
  ...
  $Header: //components/rel/platform.dsp/1.0.c3/security/config/sdm845/msmhwioreg.h#1 $
...
#define HWIO_QFPROM_CORR_PTE_ROW1_LSB_OFFS                                                      (0x00004138)
...
#define HWIO_QFPROM_CORR_PTE_ROW1_MSB_OFFS                                                      (0x0000413c)
...
#define HWIO_OEM_ID_OFFS                                                                        (0x00006138)
