...
===============================================================================
$Header: //components/rel/core.qdsp6/2.1/power/pdc/interrupt/src/config/670/adsp/gpio_table.c#3 $
$DateTime: 2017/09/21 06:00:16 $
=============================================================================*/ 
#include "comdef.h"
...
pdc_gpio_inputs g_pdcGpioInputs[] = 
{
  ...
  {56,            {PDC_GPIO_INVALID}},  
  {57,            {PDC_GPIO_INVALID}},
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_23 */
  
  /* Input 30 */
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_24 */ 
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_25 */ 
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_26 */ 
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_27 */
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_28 */

  /* Input 35 */
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_29 */
  {66,            {PDC_GPIO_INVALID}},  
  {68,            {PDC_GPIO_INVALID}},  
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_20 */
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_30 */
  ...
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* bi_px_ssc_22 */
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* core_bi_px_to_mpm[6] */
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* core_bi_px_to_mpm[0] */
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* core_bi_px_to_mpm[1] */
  ...
  {PDC_MUX_OPEN,  {PDC_GPIO_INVALID}}, /* core_bi_px_to_mpm[5] */  
