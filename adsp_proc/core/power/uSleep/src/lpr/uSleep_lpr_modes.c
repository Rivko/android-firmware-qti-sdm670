...
================================================================================
$Header: //components/rel/core.qdsp6/2.1/power/uSleep/src/lpr/uSleep_lpr_modes.c#5 $
...
uSleep_LPR g_uSleepDefaultLPR = {"No ModeChosen",              /* LPR name */
                                 {0,0},                        /* Seed enter, exit latency */
                                 0,                            /* Backoff latency */
                                 uSleepLPR_powerModeBaseInit,  /* Init function */
                                 uSleepLPR_holdoffNoMode,      /* Enter & exit functions for the LPR */
                                 NULL,
