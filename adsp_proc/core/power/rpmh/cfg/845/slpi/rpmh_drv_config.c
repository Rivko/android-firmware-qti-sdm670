...
typedef enum
{
  TCS_SLPI_VIRTUAL_ACTIVE_AMC   = 4 - TCS_SLPI_VIRTUAL_OFFSET,  //AMC_START 
  TCS_SLPI_VIRTUAL_ACTIVE_SLEEP = 5 - TCS_SLPI_VIRTUAL_OFFSET,  //AMC_END, SLEEP_TCS_START 
  TCS_SLPI_VIRTUAL_ACTIVE_WAKE  = 5 - TCS_SLPI_VIRTUAL_OFFSET,  //WAKE_TCS_START           
  TCS_SLPI_VIRTUAL_ACTIVE_MAX   = 6 - TCS_SLPI_VIRTUAL_OFFSET   //WAKE_TCS_END             
} tcs_slpi_virtual_active_config_enum;

typedef enum
{
  TCS_SLPI_VIRTUAL_AMC   = 4 - TCS_SLPI_VIRTUAL_OFFSET,  //AMC_START 
  TCS_SLPI_VIRTUAL_SLEEP = 4 - TCS_SLPI_VIRTUAL_OFFSET,  //AMC_END, SLEEP_TCS_START 
  TCS_SLPI_VIRTUAL_WAKE  = 5 - TCS_SLPI_VIRTUAL_OFFSET,  //WAKE_TCS_START           
  TCS_SLPI_VIRTUAL_MAX   = 6 - TCS_SLPI_VIRTUAL_OFFSET   //WAKE_TCS_END             
...
static const drv_config_data_t temp_config_data =
{
  ...
  .drvs = (drv_config_t[])
  {
    ...
    },
    {
      ...
      .modes = (const tcs_config_t *[])
      {
        &tcs_config_slpi_virtual_active,
