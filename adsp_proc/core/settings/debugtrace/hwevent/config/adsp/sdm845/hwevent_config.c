...
{0x1730200C,0x1730200C,0x0}, // LPASS_QDSP6SS_PWRDBG_CTL
{0x173B004C,0x173B00CC,0x0}, //LPASS_QDSP6SS_RSCC_HW_EVENT_MUXm_SELECT_DRVd
{0x170A404C,0x170A40CC,0x0}, //LPASS_RSCC_HW_EVENT_MUXm_SELECT_DRVd
{NULL,NULL,NULL}
};
