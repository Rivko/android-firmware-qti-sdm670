...
const struct tag_sender {
   ...
   EIP_BUILD_XML,
   "\310\001\000\000<?xml version=\"1.0\" encoding=\"utf-8\"?><build_vars>"
   "<add_to_dict dict=\"pool_relocs\" key=\"QURTOS_ISLAND_POOL\" range_"
   "bitmap=\"1\"/><effective_memsize value=\"30932992\"/><total_memsize"
   " value=\"31457280\"/><add_to_dict dict=\"region_names\" index=\"0\""
   " key=\"QURTOS_ISLAND_REGION_DDR\" pool=\"QURTOS_ISLAND_POOL\"/><add"
   "_to_dict dict=\"region_names\" index=\"1\" key=\"QURTOS_ISLAND_REGI"
   "ON_TCM\" pool=\"QURTOS_ISLAND_POOL\"/><region_cache_policies value="
   "\"15 0 7 15 1 0\"/></build_vars>"
};
...
CONFIG_RW_SPACE("Space for tcm tag is not defined in the config xml",
                ...
                CACHEALIGNED,
                {ARRAY_INIT(ROUNDUP(0X80000,32)) = 0xFF});
 ...
 *          - QURTK_L2_partition                                            *
 ****************************************************************************/
SET_CONFIG_VALUE(QURTK_syscfg_static, 0x84a000);
...
#define L2CFG_TAB {{ 0x00030020, 0x00000000 },{ 0x00020050, 0x00140014 },{ 0x00030024, 0x00000000 },{ 0x00020064, 0x00140014 },{ 0x00030100, 0x00022ebe },{ 0x00020068, 0x00140004 },{ 0x0002005c, 0x00140014 },{ 0x0002006c, 0x00140004 },{ 0x00030114, 0x00020000 },{ 0x00020060, 0x00140014 },{ 0x00030010, 0x00000001 },{ 0x00020058, 0x00140005 },{ 0x00030014, 0x00000000 },{ 0x00030110, 0x001e1010 },{ 0x0003010c, 0x0000041c },{ 0x00030118, 0x00000000 },{ 0x00030018, 0x00000000 },{ 0x00020054, 0x00040005 },{ 0x0003001c, 0x00000000 },{ 0x00030108, 0x00000000 },{ 0x00030104, 0x7f7f7f7f },}
...
#define POOL_CONFIGS_INIT { \
    POOLSTART("DEFAULT_PHYSPOOL") \
        POOLREGION(0x93D00,0x1E00000) \
    POOLEND \
    POOLSTART("ADSP_DRIVER_POOL") \
        POOLREGION(0x62400,0xC00000) \
    POOLEND \
    POOLSTART("DRIVER_POOL") \
        POOLREGION(0x93D00,0x1000) \
        POOLREGION(0x62400,0xEC2000) \
    POOLEND \
    POOLSTART("lpass_reg_pool") \
        POOLREGION(0x62C00,0x1000) \
    POOLEND \
    POOLSTART("qdsp6ss_reg_pool") \
        POOLREGION(0x62400,0x1000) \
    POOLEND \
    POOLSTART("smd_reg_pool") \
        POOLREGION(0x62485,0x1000) \
    POOLEND \
    POOLSTART("adsp_clk_reg_pool") \
        POOLREGION(0x62488,0x8000) \
    POOLEND \
    POOLSTART("sirc_reg_pool") \
        POOLREGION(0x62490,0x10000) \
    POOLEND \
    POOLSTART("saw_reg_pool") \
        POOLREGION(0x624B0,0x1000) \
    POOLEND \
    POOLSTART("smem_pool") \
    ...
    POOLEND \
    POOLSTART("SSC_PRAM") \
        POOLREGION(0x62BA0,0x7000) \
    POOLEND \
    POOLSTART("SSC_SDC") \
        POOLREGION(0x62800,0x100000) \
    POOLEND \
    POOLSTART("QURTOS_ISLAND_POOL") \
        POOLREGION(0x1D80,0x80000) \
        POOLREGION(0x62000,0x80000) \
    POOLEND \
    POOLSTART("") \
    POOLEND \
}
...
#define MMAP_TABLE_INIT { \
   MEMORY_MAP(1, 0, 0x62400L, 1, 0, RW, 0x4, 16, MAIN, 0x62400L),\
   MEMORY_MAP(1, 0, 0x62190L, 0, 0, RW, 0x4, 1, MAIN, 0x62190L),\
   MEMORY_MAP(1, 0, 0xbad10, 0, 0, KRN, 0x4, 4, MAIN, 0x800),\
   MEMORY_MAP(1, 0, 0xaea0L, 0, 0, RW, 0x4, 1, MAIN, 0xaea0L),\
   MEMORY_MAP(1, 0, 0x86000L, 0, 0, RW, 0x4, 16, MAIN, 0x86000L),\
   MEMORY_MAP(1, 0, 0x86100L, 0, 0, RW, 0x4, 16, MAIN, 0x86100L),\
   MEMORY_MAP(1, 0, 0x62b05L, 0, 0, RW, 0x4, 1, MAIN, 0x62b05L),\
   MEMORY_MAP(1, 0, 0x62ba0L, 1, 0, RW, 0x4, 2, MAIN, 0x62ba0L),\
   MEMORY_MAP(1, 0, 0x62ba4L, 1, 0, RW, 0x4, 2, MAIN, 0x62ba4L),\
   MEMORY_MAP(1, 0, 0x62800L, 1, 0, RW, 0x4, 8, MAIN, 0x62800L),\
   MEMORY_MAP(1, 0, 0x62840L, 1, 0, RW, 0x4, 8, MAIN, 0x62840L),\
   MEMORY_MAP(1, 0, 0x62880L, 1, 0, RW, 0x4, 8, MAIN, 0x62880L),\
   MEMORY_MAP(1, 0, 0x628c0L, 1, 0, RW, 0x4, 4, MAIN, 0x628c0L),\
   MEMORY_MAP(1, 0, 0x628d0L, 1, 0, RW, 0x4, 4, MAIN, 0x628d0L),\
   MEMORY_MAP(1, 0, 0x628e0L, 1, 0, RW, 0x4, 2, MAIN, 0x628e0L),\
   MEMORY_MAP(1, 0, 0x628e4L, 1, 0, RW, 0x4, 2, MAIN, 0x628e4L),\
   MEMORY_MAP(1, 0, 0x146bcL, 0, 0, RW, 0x4, 2, MAIN, 0x146bcL),\
   MEMORY_MAP(1, 0, 0x621a0L, 0, 0, RW, 0x4, 4, MAIN, 0x621a0L),\
   MEMORY_MAP(1, 0, 0xee000L, 1, 0, RW, 0x4, 64, MAIN, 0x62000L),\
...
#define ISR_INIT {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x832,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0}
...
#define PROGRAM_NAMES {"root_process","audio_process","sensor_process"}
...
CONFIG_RW_SPACE("",
                ...
                qurtos_heap,
                CACHEALIGNED,
                {ARRAY_INIT(ROUNDUP(0X100000,4)) = 0xFF});
SET_CONFIG_VALUE(QURTOS_HEAP_SIZE, sizeof(qurtos_heap));

#if 555 || defined(GEN_CONFIG_HEADER)
...
CONFIG_RW_SPACE(
   ...
   CONFIG_DEFAULT,
   "'\002\000\000<image><program_name_map name=\"root_process\" number=\"0"
   "\"/><program_name_map name=\"audio_process\" number=\"1\"/><program"
   "_name_map name=\"sensor_process\" number=\"2\"/><build>\n"
   "      <section name=\"*.island\" physpool=\"QURTOS_ISLAND_POOL\"/>"
   "\n"
   "    </build><cache_policy name=\"l1_wb_l2_uncacheable\" value=\"0x0"
   "\"/><cache_policy name=\"writethrough\" value=\"0x1\"/><cache_polic"
   "y name=\"l1_wt_l2_cacheable\" value=\"0x5\"/><cache_policy name=\"l"
   "1_wb_l2_cacheable\" value=\"0x7\"/><cache_policy name=\"uncached\" "
   "value=\"0x4\"/><cache_policy name=\"uncache_shared\" value=\"0x6\"/"
   "></image>"
);

#endif /* 555 */

SET_CONFIG_VALUE(qurtos_island_heap_size, ROUNDUP(0XF000,4));
...
#if 0XF000 > 0 || defined(GEN_CONFIG_HEADER)
CONFIG_RW_SPACE("",
                __attribute__((section(".data.island"))),
                unsigned char [],
                qurtos_island_heap,
                CACHEALIGNED,
                {ARRAY_INIT(ROUNDUP(0XF000,4)) = 0xFF});
#endif
CONFIG_RW_VAR("",
              int,
              QURTK_CONTEXT_SIZE,
...
#define L2ENABLE_INIT {0xffffffff,0xffffffdf,0xffffefff,0x511ffff3,0xafc2088,0xffff8000,0xffffffff,0xff6fffff,0x3ffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x328b7800,0x43c8110,0x10100000,0x50000020,0x2088,0x0,0x1000,0xff000000,0x3,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffffff,0xffffffdf,0xffffefff,0x511ffff3,0xafc2088,0xffff8000,0xffffffff,0xff6fffff,0x3ffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0}
...
#define PHYS_RELOC_INIT { &pool_configs[15].ranges[0].start, 0 }
