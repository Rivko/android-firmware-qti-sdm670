...
int main(int argc, char **argv)
{
  ...
  //Create mappings
	...
	// for(i = 0x1e000000; i < 0x21400000; i = i + 0x1000)
	// {
		// qurt_paddr_t paddr = 0;
		// num_entries++;

		// if(0 == (paddr = qurt_lookup_physaddr(i)))
		// {
			// qurt_mapping_create(i, i, 0x1000, QURT_MEM_CACHE_NONE, QURT_PERM_READ|QURT_PERM_WRITE);
		// }
	// }
