...
qurt_island_attr_resource_t g_uImageIslandData[35] =
{
    /* Interrupt elements */
    {QURT_ISLAND_ATTR_INT, {{0}}  }, /* PMI */
    {QURT_ISLAND_ATTR_INT, {{2}}  }, /* q6ss_qtmr_irq[0] */
    {QURT_ISLAND_ATTR_INT, {{4}}  }, /* qTimer frame 3 */
    {QURT_ISLAND_ATTR_INT, {{8}}  }, /* HW DOG Bark interrupt */
    {QURT_ISLAND_ATTR_INT, {{11}} }, /* Island exit */
    {QURT_ISLAND_ATTR_INT, {{12}} }, /* GSI Irq 0 */
    {QURT_ISLAND_ATTR_INT, {{13}} }, /* GSI Irq 1 */
    {QURT_ISLAND_ATTR_INT, {{14}} }, /* GSI Irq 2 */
    {QURT_ISLAND_ATTR_INT, {{15}} }, /* GSI Irq 3 */
    {QURT_ISLAND_ATTR_INT, {{16}} }, /* GSI Irq 4 */
    {QURT_ISLAND_ATTR_INT, {{17}} }, /* GSI Irq 5 */
    {QURT_ISLAND_ATTR_INT, {{29}} }, /* Island entry */
    {QURT_ISLAND_ATTR_INT, {{34}} }, /* UART interrupt */
    {QURT_ISLAND_ATTR_INT, {{35}} }, /* UART interrupt */
    {QURT_ISLAND_ATTR_INT, {{36}} }, /* UART interrupt */
    {QURT_ISLAND_ATTR_INT, {{40}} }, /* rsc_core_comp_irq */
    {QURT_ISLAND_ATTR_INT, {{46}} }, /* glink interrupt from sdc */ 
    {QURT_ISLAND_ATTR_INT, {{173}} }, /* CTI interrupt */
    ...
    {QURT_ISLAND_ATTR_MEMORY,
     {{0x05880000, 4}} }, /* SSC_QDSP6V65SS_CSR covers SPM, SLPC_CFG etc*/
    {QURT_ISLAND_ATTR_MEMORY,
...
int island_mgr_init(void)
{
    ...
    if(DAL_SUCCESS != DalHWIO_MapRegion(handle,"SSC",(uint8 **)&ssc_base_ptr))
    {
	return ISLAND_MGR_EFAILED;
    }
    ...
    qurt_rc = qurt_island_attr_add_mem(island_attr, ssc_base_ptr, 0x00800000);
    if (qurt_rc != QURT_EOK)
    {
	qurt_island_attr_delete(island_attr);
	return ISLAND_MGR_EFAILED;
