...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/avs.build/1.0/sdm1000/build_config_sdm1000.py#1 $
#  $DateTime: 2017/09/13 03:16:35 $
#  $Author: svutukur $
#  $Change: 14355555 $
...
# 09/28/15   sayyanna Build configuration
#===============================================================================
...
def chipset_specific_build_config(env):
    ...
    if env.get('AVS_TEST') == True:
        ...
        #details about this: msm8998/readme.txt  or <chipset>/readme.txt
    else:
