...
* Arguments of JSON file are described below:
      "lib_name"      : Name of the library in double quotes (same as LIBNAME is module level scons). 
                        ...
                        Eg. "Mp3DecoderModule",
                        Every module must be organized as Module level -> {CAPI level, core library level}. 
      ...
      "amdb_info"     : Dict containing info about registering/loading modules to AMDB. 
                        ...
                        Only libraries with amdb_info appear in QACT.
                        {
                          ...
                          "itype"      : type of of interface ("virtual_stub", "capi_v2"). double quoted. 
                                         Eg. "capi_v2". 
                                         Only one itype can be present for a module-id identified by key (mtype, id1, id2). 
                                         virtual_stub - need to be used if real-implementation of the module should not be used. For Generic modules will be bypassed in the topologies. 
                                                        Non-Generic modules may cause failure if used.
                                                        itype='virtual-stub' has the same effect as build='STATIC_BUILD_VIRTUAL_STUB', but allows module level control instead of library level.
                                                        (A library can have multiple modules)
                                                        This can be used for both static & shared builds.
                          ...
                          "prereq_mids": Eg. [{"mtype":"generic", "ID_1":"0x123", "ID_2":"0x0"}, {"mtype":"generic", "ID_1":"0x222", "ID_2":"0x0"}]
                                         ...
                                         Eg. Module-A lists module-B as prerequiste. Then whenever module 'A' is 'required', module 'B' is also 'required'. 
...
>> Example of shared library added to AMDB
   When GEN_SHARED_LIBS is not present in the env, these libraries are converted to static.
   {
      ...
      "amdb_info"   : 
      {
         ...
         "ID_2"               : "0",
         "tag"                : "capi_v2_my_mod",
         "qact_name"          : "AUDPROC_MODULE_ID_MY_MODULE"
      }
   }
...
>> Example of a virtual stub done at library level. See next example for an alternate way.
   {
      ...
      "amdb_info"     : 
      {
         ...
         "mtype"              : "generic",
         "ID_1"               : "0x1234",
         "tag"                : "appi_suport_proc",
         "qact_name"          : "AUDPROC_MODULE_ID_SUPER_PROC"         
      }      
   },      
