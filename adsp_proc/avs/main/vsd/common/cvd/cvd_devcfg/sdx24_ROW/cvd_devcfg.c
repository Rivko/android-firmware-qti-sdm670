/*
  ...
  $Header: //components/rel/avs.adsp/2.8.5/vsd/common/cvd/cvd_devcfg/sdx24_ROW/cvd_devcfg.c#3 $
  $Author: pwbldsvc $
*/
...
/**
  ...
  1. Voice use case <-> floor clock value table as follows:
    ...
    evs-nb                  svs2        NA      svs     NA          minSVS      minSVS      minSVS  minSVS      svs2      svs2
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_0_use_cases[ ] =
{
  /*    First classification is based on EVS media id.
      ...
      1 voice session -> EVS-NB stream ->NB DM_FV5. RTD: 119.42ms
      1 voice session -> EVS-NB stream ->NB DM_FV5_BROADSIDE. RTD: 116.69ms
      Allocate CVD_DEVCFG_CLK_HZ_minSVS
  */
  { 1, 1, 0, 0, 0, 1, 0, 0, 0, VPM_TX_DM_FLUENCEV5, CVD_UINT32_NA, VSS_MEDIA_ID_EVS, CVD_UINT16_NA },
