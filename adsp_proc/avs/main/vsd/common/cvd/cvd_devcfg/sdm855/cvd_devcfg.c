/*
  ...
  $Header: //components/rel/avs.adsp/2.8.5/vsd/common/cvd/cvd_devcfg/sdm855/cvd_devcfg.c#3 $
  $Author: pwbldsvc $
*/
...
static cvd_devcfg_clock_frequency_level_t cvd_devcfg_clock_frequency_levels[ ] = { {CVD_DEVCFG_MINSVS}, {CVD_DEVCFG_SVS2}, {CVD_DEVCFG_SVS}, {CVD_DEVCFG_SVS_L1}, {CVD_DEVCFG_NOMINAL}, {CVD_DEVCFG_NOMINAL_L1} } ;
