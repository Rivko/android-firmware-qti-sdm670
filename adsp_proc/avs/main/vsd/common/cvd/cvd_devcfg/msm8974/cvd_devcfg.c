/*
  ...
  $Header: //components/rel/avs.adsp/2.8.5/vsd/common/cvd/cvd_devcfg/msm8974/cvd_devcfg.c#3 $
  $Author: pwbldsvc $
*/
...
/**
  ...
  3. MMPM Bus Bandwidth requirement:
   ...
   5. Number of clock cycles required to execute 1000 instruction packets (
      ...
      - 1800
*/
#define CVD_DEVCFG_NUM_CLK_FREQ_LEVELS ( 3 )
#define CVD_DEVCFG_CLK_HZ_FREQ1       ( 81000000 )
#define CVD_DEVCFG_CLK_HZ_FREQ2       ( 113000000 )
#define CVD_DEVCFG_CLK_HZ_FREQ3       ( 163000000 )
...
static cvd_devcfg_clock_frequency_level_t cvd_devcfg_clock_frequency_levels[ ] = { {CVD_DEVCFG_CLK_HZ_FREQ1}, {CVD_DEVCFG_CLK_HZ_FREQ2}, {CVD_DEVCFG_CLK_HZ_FREQ3} } ;
