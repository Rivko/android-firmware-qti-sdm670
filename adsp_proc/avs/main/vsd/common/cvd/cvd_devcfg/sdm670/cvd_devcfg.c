/*
  ...
  $Header: //components/rel/avs.adsp/2.8.5/vsd/common/cvd/cvd_devcfg/sdm670/cvd_devcfg.c#3 $
  $Author: pwbldsvc $
*/
...
#define CVD_DEVCFG_MINSVS        (300000000)
#define CVD_DEVCFG_SVS2          (400000000)
#define CVD_DEVCFG_SVS           (600000000)
#define CVD_DEVCFG_SVS_PLUS      (844800000)
#define CVD_DEVCFG_NOMINAL       (940800000)
#define CVD_DEVCFG_NOMINAL_PLUS  (103680000)
#define CVD_DEVCFG_TURBO         (119040000)
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_bw_level_3_use_cases[ ] =
  {
    ...
    */
    ...
    /*  Use cases covered for each of the below topologies:
        1 voice session -> SWB/FB Stream -> SWB/FB Vocproc SMECNS_V2 PCM 32 KHz
        1 voice session -> SWB/FB Stream -> SWB/FB Vocproc SMECNS_V2 PCM 48 KHz
    */
    { 1, 0, 0, CVD_UINT16_NA, CVD_UINT16_NA, 0, 0, CVD_UINT16_NA, CVD_UINT16_NA, VPM_TX_SM_ECNS_V2, CVD_UINT32_NA, VSS_MEDIA_ID_PCM_32_KHZ, CVD_UINT16_NA }, 
    { 1, 0, 0, CVD_UINT16_NA, CVD_UINT16_NA, 0, 0, CVD_UINT16_NA, CVD_UINT16_NA, VPM_TX_SM_ECNS_V2, CVD_UINT32_NA, VSS_MEDIA_ID_PCM_48_KHZ, CVD_UINT16_NA }, 
  };
	...
	*/
	/*  Use cases covered for each of the below topologies:
	    ...
	    1 voice session -> WB Stream -> WB SM_ECNS_V2 VocProc. RTD: 79.90ms
            ...
            1 voice session -> SWB/FB Stream -> SWB/FB Vocproc SMECNS_V2 PCM 32 KHz RTD 86ms
            1 voice session -> SWB/FB Stream -> SWB/FB Vocproc SMECNS_V2 PCM 48 KHz RTD 89ms
        Allocate CVD_DEVCFG_SVS2
    */
