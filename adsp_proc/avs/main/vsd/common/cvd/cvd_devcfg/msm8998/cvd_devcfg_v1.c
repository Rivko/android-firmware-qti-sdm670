/*
  ...
  $Header: //components/rel/avs.adsp/2.8.5/vsd/common/cvd/cvd_devcfg/msm8998/cvd_devcfg_v1.c#2 $
  $Author: pwbldsvc $
*/
...
static cvd_devcfg_clock_frequency_level_t cvd_devcfg_v1_clock_frequency_levels[ ] = { {CVD_DEVCFG_V1_SVS2}, {CVD_DEVCFG_V1_SVS}, {CVD_DEVCFG_V1_NOMINAL} } ;

cvd_devcfg_clock_frequency_level_table_t cvd_devcfg_clock_frequency_level_table = {CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_clock_frequency_levels), cvd_devcfg_v1_clock_frequency_levels  } ; 
