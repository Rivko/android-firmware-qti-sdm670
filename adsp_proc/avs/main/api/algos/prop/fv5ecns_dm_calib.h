...
/** @h2xml_title1           {VOICE_MODULE_FLUENCE_EF}
    @h2xml_title_agile_rev  {VOICE_MODULE_FLUENCE_EF}
    @h2xml_title_date       {April 11, 2017} */


#define VOICE_MODULE_FLUENCE_EF  0x00010F0A
/**
    @h2xmlm_module       {"VOICE_MODULE_FLUENCE_EF",
                          VOICE_MODULE_FLUENCE_EF}
    @h2xmlm_displayName  {"TX VOICE FLUENCE EF"}
