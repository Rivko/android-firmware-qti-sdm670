#ifndef LEFT_IIR_TUNING_FILTER_CALIB_H
#define LEFT_IIR_TUNING_FILTER_CALIB_H
/*==============================================================================
  @file left_iir_tuning_filter_calib.h
  @brief This file contains LEFT_IIR_TUNING_FILTER API
==============================================================================*/
...
/** @h2xml_title1           {Rx_Left_IIR_Tuning_Filter}
    @h2xml_title_agile_rev  {Rx_Left_IIR_Tuning_Filter}
...
/**
    @h2xmlm_module       {"AUDPROC_MODULE_ID_LEFT_IIR_TUNING_FILTER",
                          AUDPROC_MODULE_ID_LEFT_IIR_TUNING_FILTER}
	@h2xmlm_displayName  {"AUDIO IIR LEFT"}
	@h2xmlm_description {ID of the LEFT IIR Tuning Filter module.\n
...
are used for the left IIR Rx tuning filter.\n
