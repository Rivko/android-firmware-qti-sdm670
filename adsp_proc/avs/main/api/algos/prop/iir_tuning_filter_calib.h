#ifndef IIR_TUNING_FILTER_CALIB_H
#define IIR_TUNING_FILTER_CALIB_H
/*==============================================================================
  @file iir_tuning_filter_calib.h
  @brief This file contains IIR_TUNING_FILTER API
==============================================================================*/
...
/** @h2xml_title1           {IIR Tuning Filter}
    @h2xml_title_agile_rev  {IIR Tuning Filter}
...
/**
    @h2xmlm_module       {"AUDPROC_MODULE_ID_IIR_TUNING_FILTER",
                          AUDPROC_MODULE_ID_IIR_TUNING_FILTER}
	@h2xmlm_displayName  {"AUDIO IIR"}
	@h2xmlm_description {ID of the IIR Tuning Filter module.\n
