...
/** @h2xml_title1           {VOICE_MODULE_FLUENCE_BS }
    @h2xml_title_agile_rev  {VOICE_MODULE_FLUENCE_BS }
    @h2xml_title_date       {April 11, 2017} */


#define VOICE_MODULE_FLUENCE_BS   0x00010F18
/**
    @h2xmlm_module       {"VOICE_MODULE_FLUENCE_BS ",
                          VOICE_MODULE_FLUENCE_BS }
    @h2xmlm_displayName  {"TX VOICE FLUENCE BS"}
