/* ========================================================================
   Allgo High precision Mp3 decoder library wrapper header file

  *//** @file CHpMp3DecoderLib.h
  This is a wrapper code for Mp3 Core decoder library from Allgo.
  the function in this file are called by the CHpMp3Decoder media module.
...
/* =========================================================================
   ...
   --------   --------     -- ----------------------------------------------
   4/03/2014   rbhatnk        CAPI V2 implementation of MP3
...
#ifndef HP_MP3_CAPIV2_HEADER_H_
#define HP_MP3_CAPIV2_HEADER_H_
...
None.
*/
capi_v2_err_t hp_mp3_dec_capi_v2_get_static_properties (
...
@dependencies
*/
capi_v2_err_t hp_mp3_dec_capi_v2_init (
   capi_v2_t*              _pif,
   capi_v2_proplist_t      *init_set_properties);
