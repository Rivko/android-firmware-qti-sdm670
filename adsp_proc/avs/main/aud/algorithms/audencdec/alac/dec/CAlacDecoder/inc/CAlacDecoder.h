/* =========================================================================
    ALAC decoder library wrapper header file
    @file CAlacDecoder.h
    
    This is wrapper code for Alac Core decoder library
...
/* ========================================================================
   ...
   --------   --------      ----------------------------------------------
   11/24/2014   aabraham        CAPI V2 implementation of ALAC
...
#ifndef ALAC_CAPIV2_HEADER_H_
#define ALAC_CAPIV2_HEADER_H_
...
capi_v2_err_t __attribute__ ((visibility ("default"))) alac_dec_capi_v2_get_static_properties (
...
capi_v2_err_t __attribute__ ((visibility ("default"))) alac_dec_capi_v2_init(
    capi_v2_t* _pif,
