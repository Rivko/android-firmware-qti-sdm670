#ifndef C_ETSI_EAACPLUS_ENC_ENCODER_LIB_H
#define C_ETSI_EAACPLUS_ENC_ENCODER_LIB_H

/* ========================================================================
   ETSI EaacPlus encoder library wrapper header file

  *//** @file CEtsiEaacPlusEncoder.h
  This is a wrapper code for ETSI EaacPlus Core encoder library.
  the function in this file are called by the CEtsiEaacPlusEncoder media module.
...
/* =========================================================================
   ...
   --------   --------     -- ----------------------------------------------
   9/30/2014   rbhatnk        CAPI V2 implementation of ETSI e-AAC Encoder
...
None.
 */
capi_v2_err_t etsi_eaacplus_enc_capi_v2_get_static_properties (
...
@dependencies
 */
capi_v2_err_t etsi_eaacplus_enc_capi_v2_init (
      capi_v2_t*              _pif,
      capi_v2_proplist_t      *init_set_properties);
...
#endif /* C_ETSI_EAACPLUS_ENC_ENCODER_LIB_H */
