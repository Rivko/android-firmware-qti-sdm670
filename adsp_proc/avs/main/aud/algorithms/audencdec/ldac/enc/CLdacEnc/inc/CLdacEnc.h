 ...
 * @file CLdacEnc.h
 *
 * This is a wrapper code for LDAC Encoder.
 */
 ...
 * ----------   ---         ------------------------------------------------
 * 2017/10/13   shrani      ldac encoder capi_v2
 ****************************************************************************/
...
/** @ingroup
    ...
    None.
*/
   capi_v2_err_t ldac_enc_capi_v2_get_static_properties (
...
/** @ingroup
    ...
    @dependencies
*/
   capi_v2_err_t ldac_enc_capi_v2_init (
      capi_v2_t*              _pif,
      capi_v2_proplist_t      *init_set_properties);
