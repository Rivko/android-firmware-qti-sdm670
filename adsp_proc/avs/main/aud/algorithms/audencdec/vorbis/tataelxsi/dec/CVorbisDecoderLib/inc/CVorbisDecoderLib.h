/* ========================================================================
   Vorbis decoder library wrapper header file

  *//** @file CVorbisDecoderLib.h
  This is a wrapper code for Vorbis Core decoder library.
  the function in this file are called by the CVorbisDecoder media module.
...
/* =========================================================================
   ...
   --------   --------     -- ----------------------------------------------
   3/5/15   vnadipal        created for CAPI V2 for Vorbis decoder
...
#ifndef VORBIS_CAPIV2_HEADER_H_
#define VORBIS_CAPIV2_HEADER_H_
...
None.
    */
capi_v2_err_t __attribute__ ((visibility ("default"))) vorbis_dec_capi_v2_get_static_properties (
...
@dependencies
 */
capi_v2_err_t __attribute__ ((visibility ("default"))) vorbis_dec_capi_v2_init (
      capi_v2_t*              _pif,
      capi_v2_proplist_t      *init_set_properties);
