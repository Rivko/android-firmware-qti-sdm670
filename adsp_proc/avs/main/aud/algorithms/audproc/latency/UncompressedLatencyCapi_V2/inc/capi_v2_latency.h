 ...
 * ----------   -------     -------------------------------------
 *  5/12/2016    rishabht     CAPI_V2 Interface for latency module
   ========================================================================= */

/*------------------------------------------------------------------------
 * Include files
 * -----------------------------------------------------------------------*/
#ifndef CAPI_V2_LATENCY_H
#define CAPI_V2_LATENCY_H
...
*/
capi_v2_err_t capi_v2_latency_get_static_properties(
...
* See Elite_CAPI_V2.h for more details.
*/
capi_v2_err_t capi_v2_latency_init(
      capi_v2_t          *_pif,
      capi_v2_proplist_t *init_set_properties);
