/* ========================================================================
   Compressed Over PCM (COP) packetizer header file

 *//** @file CCoPPacketizer.h
...
/* =========================================================================
   ...
   --------   --------     -- ----------------------------------------------
   4/11/2016   rbhatnk        CAPI V2 implementation of CoP packetizer
...
#ifndef COPP_CAPIV2_HEADER_H_
#define COPP_CAPIV2_HEADER_H_
...
None.
 */
capi_v2_err_t cop_pack_capi_v2_get_static_properties (
...
@dependencies
 */
capi_v2_err_t cop_pack_capi_v2_init (
      capi_v2_t*              _pif,
      capi_v2_proplist_t      *init_set_properties);
