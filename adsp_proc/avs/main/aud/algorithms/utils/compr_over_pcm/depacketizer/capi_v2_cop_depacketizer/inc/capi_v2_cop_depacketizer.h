/* ========================================================================
   Compressed over PCM depacketizer

 *//** @file CCoPDepacketizer.h
...
/* =========================================================================
   ...
   --------   --------     -- ----------------------------------------------
   4/11/2016   rbhatnk        Created the file.
...
#ifndef CCOP_DEPACK_CAPIV2_HEADER_H_
#define CCOP_DEPACK_CAPIV2_HEADER_H_
...
None.
 */
capi_v2_err_t cop_depack_capi_v2_get_static_properties (
...
@dependencies
 */
capi_v2_err_t cop_depack_capi_v2_init (
      capi_v2_t*              _pif,
      capi_v2_proplist_t      *init_set_properties);
...
#endif /* CCOP_DEPACK_CAPIV2_HEADER_H_ */
