...
extern const bool sns_std_request_is_passive_default;
extern const bool sns_std_request_batch_spec_flush_only_default;
extern const bool sns_std_request_batch_spec_max_batch_default;

/* Initializer values for message structs */
#define sns_std_request_init_default             {false, sns_std_request_batch_spec_init_default, {{NULL}, NULL}, false, false}
#define sns_std_request_batch_spec_init_default  {0, false, 0, false, false, false, false}
...
#define sns_std_request_init_zero                {false, sns_std_request_batch_spec_init_zero, {{NULL}, NULL}, false, 0}
...
#define sns_std_request_is_passive_tag           3

/* Struct field encoding specification for nanopb */
extern const pb_field_t sns_std_request_fields[4];
