...
#define _sns_std_client_processor_MAX SNS_STD_CLIENT_PROCESSOR_CDSP
#define _sns_std_client_processor_ARRAYSIZE ((sns_std_client_processor)(SNS_STD_CLIENT_PROCESSOR_CDSP+1))
