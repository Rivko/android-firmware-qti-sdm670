...
#define UPSAMPLING_FILTER_COEFF_LENGTH_HQ                 1632           //For RAM case only
#define UPSAMPLING_FILTER_COEFF_LENGTH_SHQ                10880          //For RAM case only
#define DOWNSAMPLING_FILTER_COEFF_LENGTH_HQ               1632           //For RAM case only
#define DOWNSAMPLING_FILTER_COEFF_LENGTH_SHQ              1632          //For RAM case only
 ...
 */
//void HAL_rs_init_v2(uint32 base_virt_addr)
//{
 ...
 */
void HAL_rs_start_v2(uint16 px, uint16 mask)
{
#ifdef HAL_DEBUG
 ...
 */
uint16 HAL_rs_get_cur_channel_v2(uint16 px)
{
   uint32 tmp; 
 ...
 */
uint16 HAL_rs_get_cur_job_id_v2(uint16 px)
{
   uint32 tmp;
 ...
 */
uint16 HAL_rs_get_cur_op_status_v2(uint16 px)
{
   uint32 tmp;
...
uint16 HAL_get_stream_struct_size_v2(uint16 num_channels)   //in bytes
{
 ...
 */
void HAL_rs_set_stream_config_v2(uint16 px, struct_rs_config* ptr_config_struct)
{
   uint32 config_reg = 0;
 ...
 * wrap up stream config info and write to RESAMPLER_Px_STREAM_CFG
 */
void HAL_rs_get_stream_config_v2(uint16 px, struct_rs_config* ptr_config_struct)
{
   uint32 config_reg=0;
 ...
 */
void HAL_rs_set_stream_struct_v2(uint16 px, struct_rs_stream* stream_struct, uint32* ptr_stream_mem, uint32* ptr_stream_mem_phys, uint16 num_channels)
{
 ...
 * Set the stream structure pointer
 */
void HAL_rs_get_stream_struct_v2(uint16 px, struct_rs_stream* stream_struct, uint32* ptr_stream_mem, uint32* ptr_stream_mem_phys)
{
 ...
 */
boolean HAL_rs_is_ack_valid_v2(uint16 px)
{
   //return valid bit
   uint32 rtn_ack;
 ...
 */
boolean HAL_rs_get_job_accepted_status_v2(uint16 px, uint16 *job_id)
{
 ...
 */
void HAL_rs_get_job_done_status_v2(uint16 px, uint16 *ptr_job_array)
{
   uint32 job_status=0;
   uint32 i;
 ...
 */
void HAL_rs_set_job_clear_v2(uint16 px, uint16 job_id, uint16 this_job_status)
{
 ...
 */
uint32 HAL_rs_get_estimated_total_clks_hiq_v2(uint16 px)
{
 ...
 */
uint32 HAL_rs_get_estimated_total_clks_loq_v2(uint16 px)
{
 ...
 */
void HAL_rs_set_estimated_clks_v2(uint16 px, uint32 clks)
{
#ifdef HAL_DEBUG
 ...
 * get filter length
 */
uint32 HAL_rs_get_upsampler_flt_mem_length_v2(void)
{

#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_upsampler_flt_mem_length_v2 Begin\n");
#endif


#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_upsampler_flt_mem_length_v2 End\n");
#endif
 ...
 * get filter length
 */
uint32 HAL_rs_get_upsampler_flt_coeff_length_hq_v2(void)
{

#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_upsampler_flt_coeff_length_hq_v2 Begin\n");
#endif


#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_upsampler_flt_coeff_length_hq_v2 End\n");
#endif
 ...
 * get filter length
 */
uint32 HAL_rs_get_upsampler_flt_coeff_length_shq_v2(void)
{

#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_upsampler_flt_coeff_length_shq_v2 Begin\n");
#endif


#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_upsampler_flt_coeff_length_shq_v2 End\n");
#endif
 ...
 * get filter length
 */
uint32 HAL_rs_get_downsampler_flt_coeff_length_hq_v2(void)
{

#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_downsampler_flt_coeff_length_hq_v2 Begin\n");
#endif


#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_downsampler_flt_coeff_length_hq_v2 End\n");
#endif
 ...
 * get filter length
 */
uint32 HAL_rs_get_downsampler_flt_coeff_length_shq_v2(void)
{

#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_downsampler_flt_coeff_length_shq_v2 Begin\n");
#endif


#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_downsampler_flt_coeff_length_shq_v2 End\n");
#endif
 ...
 */
uint32 HAL_rs_get_downsampler_flt_output_buf_size_v2(uint16 div_factor)
{
#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_downsampler_flt_output_buf_size_v2 Begin\n");
#endif
...
#ifdef HAL_DEBUG
   MSG(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"@HAL_rs_get_downsampler_flt_output_buf_size_v2 End\n");
#endif
 ...
 */
uint32 HAL_rs_get_memory_load_burst_size_v2(void)
{
 ...
 */
uint32 HAL_rs_get_parallel_pipeline_num_v2(void)
{
   return 2;
}
...
@return  
*/
uint32 HAL_rs_get_data_from_clk_tbl_v2(rs_hw_power_mode power_mode, rs_clock_idx clk_idx)
{
...
@return  power mode
*/
rs_hw_power_mode HAL_rs_get_power_mode_lowest_v2(void)
{
...
@return  power mode
*/
rs_hw_power_mode HAL_rs_get_power_mode_highest_v2(void)
{
   return POWER_MODE_SUPPORTED_HIGHEST;
}

void HAL_rs_init_v2(uint32 base_virt_addr, hal_rs_func_def_t* hal_func_def_ptr)
{
   hal_func_def_ptr->HAL_rs_init_f = NULL;
   hal_func_def_ptr->HAL_rs_start_f = HAL_rs_start_v2;
   hal_func_def_ptr->HAL_rs_get_cur_channel_f = HAL_rs_get_cur_channel_v2;
   hal_func_def_ptr->HAL_rs_get_cur_job_id_f = HAL_rs_get_cur_job_id_v2;
   hal_func_def_ptr->HAL_rs_get_cur_op_status_f = HAL_rs_get_cur_op_status_v2;
   hal_func_def_ptr->HAL_rs_set_stream_config_f = HAL_rs_set_stream_config_v2;
   hal_func_def_ptr->HAL_rs_get_stream_config_f = HAL_rs_get_stream_config_v2;
   hal_func_def_ptr->HAL_get_stream_struct_size_f = HAL_get_stream_struct_size_v2;
   hal_func_def_ptr->HAL_rs_set_stream_struct_f = HAL_rs_set_stream_struct_v2;
   hal_func_def_ptr->HAL_rs_get_stream_struct_f = HAL_rs_get_stream_struct_v2;
   hal_func_def_ptr->HAL_rs_is_ack_valid_f = HAL_rs_is_ack_valid_v2;
   hal_func_def_ptr->HAL_rs_get_job_accepted_status_f = HAL_rs_get_job_accepted_status_v2;
   hal_func_def_ptr->HAL_rs_get_job_done_status_f = HAL_rs_get_job_done_status_v2;
   hal_func_def_ptr->HAL_rs_set_job_clear_f = HAL_rs_set_job_clear_v2;
   hal_func_def_ptr->HAL_rs_get_estimated_total_clks_hiq_f = HAL_rs_get_estimated_total_clks_hiq_v2;
   hal_func_def_ptr->HAL_rs_get_estimated_total_clks_loq_f = HAL_rs_get_estimated_total_clks_loq_v2;
   hal_func_def_ptr->HAL_rs_set_estimated_clks_f = HAL_rs_set_estimated_clks_v2;

   hal_func_def_ptr->HAL_rs_get_upsampler_flt_mem_length_f = HAL_rs_get_upsampler_flt_mem_length_v2;
   hal_func_def_ptr->HAL_rs_get_upsampler_flt_coeff_length_hq_f = HAL_rs_get_upsampler_flt_coeff_length_hq_v2;
   hal_func_def_ptr->HAL_rs_get_upsampler_flt_coeff_length_shq_f = HAL_rs_get_upsampler_flt_coeff_length_shq_v2;
   hal_func_def_ptr->HAL_rs_get_downsampler_flt_coeff_length_hq_f = HAL_rs_get_downsampler_flt_coeff_length_hq_v2;
   hal_func_def_ptr->HAL_rs_get_downsampler_flt_coeff_length_shq_f = HAL_rs_get_downsampler_flt_coeff_length_shq_v2;

   hal_func_def_ptr->HAL_rs_get_downsampler_flt_output_buf_size_f = HAL_rs_get_downsampler_flt_output_buf_size_v2;
   hal_func_def_ptr->HAL_rs_get_memory_load_burst_size_f = HAL_rs_get_memory_load_burst_size_v2;

   hal_func_def_ptr->HAL_rs_get_parallel_pipeline_num_f = HAL_rs_get_parallel_pipeline_num_v2;
   hal_func_def_ptr->HAL_rs_get_data_from_clk_tbl_f = HAL_rs_get_data_from_clk_tbl_v2;

   hal_func_def_ptr->HAL_rs_get_power_mode_lowest_f = HAL_rs_get_power_mode_lowest_v2;
   hal_func_def_ptr->HAL_rs_get_power_mode_highest_f = HAL_rs_get_power_mode_highest_v2;
