...
public:
  ...
  vector() :
    m_pArray(0), m_capacity(0), m_num_elements(0), mDefaultCapacity(DEFAULT_CAPACITY)
  {
  }
  ...
  void setDefaultCapacity (unsigned int capacity)
  {
