...
#define PROXIMITY_RX_PATTERN_LEN_LOG2   10
#define PROXIMITY_RX_PATTERN_LEN        (1 << PROXIMITY_RX_PATTERN_LEN_LOG2)
...
==============================================================================*/
/**
 * Initializes the proximity algorithm.
 *
...
==============================================================================*/
/**
 * Returns the TxTransparentData to be stored / restored on restart.
 *
 * @param pWorkspace [in] Scratch buffer to be used by the algorithm.
 * @param pConfig [out] TxTransparentData and the size of the transparent
 *                      data in bytes
 * @param maxConfigSize [in] The value of the allocated buffer in bytes.
 *
 * @return 0 for success, 1 for failure.
 */
