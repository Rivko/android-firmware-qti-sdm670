...
#define GESTURE_RX_PATTERN_LEN_LOG2    10
#define GESTURE_RX_PATTERN_LEN         (1 << GESTURE_RX_PATTERN_LEN_LOG2)
...
typedef enum
{
  ...
  QC_US_GESTURE_LIB_RESULT_IDLE        =  0,   /* No detected */
 ...
 * @return 0 for success, 1 for failure.
 */
extern int QcUsGestureLibGetVersion(int *pVersion);
