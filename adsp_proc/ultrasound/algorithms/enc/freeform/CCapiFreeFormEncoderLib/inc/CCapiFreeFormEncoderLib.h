#ifndef C_CAPI_FREE_FORM_ENCODER_LIB_H
#define C_CAPI_FREE_FORM_ENCODER_LIB_H

/* ========================================================================
   Adpcm encoder library wrapper header file

  *//** @file CCapiFreeFormEncoderLib.h
...
/* =========================================================================
   ...
   06/26/13   IM           Add support for up to 8 channels input.
...
typedef struct FreeFormInitParamsStruct
{
...
}FreeFormInitParamsType;


   class CCapiFreeFormEncoderLib : public IUsCAPI
   {
...
public:
     ...
     enum FreeFormIdx
      {
         eFreeFormFormatTag = eUsCapiEncoderCommonMaxParamIndex,
         eFreeFormNumberOfChannels,
         eFreeFormBitsPerSample,
         eFreeFormSamplingRate,
         eFreeFormEncoderMapping,
		 eFreeFormSkipFactor,
         eFreeFormGroupFactor,
         eFreeFormSamplesPerFrame,
         eFreeFormFrameSizeBytes,
         _QIDL_PLACEHOLDER_FreeFormIdx = 0x7fffffff
      };

   private:

        int32             m_lFormatTag;                 // Media Format Tag
        uint16            m_sNumberOfChannels;          // Number of granules
        int16             m_sBitsPerSample;             // Bits Per Sample
        int32             m_lSamplingRate;              // Sampling Rate
        uint16            m_sSkipFactor;
        uint16            m_sGroupFactor;
        uint16            m_sSamplesPerFrame;
   ...
   /**
    * Default Constructor of CCapiFreeFormEncoderLib
    */
   CCapiFreeFormEncoderLib ( );

   /**
    * Constructor of CCapiFreeFormEncoderLib that creats an instance of encoder lib
    */
    CCapiFreeFormEncoderLib ( ADSPResult    &nRes );

   /**
    * Destructor of CCapiFreeFormEncoderLib
    */
   virtual ~CCapiFreeFormEncoderLib ( );
   ...
   int Drop ( const CAPI_BufList_t* pInSamples);
    ...
    public:
      FreeFormHeaderType() : packetHeader(0), packetLengthBytes(0), packetNumber(0)
      {
    	  // default constructor
      }
...
#endif /* C_CAPI_FREE_FORM_ENCODER_LIB_H */
