...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6/servreg_notif/src/service_registry_notifier_v01.c#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t qmi_servreg_notif_restart_pd_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
  QMI_IDL_OFFSET8(qmi_servreg_notif_restart_pd_req_msg_v01, process_spc_name),
  QMI_SERVREG_NOTIF_PROCESS_SPECEFIER_NAME_LENGTH_V01
};

static const uint8_t qmi_servreg_notif_restart_pd_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(qmi_servreg_notif_restart_pd_resp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0)
};
...
static const qmi_idl_message_table_entry servreg_notif_message_table_v01[] = {
  ...
  {sizeof(qmi_servreg_notif_restart_pd_req_msg_v01), qmi_servreg_notif_restart_pd_req_msg_data_v01},
  {sizeof(qmi_servreg_notif_restart_pd_resp_msg_v01), qmi_servreg_notif_restart_pd_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry servreg_notif_service_command_messages_v01[] = {
  ...
  {QMI_SERVREG_NOTIF_RESTART_PD_REQ_V01, QMI_IDL_TYPE16(0, 7), 67}
};
...
static const qmi_idl_service_message_table_entry servreg_notif_service_response_messages_v01[] = {
  ...
  {QMI_SERVREG_NOTIF_RESTART_PD_RESP_V01, QMI_IDL_TYPE16(0, 8), 7}
};
