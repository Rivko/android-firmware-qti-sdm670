...
target=sys.argv[1]
cdsp_flag=sys.argv[2]
input=str(sys.argv[3])
print input
os.chdir(input)


# This is for 8998/8996
if target=="8998" or target=="8996":
    smmu_fastrpc_list = { \
...
#This is for 660 ADSP/CDSP case
elif target=="660":
    if cdsp_flag=="True":
        smmu_fastrpc_list = { \
...
#This is for 845 ADSP/CDSP case
elif target == "845":
    if cdsp_flag == "True":
        smmu_fastrpc_list = { \
        '0x1':'msm_fastrpc_compute_cb1',\
        '0x2':'msm_fastrpc_compute_cb6',\
        '0x5':'msm_fastrpc_compute_cb7',\
        '0x6':'msm_fastrpc_compute_cb8',\
        '0x7':'msm_fastrpc_compute_cb9',\
        '0x8':'msm_fastrpc_compute_cb1',\
