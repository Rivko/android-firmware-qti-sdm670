 ...
 * @return none
 */
static void icm4x6xx_publish_attributes(sns_sensor *const this)
{
...
#endif
  {
    // TODO: publish available false here, check is example driver missed or intentional
    sns_std_attr_value_data value = sns_std_attr_value_data_init_default;
    value.has_boolean = true;
    value.boolean = false;
    sns_publish_attribute(
...
sns_rc icm4x6xx_accel_init(sns_sensor *const this)
{
    ...
    ICM4X6XX_PRINTF(LOW, this, "accel_init reg_idx=%d", state->registration_idx);
    ...
    ICM4X6XX_PRINTF(LOW, this, "icm4x6xx_accel_init finish");
