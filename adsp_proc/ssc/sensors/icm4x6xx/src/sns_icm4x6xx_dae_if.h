...
struct icm4x6xx_instance_state;
struct icm4x6xx_state;
...
typedef struct icm4x6xx_dae_if_info
{
  icm4x6xx_dae_stream   ag;
  icm4x6xx_dae_stream   temp;
} icm4x6xx_dae_if_info;
...
sns_rc icm4x6xx_dae_if_init(
    ...
    struct icm4x6xx_state          *sensor_state);
