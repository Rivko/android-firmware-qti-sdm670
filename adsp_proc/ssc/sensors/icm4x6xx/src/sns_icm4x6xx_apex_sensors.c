...
static void
icm4x6xx_publish_free_fall_attributes(sns_sensor *const this)
{
  icm4x6xx_state *state = (icm4x6xx_state*)this->state->state;
  {
    sns_std_attr_value_data values[] = {SNS_ATTR};
    char const proto1[] = "sns_lowg.proto";
  ...
  {
    sns_std_attr_value_data value = sns_std_attr_value_data_init_default;
    sns_free_fall_event stream_event =
      sns_free_fall_event_init_default;
...
static void
icm4x6xx_publish_high_shock_attributes(sns_sensor *const this)
{
  icm4x6xx_state *state = (icm4x6xx_state*)this->state->state;
  {
    sns_std_attr_value_data values[] = {SNS_ATTR};
    char const proto1[] = "sns_highg.proto";
    values[0].str.funcs.encode = pb_encode_string_cb;
    values[0].str.arg = &((pb_buffer_arg)
        { .buf = proto1, .buf_len = sizeof(proto1) });
    sns_publish_attribute(this, SNS_STD_SENSOR_ATTRID_API,
  ...
  {
    sns_std_attr_value_data value = sns_std_attr_value_data_init_default;
    sns_high_shock_event stream_event =
      sns_high_shock_event_init_default;
    pb_get_encoded_size(&state->encoded_event_len,
...
static void
icm4x6xx_publish_attributes(sns_sensor *const this)
{
  {
    sns_std_attr_value_data values[] = {SNS_ATTR};
  ...
  }
  {
    ...
    char const op_mode1[] = ICM4X6XX_LPM;
    char const op_mode2[] = ICM4X6XX_NORMAL;
    char const op_mode3[] = ICM4X6XX_HIGH_PERF;
  ...
  {
      char const vendor[] = "TDK-Invensense";
  ...
  }
  {
    sns_std_attr_value_data value = sns_std_attr_value_data_init_default;
    value.has_sint = true;
    value.sint = ICM4X6XX_DRIVER_VERSION;
    sns_publish_attribute(
...
{
  icm4x6xx_state *state = (icm4x6xx_state*)this->state->state;
  sns_sensor_uid suid = (sns_sensor_uid)ICM_FREE_FALL_SUID;
#ifdef ICM4X6XX_ENABLE_DUAL_SENSOR
  state->registration_idx = this->cb->get_registration_index(this);
  ICM4X6XX_PRINTF(MED, this, "reg idx=%d",state->registration_idx);
  if (state->registration_idx)
    suid = (sns_sensor_uid)ICM_FREE_FALL_SUID_1;
#endif
  ...
  icm4x6xx_publish_attributes(this);
  icm4x6xx_publish_free_fall_attributes(this);
...
{
  icm4x6xx_state *state = (icm4x6xx_state*)this->state->state;
  sns_sensor_uid suid = (sns_sensor_uid)ICM_HIGH_SHOCK_SUID;
#ifdef ICM4X6XX_ENABLE_DUAL_SENSOR
  state->registration_idx = this->cb->get_registration_index(this);
  ICM4X6XX_PRINTF(MED, this, "reg idx=%d",state->registration_idx);
  if (state->registration_idx)
    suid = (sns_sensor_uid)ICM_HIGH_SHOCK_SUID_1;
#endif
  ...
  icm4x6xx_common_init(this);
  icm4x6xx_publish_attributes(this);
  icm4x6xx_publish_high_shock_attributes(this);
