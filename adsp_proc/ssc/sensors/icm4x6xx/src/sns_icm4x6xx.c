...
sns_rc sns_register_icm4x6xx(sns_register_cb const *register_api)
{
    ...
    register_api->init_sensor(sizeof(icm4x6xx_state), &icm4x6xx_accel_sensor_api,
        &icm4x6xx_sensor_instance_api);

    /** Register Gyro Sensor. */
    register_api->init_sensor(sizeof(icm4x6xx_state), &icm4x6xx_gyro_sensor_api,
        &icm4x6xx_sensor_instance_api);

    /** Register Motion Accel Sensor. */
    register_api->init_sensor(sizeof(icm4x6xx_state), &icm4x6xx_motion_detect_sensor_api,
        &icm4x6xx_sensor_instance_api);

    /** Register Sensor Temperature Sensor. */
    register_api->init_sensor(sizeof(icm4x6xx_state), &icm4x6xx_sensor_temp_sensor_api,
        &icm4x6xx_sensor_instance_api);

#ifdef ICM4X6XX_ENABLE_LOWG
    /** Register Free Fall Sensor. */
    register_api->init_sensor(sizeof(icm4x6xx_state), &icm4x6xx_free_fall_sensor_api,
        &icm4x6xx_sensor_instance_api);
#endif

#ifdef ICM4X6XX_ENABLE_HIGHG
    /** Register High Shock Sensor. */
    register_api->init_sensor(sizeof(icm4x6xx_state), &icm4x6xx_high_shock_sensor_api,
        &icm4x6xx_sensor_instance_api);
#endif
