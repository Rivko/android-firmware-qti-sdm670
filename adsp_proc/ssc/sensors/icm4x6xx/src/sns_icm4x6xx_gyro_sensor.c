...
{
  icm4x6xx_state *state = (icm4x6xx_state*)this->state->state;
  sns_sensor_uid suid = (sns_sensor_uid)ICM_GYRO_SUID;
  ...
  if (state->registration_idx)
    suid = (sns_sensor_uid)ICM_GYRO_SUID_1;
#endif
  ...
  ICM4X6XX_PRINTF(LOW, this, "icm4x6xx_gyro_init exit");
