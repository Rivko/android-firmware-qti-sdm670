...
icm4x6xx_publish_attributes(sns_sensor *const this)
{
  icm4x6xx_state *state = (icm4x6xx_state*)this->state->state;
  {
    ...
    range1[0].flt = ICM4X6XX_SENSOR_TEMPERATURE_RANGE_MIN;
    range1[1].has_flt = true;
    range1[1].flt = ICM4X6XX_SENSOR_TEMPERATURE_RANGE_MAX;
  ...
  }
  {
    ...
    values[0].flt = ICM4X6XX_SENSOR_TEMP_ODR_1;
    values[1].has_flt = true;
    values[1].flt = ICM4X6XX_SENSOR_TEMP_ODR_5;
  ...
  }
  {
    sns_std_attr_value_data values[] = {SNS_ATTR};
    values[0].has_flt = true;
    values[0].flt = ICM4X6XX_SENSOR_TEMPERATURE_RESOLUTION;
  ...
  }
  {
    sns_std_attr_value_data value = sns_std_attr_value_data_init_default;
    value.has_flt = true;
    value.flt = ICM4X6XX_SENSOR_TEMPERATURE_RESOLUTION;
    sns_publish_attribute(
...
{
  icm4x6xx_state *state = (icm4x6xx_state*)this->state->state;
  sns_sensor_uid suid = (sns_sensor_uid)ICM_SENSOR_TEMPERATURE_SUID;
  ...
  if (state->registration_idx)
    suid = (sns_sensor_uid)ICM_SENSOR_TEMPERATURE_SUID_1;
#endif

  state->sensor = ICM4X6XX_SENSOR_TEMP;
