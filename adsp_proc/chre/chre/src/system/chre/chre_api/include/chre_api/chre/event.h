...
/**
 * First event in the block reserved for QC BLE. These events 
 * are defined in chre/qc_ble.h. 
 */
#define CHRE_EVENT_QC_BLE_FIRST_EVENT  CHRE_EVENT_INTERNAL_EXTENDED_FIRST_EVENT
#define CHRE_EVENT_QC_BLE_LAST_EVENT   (CHRE_EVENT_INTERNAL_EXTENDED_FIRST_EVENT + UINT16_C(0xF))
