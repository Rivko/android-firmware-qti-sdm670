...
MAKE_D_7_INCDIR: MAKE_D_4_INCDIR MAKE_D_5_INCDIR MAKE_D_5_INCDIR MAKE_D_4_INCDIR
	$(call job,../test_rsp,$(MAKE) V=hexagon_Release_dynamic_toolv81_v65,making ../test_rsp)

MAKE_D_7_INCDIR_clean: MAKE_D_4_INCDIR_clean MAKE_D_5_INCDIR_clean MAKE_D_5_INCDIR_clean MAKE_D_4_INCDIR_clean
	$(call job,../test_rsp,$(MAKE) V=hexagon_Release_dynamic_toolv81_v65 clean,cleaning ../test_rsp)

MAKE_D_4_INCDIR: 
	$(call job,../test_util,$(MAKE) V=hexagon_Release_dynamic_toolv81_v65,making ../test_util)

MAKE_D_4_INCDIR_clean: 
	$(call job,../test_util,$(MAKE) V=hexagon_Release_dynamic_toolv81_v65 clean,cleaning ../test_util)

MAKE_D_5_INCDIR: 
	$(call job,../atomic,$(MAKE) V=hexagon_Release_dynamic_toolv81_v65,making ../atomic)

MAKE_D_5_INCDIR_clean: 
	$(call job,../atomic,$(MAKE) V=hexagon_Release_dynamic_toolv81_v65 clean,cleaning ../atomic)
